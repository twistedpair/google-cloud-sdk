...
class CreateGA(base_classes.BaseAsyncCreator,
  ...
  def CreateNetworkInterfaceMessage(self, args, instance_refs):
    ...
    # TODO(stephenmw) drop hasattr after subnets goes GA
  ...
  def CreateRequests(self, args):
    ...
    # TODO(jeffvaughan) drop test after CSEK goes GA
    ...
    # TODO(aryann): Simplify this once resources.Resource becomes
    # hashable.
    existing_boot_disks = {}
