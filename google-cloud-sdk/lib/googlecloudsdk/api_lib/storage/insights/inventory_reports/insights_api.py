...
class InsightsApi:
  ...
  def list(self, source_bucket=None, destination=None, page_size=None):
  ...
  def _get_metadata_options_and_update_mask(self, metadata_fields,
    ...
    return (
        self.messages.ObjectMetadataReportOptions(
            metadataFields=metadata_fields,
            storageDestinationOptions=storage_destination_message),
        update_mask)

  def _get_csv_options_and_update_mask(self, csv_delimiter, csv_separator,
                                       csv_header):
  ...
  def update(self,
    ...
    csv_options, csv_update_mask = self._get_csv_options_and_update_mask(
        csv_delimiter, csv_separator, csv_header)
