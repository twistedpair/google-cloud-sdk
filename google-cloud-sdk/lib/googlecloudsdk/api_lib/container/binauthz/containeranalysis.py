  ...
  def CreatePgpAttestationOccurrence(self, note_ref, project_ref, artifact_url,
    ...
    Args:
      ...
      pgp_key_fingerprint: The ID of the public key that will be used to verify
        the signature.  This is usually generated by running `gpg --list-keys
        attesting_user@example.com` or equivalent. Note that this must match the
        public key inside the policy (managed separately) for the role being
        verified. (string)
      signature: The content artifact's signature, in the gpg clearsigned,
        ASCII-armored format.  Normally this is generated by running `gpg
        --local-user attesting_user@example.com --armor --sign <infile>` over
        the output of `CreateSignaturePayload`. (string)
    ...
    attestation = self.messages.Attestation(
        pgpSignedAttestation=self.messages.PgpSignedAttestation(
            contentType=(self.messages.PgpSignedAttestation
