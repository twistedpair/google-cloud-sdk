...
def GetClient():
  return apis.GetClientInstance('ondemandscanning', 'v1beta1')


def GetMessages():
  return apis.GetMessagesModule('ondemandscanning', 'v1beta1')


def AnalyzePackages(project, location, resource_uri, packages):
  """Make an RPC to the On-Demand Scanning's AnalyzePackages method."""
  client = GetClient()
