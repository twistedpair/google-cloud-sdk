...
class ListLogMetricsPager:
    ...
    :class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogMetricsResponse` object, and
    ...
    All the usual :class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogMetricsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogMetricsResponse):
