...
class ListLogEntriesPager:
    ...
    :class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogEntriesResponse` object, and
    ...
    All the usual :class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogEntriesResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogEntriesResponse):
...
class ListMonitoredResourceDescriptorsPager:
    ...
    This class thinly wraps an initial
    :class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListMonitoredResourceDescriptorsResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListMonitoredResourceDescriptorsResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            ...
            request (googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListMonitoredResourceDescriptorsRequest):
                The initial request object.
            response (googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListMonitoredResourceDescriptorsResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
