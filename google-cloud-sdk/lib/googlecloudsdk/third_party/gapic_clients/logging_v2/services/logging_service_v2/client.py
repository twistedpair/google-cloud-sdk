...
from googlecloudsdk.third_party.gapic_clients.logging_v2.services.logging_service_v2 import pagers
...
class LoggingServiceV2Client(metaclass=LoggingServiceV2ClientMeta):
    ...
    def delete_log(self,
        ...
        Args:
            request (Union[googlecloudsdk.third_party.gapic_clients.logging_v2.types.DeleteLogRequest, dict]):
    ...
    def write_log_entries(self,
        ...
        Args:
            request (Union[googlecloudsdk.third_party.gapic_clients.logging_v2.types.WriteLogEntriesRequest, dict]):
            ...
            resource (google.api.monitored_resource_pb2.MonitoredResource):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            labels (Sequence[googlecloudsdk.third_party.gapic_clients.logging_v2.types.WriteLogEntriesRequest.LabelsEntry]):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            entries (Sequence[googlecloudsdk.third_party.gapic_clients.logging_v2.types.LogEntry]):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.types.WriteLogEntriesResponse:
    ...
    def list_log_entries(self,
        ...
        Args:
            request (Union[googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogEntriesRequest, dict]):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.logging_service_v2.pagers.ListLogEntriesPager:
    ...
    def list_monitored_resource_descriptors(self,
        ...
        Args:
            request (Union[googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListMonitoredResourceDescriptorsRequest, dict]):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.logging_service_v2.pagers.ListMonitoredResourceDescriptorsPager:
    ...
    def list_logs(self,
        ...
        Args:
            request (Union[googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogsRequest, dict]):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.logging_service_v2.pagers.ListLogsPager:
    ...
    def tail_log_entries(self,
        ...
        Args:
            requests (Iterator[googlecloudsdk.third_party.gapic_clients.logging_v2.types.TailLogEntriesRequest]):
        ...
        Returns:
            Iterable[googlecloudsdk.third_party.gapic_clients.logging_v2.types.TailLogEntriesResponse]:
