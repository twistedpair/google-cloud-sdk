            ...
            },
{
            ...
            query_params = json.loads(logging.DeleteLogRequest.to_json(
                logging.DeleteLogRequest(transcoded_request['query_params']),
            ...
            },
{
            ...
            body = logging.ListLogEntriesRequest.to_json(
                logging.ListLogEntriesRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging.ListLogEntriesRequest.to_json(
                logging.ListLogEntriesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            # Jsonify the query params
            query_params = json.loads(logging.ListLogsRequest.to_json(
                logging.ListLogsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _ListMonitoredResourceDescriptors(LoggingServiceV2RestStub):
        ...
        descriptors method over HTTP.
            ...
            request_kwargs = logging.ListMonitoredResourceDescriptorsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging.ListMonitoredResourceDescriptorsRequest.to_json(
                logging.ListMonitoredResourceDescriptorsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            body = logging.WriteLogEntriesRequest.to_json(
                logging.WriteLogEntriesRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging.WriteLogEntriesRequest.to_json(
                logging.WriteLogEntriesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    def delete_log(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["delete_log"] = self._DeleteLog(self._session, self._host, self._interceptor)
    ...
    def list_log_entries(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_log_entries"] = self._ListLogEntries(self._session, self._host, self._interceptor)
    ...
    def list_logs(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_logs"] = self._ListLogs(self._session, self._host, self._interceptor)
    ...
    def list_monitored_resource_descriptors(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["list_monitored_resource_descriptors"] = self._ListMonitoredResourceDescriptors(self._session, self._host, self._interceptor)
    ...
    def tail_log_entries(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["tail_log_entries"] = self._TailLogEntries(self._session, self._host, self._interceptor)
    ...
    def write_log_entries(self) -> Callable[
        ...
        if not stub:
            stub = self._STUBS["write_log_entries"] = self._WriteLogEntries(self._session, self._host, self._interceptor)
