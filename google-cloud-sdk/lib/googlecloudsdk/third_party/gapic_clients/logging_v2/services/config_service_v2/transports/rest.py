    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomConfigServiceV2Interceptor(ConfigServiceV2RestInterceptor):
            def pre_copy_log_entries(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_copy_log_entries(response):
            ...
            def post_get_settings(response):
                logging.log(f"Received response: {response}")
            ...
            def pre_update_settings(request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_settings(response):
                logging.log(f"Received response: {response}")
...
class ConfigServiceV2RestTransport(ConfigServiceV2Transport):
    ...
    """
    _STUBS: Dict[str, ConfigServiceV2RestStub] = {}
    ...
    class _CopyLogEntries(ConfigServiceV2RestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = logging_config.CopyLogEntriesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = logging_config.CopyLogEntriesRequest.to_json(
                logging_config.CopyLogEntriesRequest(transcoded_request['body']),                including_default_value_fields=False,
            ...
            query_params = json.loads(logging_config.CopyLogEntriesRequest.to_json(
                logging_config.CopyLogEntriesRequest(transcoded_request['query_params']),
            ...
            },
{
            ...
            request_kwargs = logging_config.CreateBucketRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = logging_config.LogBucket.to_json(
                logging_config.LogBucket(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.CreateBucketRequest.to_json(
                logging_config.CreateBucketRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.LogBucket.from_json(
                response.content,
            ...
            },
{
            ...
            request_kwargs = logging_config.CreateExclusionRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = logging_config.LogExclusion.to_json(
                logging_config.LogExclusion(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.CreateExclusionRequest.to_json(
                logging_config.CreateExclusionRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.LogExclusion.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.CreateSinkRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = logging_config.LogSink.to_json(
                logging_config.LogSink(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.CreateSinkRequest.to_json(
                logging_config.CreateSinkRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.LogSink.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.CreateViewRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = logging_config.LogView.to_json(
                logging_config.LogView(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.CreateViewRequest.to_json(
                logging_config.CreateViewRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.LogView.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.DeleteBucketRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.DeleteBucketRequest.to_json(
                logging_config.DeleteBucketRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.DeleteExclusionRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.DeleteExclusionRequest.to_json(
                logging_config.DeleteExclusionRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.DeleteSinkRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.DeleteSinkRequest.to_json(
                logging_config.DeleteSinkRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.DeleteViewRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.DeleteViewRequest.to_json(
                logging_config.DeleteViewRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.GetBucketRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.GetBucketRequest.to_json(
                logging_config.GetBucketRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.GetCmekSettingsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.GetCmekSettingsRequest.to_json(
                logging_config.GetCmekSettingsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.CmekSettings.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.GetExclusionRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.GetExclusionRequest.to_json(
                logging_config.GetExclusionRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.GetSettingsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.GetSettingsRequest.to_json(
                logging_config.GetSettingsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.Settings.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.GetSinkRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.GetSinkRequest.to_json(
                logging_config.GetSinkRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.GetViewRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.GetViewRequest.to_json(
                logging_config.GetViewRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.ListBucketsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.ListBucketsRequest.to_json(
                logging_config.ListBucketsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.ListBucketsResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.ListExclusionsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.ListExclusionsRequest.to_json(
                logging_config.ListExclusionsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.ListExclusionsResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.ListSinksRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.ListSinksRequest.to_json(
                logging_config.ListSinksRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.ListSinksResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.ListViewsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.ListViewsRequest.to_json(
                logging_config.ListViewsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = logging_config.ListViewsResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
            ...
            },
{
            ...
            request_kwargs = logging_config.UndeleteBucketRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = logging_config.UndeleteBucketRequest.to_json(
                logging_config.UndeleteBucketRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.UndeleteBucketRequest.to_json(
                logging_config.UndeleteBucketRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.UpdateBucketRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.UpdateBucketRequest.to_json(
                logging_config.UpdateBucketRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.UpdateCmekSettingsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = logging_config.CmekSettings.to_json(
                logging_config.CmekSettings(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.UpdateCmekSettingsRequest.to_json(
                logging_config.UpdateCmekSettingsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.UpdateExclusionRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.UpdateExclusionRequest.to_json(
                logging_config.UpdateExclusionRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.UpdateSettingsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = logging_config.Settings.to_json(
                logging_config.Settings(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.UpdateSettingsRequest.to_json(
                logging_config.UpdateSettingsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.UpdateSinkRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.UpdateSinkRequest.to_json(
                logging_config.UpdateSinkRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            },
{
            ...
            request_kwargs = logging_config.UpdateViewRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(logging_config.UpdateViewRequest.to_json(
                logging_config.UpdateViewRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    def copy_log_entries(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("copy_log_entries")
        if not stub:
            stub = self._STUBS["copy_log_entries"] = self._CopyLogEntries(self._session, self._host, self._interceptor)
    ...
    def create_bucket(self) -> Callable[
            ...
            logging_config.LogBucket]:
        stub = self._STUBS.get("create_bucket")
        if not stub:
            stub = self._STUBS["create_bucket"] = self._CreateBucket(self._session, self._host, self._interceptor)
    ...
    def create_exclusion(self) -> Callable[
            ...
            logging_config.LogExclusion]:
        stub = self._STUBS.get("create_exclusion")
        if not stub:
            stub = self._STUBS["create_exclusion"] = self._CreateExclusion(self._session, self._host, self._interceptor)
    ...
    def create_sink(self) -> Callable[
            ...
            logging_config.LogSink]:
        stub = self._STUBS.get("create_sink")
        if not stub:
            stub = self._STUBS["create_sink"] = self._CreateSink(self._session, self._host, self._interceptor)
    ...
    def create_view(self) -> Callable[
            ...
            logging_config.LogView]:
        stub = self._STUBS.get("create_view")
        if not stub:
            stub = self._STUBS["create_view"] = self._CreateView(self._session, self._host, self._interceptor)
    ...
    def delete_bucket(self) -> Callable[
            ...
            empty_pb2.Empty]:
        stub = self._STUBS.get("delete_bucket")
        if not stub:
            stub = self._STUBS["delete_bucket"] = self._DeleteBucket(self._session, self._host, self._interceptor)
    ...
    def delete_exclusion(self) -> Callable[
            ...
            empty_pb2.Empty]:
        stub = self._STUBS.get("delete_exclusion")
        if not stub:
            stub = self._STUBS["delete_exclusion"] = self._DeleteExclusion(self._session, self._host, self._interceptor)
    ...
    def delete_sink(self) -> Callable[
            ...
            empty_pb2.Empty]:
        stub = self._STUBS.get("delete_sink")
        if not stub:
            stub = self._STUBS["delete_sink"] = self._DeleteSink(self._session, self._host, self._interceptor)
    ...
    def delete_view(self) -> Callable[
            ...
            empty_pb2.Empty]:
        stub = self._STUBS.get("delete_view")
        if not stub:
            stub = self._STUBS["delete_view"] = self._DeleteView(self._session, self._host, self._interceptor)
    ...
    def get_bucket(self) -> Callable[
            ...
            logging_config.LogBucket]:
        stub = self._STUBS.get("get_bucket")
        if not stub:
            stub = self._STUBS["get_bucket"] = self._GetBucket(self._session, self._host, self._interceptor)
    ...
    def get_cmek_settings(self) -> Callable[
            ...
            logging_config.CmekSettings]:
        stub = self._STUBS.get("get_cmek_settings")
        if not stub:
            stub = self._STUBS["get_cmek_settings"] = self._GetCmekSettings(self._session, self._host, self._interceptor)
    ...
    def get_exclusion(self) -> Callable[
            ...
            logging_config.LogExclusion]:
        stub = self._STUBS.get("get_exclusion")
        if not stub:
            stub = self._STUBS["get_exclusion"] = self._GetExclusion(self._session, self._host, self._interceptor)
    ...
    def get_settings(self) -> Callable[
            ...
            logging_config.Settings]:
        stub = self._STUBS.get("get_settings")
        if not stub:
            stub = self._STUBS["get_settings"] = self._GetSettings(self._session, self._host, self._interceptor)
    ...
    def get_sink(self) -> Callable[
            ...
            logging_config.LogSink]:
        stub = self._STUBS.get("get_sink")
        if not stub:
            stub = self._STUBS["get_sink"] = self._GetSink(self._session, self._host, self._interceptor)
    ...
    def get_view(self) -> Callable[
            ...
            logging_config.LogView]:
        stub = self._STUBS.get("get_view")
        if not stub:
            stub = self._STUBS["get_view"] = self._GetView(self._session, self._host, self._interceptor)
    ...
    def list_buckets(self) -> Callable[
            ...
            logging_config.ListBucketsResponse]:
        stub = self._STUBS.get("list_buckets")
        if not stub:
            stub = self._STUBS["list_buckets"] = self._ListBuckets(self._session, self._host, self._interceptor)
    ...
    def list_exclusions(self) -> Callable[
            ...
            logging_config.ListExclusionsResponse]:
        stub = self._STUBS.get("list_exclusions")
        if not stub:
            stub = self._STUBS["list_exclusions"] = self._ListExclusions(self._session, self._host, self._interceptor)
    ...
    def list_sinks(self) -> Callable[
            ...
            logging_config.ListSinksResponse]:
        stub = self._STUBS.get("list_sinks")
        if not stub:
            stub = self._STUBS["list_sinks"] = self._ListSinks(self._session, self._host, self._interceptor)
    ...
    def list_views(self) -> Callable[
            ...
            logging_config.ListViewsResponse]:
        stub = self._STUBS.get("list_views")
        if not stub:
            stub = self._STUBS["list_views"] = self._ListViews(self._session, self._host, self._interceptor)
    ...
    def undelete_bucket(self) -> Callable[
            ...
            empty_pb2.Empty]:
        stub = self._STUBS.get("undelete_bucket")
        if not stub:
            stub = self._STUBS["undelete_bucket"] = self._UndeleteBucket(self._session, self._host, self._interceptor)
    ...
    def update_bucket(self) -> Callable[
            ...
            logging_config.LogBucket]:
        stub = self._STUBS.get("update_bucket")
        if not stub:
            stub = self._STUBS["update_bucket"] = self._UpdateBucket(self._session, self._host, self._interceptor)
    ...
    def update_cmek_settings(self) -> Callable[
            ...
            logging_config.CmekSettings]:
        stub = self._STUBS.get("update_cmek_settings")
        if not stub:
            stub = self._STUBS["update_cmek_settings"] = self._UpdateCmekSettings(self._session, self._host, self._interceptor)
    ...
    def update_exclusion(self) -> Callable[
            ...
            logging_config.LogExclusion]:
        stub = self._STUBS.get("update_exclusion")
        if not stub:
            stub = self._STUBS["update_exclusion"] = self._UpdateExclusion(self._session, self._host, self._interceptor)
    ...
    def update_settings(self) -> Callable[
            ...
            logging_config.Settings]:
        stub = self._STUBS.get("update_settings")
        if not stub:
            stub = self._STUBS["update_settings"] = self._UpdateSettings(self._session, self._host, self._interceptor)
    ...
    def update_sink(self) -> Callable[
            ...
            logging_config.LogSink]:
        stub = self._STUBS.get("update_sink")
        if not stub:
            stub = self._STUBS["update_sink"] = self._UpdateSink(self._session, self._host, self._interceptor)
    ...
    def update_view(self) -> Callable[
            ...
            logging_config.LogView]:
        stub = self._STUBS.get("update_view")
        if not stub:
            stub = self._STUBS["update_view"] = self._UpdateView(self._session, self._host, self._interceptor)
