...
class ConfigServiceV2AsyncClient:
    ...
    async def list_buckets(self,
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.config_service_v2.pagers.ListBucketsAsyncPager:
    ...
    async def list_views(self,
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.config_service_v2.pagers.ListViewsAsyncPager:
    ...
    async def list_sinks(self,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListSinksRequest`):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.config_service_v2.pagers.ListSinksAsyncPager:
    ...
    async def get_sink(self,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.GetSinkRequest`):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.types.LogSink:
    ...
    async def create_sink(self,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.CreateSinkRequest`):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            sink (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.LogSink`):
    ...
    async def update_sink(self,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.UpdateSinkRequest`):
    ...
    async def delete_sink(self,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.DeleteSinkRequest`):
    ...
    async def list_exclusions(self,
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.config_service_v2.pagers.ListExclusionsAsyncPager:
    ...
    async def create_exclusion(self,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            exclusion (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.LogExclusion`):
    ...
    async def get_cmek_settings(self,
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.types.CmekSettings:
