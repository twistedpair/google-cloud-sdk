...
def _AsMessageList(msg):
  ...
  # This really needs to live in extra_types, but extra_types needs to
  # import this file to be able to register codecs.
  # TODO(craigcitro): Split out a codecs module and fix this ugly import.
  from googlecloudsdk.third_party.apitools.base.py import extra_types  # pylint: disable=g-import-not-at-top
