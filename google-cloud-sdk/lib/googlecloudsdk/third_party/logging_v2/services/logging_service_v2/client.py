...
class LoggingServiceV2Client(metaclass=LoggingServiceV2ClientMeta):
    ...
    def delete_log(self,
        ...
        Args:
            request (google.logging_v2.types.DeleteLogRequest):
    ...
    def write_log_entries(self,
        ...
        Args:
            request (google.logging_v2.types.WriteLogEntriesRequest):
    ...
    def list_log_entries(self,
        ...
        Returns:
            google.logging_v2.services.logging_service_v2.pagers.ListLogEntriesPager:
    ...
    def list_monitored_resource_descriptors(self,
        ...
        Returns:
            google.logging_v2.services.logging_service_v2.pagers.ListMonitoredResourceDescriptorsPager:
    ...
    def list_logs(self,
        ...
        Returns:
            google.logging_v2.services.logging_service_v2.pagers.ListLogsPager:
    ...
    def tail_log_entries(self,
        ...
        Args:
            requests (Iterator[google.logging_v2.types.TailLogEntriesRequest]):
        ...
        Returns:
            Iterable[google.logging_v2.types.TailLogEntriesResponse]:
