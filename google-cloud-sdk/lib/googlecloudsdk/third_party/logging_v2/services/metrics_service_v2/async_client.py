...
from googlecloudsdk.third_party.logging_v2.services.metrics_service_v2 import pagers
...
class MetricsServiceV2AsyncClient:
    ...
    async def list_log_metrics(self,
        ...
        Args:
            request (:class:`google.logging_v2.types.ListLogMetricsRequest`):
        ...
        Returns:
            google.logging_v2.services.metrics_service_v2.pagers.ListLogMetricsAsyncPager:
    ...
    async def get_log_metric(self,
        ...
        Args:
            request (:class:`google.logging_v2.types.GetLogMetricRequest`):
        ...
        Returns:
            google.logging_v2.types.LogMetric:
    ...
    async def create_log_metric(self,
        ...
        Args:
            request (:class:`google.logging_v2.types.CreateLogMetricRequest`):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            metric (:class:`google.logging_v2.types.LogMetric`):
    ...
    async def update_log_metric(self,
        ...
        Args:
            request (:class:`google.logging_v2.types.UpdateLogMetricRequest`):
    ...
    async def delete_log_metric(self,
        ...
        Args:
            request (:class:`google.logging_v2.types.DeleteLogMetricRequest`):
