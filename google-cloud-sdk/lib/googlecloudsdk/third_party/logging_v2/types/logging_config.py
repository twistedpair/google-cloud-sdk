...
class LogBucket(proto.Message):
    ...
    Attributes:
        ...
        locked (bool):
            ...
            if they are empty.
        lifecycle_state (google.logging_v2.types.LifecycleState):
...
class LogSink(proto.Message):
    ...
    BigQuery dataset, a Cloud Pub/Sub topic or a Cloud Logging
    Bucket. A logs filter controls which log entries are exported.
    The sink must be created within a project, organization, billing
    account, or folder.
    ...
    Attributes:
        ...
        exclusions (Sequence[google.logging_v2.types.LogExclusion]):
            ...
            be exported.
        output_version_format (google.logging_v2.types.LogSink.VersionFormat):
        ...
        bigquery_options (google.logging_v2.types.BigQueryOptions):
...
class ListBucketsResponse(proto.Message):
    ...
    Attributes:
        buckets (Sequence[google.logging_v2.types.LogBucket]):
            A list of buckets.
        next_page_token (str):
...
class CreateBucketRequest(proto.Message):
    ...
    Attributes:
        ...
        bucket_id (str):
            ...
            and periods.
        bucket (google.logging_v2.types.LogBucket):
...
class ListViewsResponse(proto.Message):
    ...
    Attributes:
        views (Sequence[google.logging_v2.types.LogView]):
            A list of views.
        next_page_token (str):
            If there might be more results than appear in this response,
            then ``nextPageToken`` is included. To get the next set of
...
class CreateViewRequest(proto.Message):
    ...
    Attributes:
        ...
        view (google.logging_v2.types.LogView):
...
class ListSinksResponse(proto.Message):
    ...
    Attributes:
        sinks (Sequence[google.logging_v2.types.LogSink]):
            A list of sinks.
        next_page_token (str):
            If there might be more results than appear in this response,
            then ``nextPageToken`` is included. To get the next set of
...
class CreateSinkRequest(proto.Message):
    ...
    Attributes:
        ...
        sink (google.logging_v2.types.LogSink):
...
class CreateExclusionRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            Examples: ``"projects/my-logging-project"``,
            ``"organizations/123456789"``.
        exclusion (google.logging_v2.types.LogExclusion):
...
class UpdateCmekSettingsRequest(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            configured for GCP organizations. Once configured, it
            applies to all projects and folders in the GCP organization.
        cmek_settings (google.logging_v2.types.CmekSettings):
