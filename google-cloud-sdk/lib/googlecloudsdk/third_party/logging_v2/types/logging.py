...
class WriteLogEntriesRequest(proto.Message):
    ...
    Attributes:
        ...
        labels (Sequence[google.logging_v2.types.WriteLogEntriesRequest.LabelsEntry]):
            ...
            [LogEntry][google.logging.v2.LogEntry].
        entries (Sequence[google.logging_v2.types.LogEntry]):
...
class WriteLogEntriesPartialErrors(proto.Message):
    ...
    Attributes:
        log_entry_errors (Sequence[google.logging_v2.types.WriteLogEntriesPartialErrors.LogEntryErrorsEntry]):
...
class TailLogEntriesResponse(proto.Message):
    ...
    Attributes:
        entries (Sequence[google.logging_v2.types.LogEntry]):
            ...
            separate responses.
        suppression_info (Sequence[google.logging_v2.types.TailLogEntriesResponse.SuppressionInfo]):
    ...
    class SuppressionInfo(proto.Message):
        ...
        Attributes:
            reason (google.logging_v2.types.TailLogEntriesResponse.SuppressionInfo.Reason):
