...
class LogMetric(proto.Message):
    ...
    Attributes:
        ...
        label_extractors (Sequence[google.logging_v2.types.LogMetric.LabelExtractorsEntry]):
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            metric.
            This field may not be present for older metrics.
        version (google.logging_v2.types.LogMetric.ApiVersion):
...
class ListLogMetricsResponse(proto.Message):
    ...
    Attributes:
        metrics (Sequence[google.logging_v2.types.LogMetric]):
...
class CreateLogMetricRequest(proto.Message):
    ...
    Attributes:
        ...
        metric (google.logging_v2.types.LogMetric):
