...
from googlecloudsdk.third_party.apis.memcache.v1 import memcache_v1_messages as messages
...
class MemcacheV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsInstancesService(base_api.BaseApiService):
    ...
    ApplySoftwareUpdate.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:applySoftwareUpdate',
        http_method='POST',
        method_id='memcache.projects.locations.instances.applySoftwareUpdate',
        ordered_params=['instance'],
        path_params=['instance'],
        query_params=[],
        relative_path='v1/{+instance}:applySoftwareUpdate',
