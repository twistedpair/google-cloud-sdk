...
class SearchOrganizationsRequest(_messages.Message):
  ...
  Fields:
    filter: An optional query string used to filter the Organizations to
      ...
      `domain`, where the domain is a G Suite domain, for example:  clang-
      format off | Filter                              | Description
      | |-------------------------------------|-------------------------------
      ---| | owner.directorycustomerid:123456789 | Organizations with
      `owner.directory_customer_id` equal to `123456789`.| | domain:google.com
      | Organizations corresponding to the domain `google.com`.| clang-format
