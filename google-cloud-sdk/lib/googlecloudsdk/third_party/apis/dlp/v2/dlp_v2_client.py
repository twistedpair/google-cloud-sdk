...
more.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[u'location', u'orderBy', u'pageSize', u'pageToken'],
        relative_path=u'v2/{+parent}/deidentifyTemplates',
        request_field='',
...
more.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2/organizations/{organizationsId}/locations/{location}/deidentifyTemplates',
        http_method=u'POST',
        ...
        query_params=[],
        relative_path=u'v2/{+parent}/locations/{location}/deidentifyTemplates',
        request_field=u'googlePrivacyDlpV2CreateDeidentifyTemplateRequest',
...
See https://cloud.google.com/dlp/docs/creating-templates to learn more.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2/organizations/{organizationsId}/locations/{location}/inspectTemplates',
        http_method=u'POST',
        method_id=u'dlp.organizations.locations.inspectTemplates.create',
        ordered_params=[u'parent', u'location'],
        path_params=[u'location', u'parent'],
        query_params=[],
        relative_path=u'v2/{+parent}/locations/{location}/inspectTemplates',
        request_field=u'googlePrivacyDlpV2CreateInspectTemplateRequest',
...
learn more.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2/organizations/{organizationsId}/locations/{location}/storedInfoTypes',
        http_method=u'POST',
        method_id=u'dlp.organizations.locations.storedInfoTypes.create',
        ordered_params=[u'parent', u'location'],
        path_params=[u'location', u'parent'],
        query_params=[],
        relative_path=u'v2/{+parent}/locations/{location}/storedInfoTypes',
...
https://cloud.google.com/dlp/docs/compute-risk-analysis to learn more.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[u'filter', u'location', u'orderBy', u'pageSize', u'pageToken', u'type'],
        relative_path=u'v2/{+parent}/dlpJobs',
        request_field='',
...
See https://cloud.google.com/dlp/docs/creating-job-triggers to learn more.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[u'filter', u'location', u'orderBy', u'pageSize', u'pageToken'],
        relative_path=u'v2/{+parent}/jobTriggers',
        request_field='',
...
more.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2/projects/{projectsId}/locations/{location}/deidentifyTemplates',
        http_method=u'POST',
...
be all types, but may change over time as detectors are updated.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2/projects/{projectsId}/locations/{location}/dlpJobs',
        http_method=u'POST',
        method_id=u'dlp.projects.locations.dlpJobs.create',
        ordered_params=[u'parent', u'location'],
        path_params=[u'location', u'parent'],
        query_params=[],
        relative_path=u'v2/{+parent}/locations/{location}/dlpJobs',
        request_field=u'googlePrivacyDlpV2CreateDlpJobRequest',
...
See https://cloud.google.com/dlp/docs/creating-templates to learn more.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2/projects/{projectsId}/locations/{location}/inspectTemplates',
        http_method=u'POST',
...
See https://cloud.google.com/dlp/docs/creating-job-triggers to learn more.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2/projects/{projectsId}/locations/{location}/jobTriggers',
        http_method=u'POST',
        method_id=u'dlp.projects.locations.jobTriggers.create',
        ordered_params=[u'parent', u'location'],
        path_params=[u'location', u'parent'],
        query_params=[],
        relative_path=u'v2/{+parent}/locations/{location}/jobTriggers',
        request_field=u'googlePrivacyDlpV2CreateJobTriggerRequest',
...
learn more.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2/projects/{projectsId}/locations/{location}/storedInfoTypes',
        http_method=u'POST',
