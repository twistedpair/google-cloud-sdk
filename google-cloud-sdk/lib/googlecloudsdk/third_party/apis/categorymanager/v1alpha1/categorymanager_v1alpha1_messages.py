"""Generated message classes for categorymanager version v1alpha1.
...
class Annotation(_messages.Message):
  ...
  parentAnnotationId = _messages.StringField(6)
...
class AnnotationTag(_messages.Message):
  ...
  annotationName = _messages.StringField(3)
  assetName = _messages.StringField(4)
  storeId = _messages.StringField(5)
  subAssetName = _messages.StringField(6)
  taxonomyDisplayName = _messages.StringField(7)
  taxonomyId = _messages.StringField(8)
...
class ApplyAnnotationTagRequest(_messages.Message):
  ...
  Fields:
    annotationName: [Required] Resource name of the annotation tag.
  ...
  subAssetName = _messages.StringField(2)
...
class CategorymanagerAssetsAnnotationTagsListRequest(_messages.Message):
  ...
  subAssetName = _messages.StringField(4)
...
class CategorymanagerAssetsDeleteAnnotationTagRequest(_messages.Message):
  ...
  Fields:
    annotationName: [Required] Resource name of the annotation tag to be
      removed. The request will be failed with a NOT_FOUND error if the
      annotation is not tagged on the given asset / sub asset.
    name: [Required] Resource name of the asset whose annotation tag is to be
      removed.
    subAssetName: A finer grained sub asset whose annotation tag is to be
      removed. For Bigquery, provide the name of the column that contains the
  ...
  annotationName = _messages.StringField(1)
  name = _messages.StringField(2, required=True)
  subAssetName = _messages.StringField(3)


class CategorymanagerAssetsListResourceNamesRequest(_messages.Message):
  """A CategorymanagerAssetsListResourceNamesRequest object.

  Fields:
    annotations: Resource names of annotations to be looked up.
    filter: A filter string that includes additional predicates for assets.
    includeAnnotatedByGroup: If set to true, for any annotation with child
      annotations, also list assets that are annotated by those child
      annotations.
    pageSize: The maximum number of items to return.
    pageToken: The next_page_token value returned from a previous List
      request, if any.
  ...
  includeAnnotatedByGroup = _messages.BooleanField(3)
...
class CategorymanagerTaxonomyStoresGetDefaultRequest(_messages.Message):
  """A CategorymanagerTaxonomyStoresGetDefaultRequest object.
...
class CopyAnnotationRequest(_messages.Message):
  ...
  Fields:
    ...
    sourceAnnotationName: [Required] Resource name of the annotation to be
      copied from.
  """
...
class CopyTaxonomyRequest(_messages.Message):
  ...
  Fields:
    sourceTaxonomyName: [Required] Resource name of the taxonomy to be copied
      from.
  """
...
class ListAssetsResponse(_messages.Message):
  """Response message for "TaggingApi.ListAssets".
