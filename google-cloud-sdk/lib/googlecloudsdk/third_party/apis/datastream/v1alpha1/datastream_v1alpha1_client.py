...
from googlecloudsdk.third_party.apis.datastream.v1alpha1 import datastream_v1alpha1_messages as messages
...
class DatastreamV1alpha1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsStreamsService(base_api.BaseApiService):
    ...
    def Pause(self, request, global_params=None):
      r"""Use this method to pause a running stream.
    ...
    Pause.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/streams/{streamsId}:pause',
        http_method='POST',
        method_id='datastream.projects.locations.streams.pause',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:pause',
        request_field='pauseStreamRequest',
        request_type_name='DatastreamProjectsLocationsStreamsPauseRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Resume(self, request, global_params=None):
      r"""Use this method to resume a paused stream.
    ...
    Resume.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/streams/{streamsId}:resume',
        http_method='POST',
        method_id='datastream.projects.locations.streams.resume',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:resume',
        request_field='resumeStreamRequest',
        request_type_name='DatastreamProjectsLocationsStreamsResumeRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Start(self, request, global_params=None):
      r"""Use this method to start a stream.
    ...
    Start.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/streams/{streamsId}:start',
        http_method='POST',
        method_id='datastream.projects.locations.streams.start',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:start',
        request_field='startStreamRequest',
        request_type_name='DatastreamProjectsLocationsStreamsStartRequest',
        response_type_name='Operation',
        supports_download=False,
    )
