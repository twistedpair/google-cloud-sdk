"""Generated client library for dns version v2beta1."""
# NOTE: This file is autogenerated and should not be edited by hand.
from apitools.base.py import base_api
from googlecloudsdk.third_party.apis.dns.v2beta1 import dns_v2beta1_messages as messages


class DnsV2beta1(base_api.BaseApiClient):
  """Generated client library for service dns version v2beta1."""

  MESSAGES_MODULE = messages
  BASE_URL = u'https://www.googleapis.com/dns/v2beta1/'
  ...
  _CLIENT_CLASS_NAME = u'DnsV2beta1'
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(DnsV2beta1, self).__init__(
  ...
  class ChangesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DnsV2beta1.ChangesService, self).__init__(client)
  ...
  class DnsKeysService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DnsV2beta1.DnsKeysService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ManagedZoneOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DnsV2beta1.ManagedZoneOperationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ManagedZonesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DnsV2beta1.ManagedZonesService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DnsV2beta1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ResourceRecordSetsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(DnsV2beta1.ResourceRecordSetsService, self).__init__(client)
      self._upload_configs = {
          }
