...
class ApigatewayApiConfig(_messages.Message):
  ...
  labels = _messages.MessageField('LabelsValue', 4)
  name = _messages.StringField(5)
  serviceRollout = _messages.MessageField('ApigatewayApiConfigManagedServiceRollout', 6)
...
class ApigatewayApiConfigManagedServiceRollout(_messages.Message):
  ...
  Fields:
    rolloutId: Required. The Rollout ID for the Managed Service. See
      https://cloud.google.com/service-infrastructure/docs/rollout for more
      info.
    serviceConfig: The Service Config to rollout.
  """

  rolloutId = _messages.StringField(1)
  serviceConfig = _messages.MessageField('ApigatewayService', 2)
...
class ApigatewayAuthProvider(_messages.Message):
...
class ApigatewayAuthRequirement(_messages.Message):
...
class ApigatewayAuthentication(_messages.Message):
  ...
  providers = _messages.MessageField('ApigatewayAuthProvider', 1, repeated=True)
  rules = _messages.MessageField('ApigatewayAuthenticationRule', 2, repeated=True)


class ApigatewayAuthenticationRule(_messages.Message):
  ...
  oauth = _messages.MessageField('ApigatewayOAuthRequirements', 2)
  requirements = _messages.MessageField('ApigatewayAuthRequirement', 3, repeated=True)
  selector = _messages.StringField(4)


class ApigatewayBackend(_messages.Message):
  ...
  rules = _messages.MessageField('ApigatewayBackendRule', 1, repeated=True)
...
class ApigatewayBackendRule(_messages.Message):
...
class ApigatewayBilling(_messages.Message):
  ...
  consumerDestinations = _messages.MessageField('ApigatewayBillingBillingDestination', 1, repeated=True)


class ApigatewayBillingBillingDestination(_messages.Message):
...
class ApigatewayContext(_messages.Message):
  ...
  rules = _messages.MessageField('ApigatewayContextRule', 1, repeated=True)


class ApigatewayContextRule(_messages.Message):
...
class ApigatewayControl(_messages.Message):
...
class ApigatewayCustomError(_messages.Message):
  ...
  rules = _messages.MessageField('ApigatewayCustomErrorRule', 1, repeated=True)
  types = _messages.StringField(2, repeated=True)


class ApigatewayCustomErrorRule(_messages.Message):
...
class ApigatewayCustomHttpPattern(_messages.Message):
...
class ApigatewayDocumentation(_messages.Message):
  ...
  pages = _messages.MessageField('ApigatewayPage', 3, repeated=True)
  rules = _messages.MessageField('ApigatewayDocumentationRule', 4, repeated=True)
  serviceRootUrl = _messages.StringField(5)
  summary = _messages.StringField(6)


class ApigatewayDocumentationRule(_messages.Message):
...
class ApigatewayEndpoint(_messages.Message):
...
class ApigatewayGateway(_messages.Message):
  r"""A Gateway is an API-aware HTTP proxy. It performs API-operation and/or
  ...
  Fields:
    ...
    createTime: Output only. Created time.
    defaultHostname: Output only. The default API Gateway host name. This is
      static and takes the form
      `{gateway_id}.{project}.{region}.gateway.cloud`. This is implemented as
      a DNS A record on the external IP of the Gateway.
    displayName: Optional. Display name.
    labels: Optional. Resource labels to represent user-provided metadata.
      Refer to cloud documentation on labels for more details.
      https://cloud.google.com/compute/docs/labeling-resources
    ...
    serviceAccount: Output only. The service account (identity) the gateway
      runs as in the resource project.
  ...
  serviceAccount = _messages.MessageField('ApigatewayServiceAccount', 7)
...
class ApigatewayHttp(_messages.Message):
  ...
  rules = _messages.MessageField('ApigatewayHttpRule', 2, repeated=True)


class ApigatewayHttpRule(_messages.Message):
  ...
  additionalBindings = _messages.MessageField('ApigatewayHttpRule', 1, repeated=True)
  allowHalfDuplex = _messages.BooleanField(2)
  body = _messages.StringField(3)
  custom = _messages.MessageField('ApigatewayCustomHttpPattern', 4)
...
class ApigatewayLabelDescriptor(_messages.Message):
...
class ApigatewayLogDescriptor(_messages.Message):
  ...
  description = _messages.StringField(1)
  displayName = _messages.StringField(2)
  labels = _messages.MessageField('ApigatewayLabelDescriptor', 3, repeated=True)
  name = _messages.StringField(4)


class ApigatewayLogging(_messages.Message):
  ...
  consumerDestinations = _messages.MessageField('ApigatewayLoggingLoggingDestination', 1, repeated=True)
  producerDestinations = _messages.MessageField('ApigatewayLoggingLoggingDestination', 2, repeated=True)


class ApigatewayLoggingLoggingDestination(_messages.Message):
...
class ApigatewayMetricDescriptor(_messages.Message):
  ...
  metadata = _messages.MessageField('ApigatewayMetricDescriptorMetricDescriptorMetadata', 5)
...
class ApigatewayMetricDescriptorMetricDescriptorMetadata(_messages.Message):
...
class ApigatewayMetricRule(_messages.Message):
...
class ApigatewayMonitoredResourceDescriptor(_messages.Message):
...
class ApigatewayMonitoring(_messages.Message):
  ...
  consumerDestinations = _messages.MessageField('ApigatewayMonitoringMonitoringDestination', 1, repeated=True)
  producerDestinations = _messages.MessageField('ApigatewayMonitoringMonitoringDestination', 2, repeated=True)


class ApigatewayMonitoringMonitoringDestination(_messages.Message):
...
class ApigatewayOAuthRequirements(_messages.Message):
...
class ApigatewayPage(_messages.Message):
  ...
  subpages = _messages.MessageField('ApigatewayPage', 3, repeated=True)
...
class ApigatewayQuota(_messages.Message):
  ...
  limits = _messages.MessageField('ApigatewayQuotaLimit', 1, repeated=True)
  metricRules = _messages.MessageField('ApigatewayMetricRule', 2, repeated=True)


class ApigatewayQuotaLimit(_messages.Message):
...
class ApigatewayService(_messages.Message):
  ...
  authentication = _messages.MessageField('ApigatewayAuthentication', 2)
  backend = _messages.MessageField('ApigatewayBackend', 3)
  billing = _messages.MessageField('ApigatewayBilling', 4)
  configVersion = _messages.IntegerField(5, variant=_messages.Variant.UINT32)
  context = _messages.MessageField('ApigatewayContext', 6)
  control = _messages.MessageField('ApigatewayControl', 7)
  customError = _messages.MessageField('ApigatewayCustomError', 8)
  documentation = _messages.MessageField('ApigatewayDocumentation', 9)
  endpoints = _messages.MessageField('ApigatewayEndpoint', 10, repeated=True)
  enums = _messages.MessageField('Enum', 11, repeated=True)
  http = _messages.MessageField('ApigatewayHttp', 12)
  id = _messages.StringField(13)
  logging = _messages.MessageField('ApigatewayLogging', 14)
  logs = _messages.MessageField('ApigatewayLogDescriptor', 15, repeated=True)
  metrics = _messages.MessageField('ApigatewayMetricDescriptor', 16, repeated=True)
  monitoredResources = _messages.MessageField('ApigatewayMonitoredResourceDescriptor', 17, repeated=True)
  monitoring = _messages.MessageField('ApigatewayMonitoring', 18)
  name = _messages.StringField(19)
  producerProjectId = _messages.StringField(20)
  quota = _messages.MessageField('ApigatewayQuota', 21)
  sourceInfo = _messages.MessageField('ApigatewaySourceInfo', 22)
  systemParameters = _messages.MessageField('ApigatewaySystemParameters', 23)
  ...
  usage = _messages.MessageField('ApigatewayUsage', 27)


class ApigatewayServiceAccount(_messages.Message):
  r"""Service Account options for an API Gateway.

  Fields:
    email: The service account email.
    scopes: The access scopes of the service account.
  """
...
class ApigatewayServiceIdentity(_messages.Message):
...
class ApigatewaySourceInfo(_messages.Message):
...
class ApigatewaySystemParameter(_messages.Message):
...
class ApigatewaySystemParameterRule(_messages.Message):
  ...
  parameters = _messages.MessageField('ApigatewaySystemParameter', 1, repeated=True)
  selector = _messages.StringField(2)


class ApigatewaySystemParameters(_messages.Message):
  ...
  rules = _messages.MessageField('ApigatewaySystemParameterRule', 1, repeated=True)
...
class ApigatewayUsage(_messages.Message):
  ...
  rules = _messages.MessageField('ApigatewayUsageRule', 3, repeated=True)
  serviceIdentity = _messages.MessageField('ApigatewayServiceIdentity', 4)


class ApigatewayUsageRule(_messages.Message):
