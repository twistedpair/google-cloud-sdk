...
class DestinationTableProperties(_messages.Message):
  ...
  Fields:
    ...
    expirationTimestampMillis: [Optional] The expiration timestamp for the
      destination table. If this field is set: For a new table, it will set
      the table's expiration time (even if there is a dataset level default
      table expiration time). For an existing table, it will update the
      table's expiration time. If this field is not set: For a new table, if
  ...
  expirationTimestampMillis = _messages.IntegerField(2)
