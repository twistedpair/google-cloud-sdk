...
class SqladminV1beta4(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    url = url or u'https://www.googleapis.com/sql/v1beta4/'
  ...
  class InstancesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'Failover': base_api.ApiMethodInfo(
              http_method=u'POST',
          ...
          'StartReplica': base_api.ApiMethodInfo(
              http_method=u'POST',
          ...
          'StopReplica': base_api.ApiMethodInfo(
              http_method=u'POST',
  ...
  class SslCertsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          'CreateEphemeral': base_api.ApiMethodInfo(
              http_method=u'POST',
