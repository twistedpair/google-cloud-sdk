...
class GoogleCloudCommerceConsumerProcurementV1alpha1Entitlement(_messages.Message):
  ...
  Fields:
    account: Output only. Account associated with this entitlement, field is
      empty if the entitlement is not based on an account. In the format of
      `billingAccounts/<billing-account-id>/accounts/{account_id}`.
  ...
  changeHistory = _messages.MessageField('GoogleCloudCommerceConsumerProcurementV1alpha1EntitlementChange', 2, repeated=True)
  createTime = _messages.StringField(3)
  flavorExternalName = _messages.StringField(4)
  name = _messages.StringField(5)
  order = _messages.StringField(6)
  pendingChange = _messages.MessageField('GoogleCloudCommerceConsumerProcurementV1alpha1EntitlementChange', 7)
  productExternalName = _messages.StringField(8)
  provider = _messages.StringField(9)
  services = _messages.MessageField('GoogleCloudCommerceConsumerProcurementV1alpha1EntitlementService', 10, repeated=True)
