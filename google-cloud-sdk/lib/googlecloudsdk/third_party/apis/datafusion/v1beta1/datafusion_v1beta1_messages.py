...
class Instance(_messages.Message):
  ...
  Fields:
    ...
    serviceAccount: Output only. Service account output for use in
      peering&mdash;see [Set up VPC Network Peering](/data-fusion/docs/how-
      to/create-private-ip#set_up_network_peering).
