...
class GoogleCloudApigeeV1Environment(_messages.Message):
  ...
  createdAt = _messages.IntegerField(1)
  deploymentType = _messages.EnumField('DeploymentTypeValueValuesEnum', 2)
  description = _messages.StringField(3)
  displayName = _messages.StringField(4)
  lastModifiedAt = _messages.IntegerField(5)
  name = _messages.StringField(6)
  properties = _messages.MessageField('GoogleCloudApigeeV1Properties', 7)
