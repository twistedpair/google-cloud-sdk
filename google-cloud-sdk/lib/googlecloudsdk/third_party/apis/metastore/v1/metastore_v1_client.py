...
from googlecloudsdk.third_party.apis.metastore.v1 import metastore_v1_messages as messages
...
class MetastoreV1(base_api.BaseApiClient):
  ...
  class OperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(MetastoreV1.OperationsService, self).__init__(client)
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='POST',
        method_id='metastore.operations.cancel',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:cancel',
        request_field='cancelOperationRequest',
        request_type_name='MetastoreOperationsCancelRequest',
