...
from googlecloudsdk.third_party.apis.clouddeploy.v1 import clouddeploy_v1_messages as messages
...
class ClouddeployV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsDeliveryPipelinesReleasesRolloutsService(base_api.BaseApiService):
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/deliveryPipelines/{deliveryPipelinesId}/releases/{releasesId}/rollouts/{rolloutsId}:testIamPermissions',
        http_method='POST',
  ...
  class ProjectsLocationsDeliveryPipelinesReleasesService(base_api.BaseApiService):
    ...
    Promote.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/deliveryPipelines/{deliveryPipelinesId}/releases/{releasesId}:promote',
        http_method='POST',
        ...
        request_field='promoteReleaseRequest',
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/deliveryPipelines/{deliveryPipelinesId}/releases/{releasesId}:testIamPermissions',
        http_method='POST',
  ...
  class ProjectsLocationsDeliveryPipelinesTargetsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ClouddeployV1.ProjectsLocationsDeliveryPipelinesTargetsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/deliveryPipelines/{deliveryPipelinesId}/targets',
        http_method='POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/deliveryPipelines/{deliveryPipelinesId}/targets/{targetsId}',
        http_method='DELETE',
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/deliveryPipelines/{deliveryPipelinesId}/targets/{targetsId}:testIamPermissions',
        http_method='POST',
