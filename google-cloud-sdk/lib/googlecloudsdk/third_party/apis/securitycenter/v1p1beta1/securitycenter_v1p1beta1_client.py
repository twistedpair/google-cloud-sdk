...
class SecuritycenterV1p1beta1(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = 'SecuritycenterV1p1beta1'
...
properties.
    ...
    Group.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/assets:group',
        http_method='POST',
        method_id='securitycenter.organizations.assets.group',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1p1beta1/{+parent}/assets:group',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/assets',
        http_method='GET',
        ...
        relative_path='v1p1beta1/{+parent}/assets',
        request_field='',
...
error.
    ...
    RunDiscovery.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/assets:runDiscovery',
        http_method='POST',
        method_id='securitycenter.organizations.assets.runDiscovery',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1p1beta1/{+parent}/assets:runDiscovery',
...
Updates security marks.
    ...
    UpdateSecurityMarks.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/assets/{assetsId}/securityMarks',
        http_method='PATCH',
        ...
        request_field='googleCloudSecuritycenterV1p1beta1SecurityMarks',
        request_type_name='SecuritycenterOrganizationsAssetsUpdateSecurityMarksRequest',
        response_type_name='GoogleCloudSecuritycenterV1p1beta1SecurityMarks',
        supports_download=False,
    )
  ...
  class OrganizationsNotificationConfigsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/notificationConfigs',
        http_method='POST',
        method_id='securitycenter.organizations.notificationConfigs.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['configId'],
        relative_path='v1p1beta1/{+parent}/notificationConfigs',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/notificationConfigs/{notificationConfigsId}',
        http_method='DELETE',
...
corresponding to `Code.CANCELLED`.
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/operations/{operationsId}:cancel',
        http_method='POST',
        method_id='securitycenter.organizations.operations.cancel',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1p1beta1/{+name}:cancel',
        request_field='',
...
`google.rpc.Code.UNIMPLEMENTED`.
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/operations/{operationsId}',
        http_method='DELETE',
...
is the parent resource, without the operations collection id.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/operations',
        http_method='GET',
...
creation to succeed.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}/findings',
        http_method='POST',
        method_id='securitycenter.organizations.sources.findings.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['findingId'],
        relative_path='v1p1beta1/{+parent}/findings',
        request_field='googleCloudSecuritycenterV1p1beta1Finding',
        request_type_name='SecuritycenterOrganizationsSourcesFindingsCreateRequest',
        response_type_name='GoogleCloudSecuritycenterV1p1beta1Finding',
        supports_download=False,
    )
...
Example: /v1p1beta1/organizations/{organization_id}/sources/-/findings
    ...
    Group.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}/findings:group',
        http_method='POST',
        method_id='securitycenter.organizations.sources.findings.group',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1p1beta1/{+parent}/findings:group',
...
finding creation to succeed.
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}/findings/{findingsId}',
        http_method='PATCH',
...
Updates the state of a finding.
    ...
    SetState.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}/findings/{findingsId}:setState',
        http_method='POST',
        method_id='securitycenter.organizations.sources.findings.setState',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1p1beta1/{+name}:setState',
...
Updates security marks.
    ...
    UpdateSecurityMarks.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}/findings/{findingsId}/securityMarks',
        http_method='PATCH',
  ...
  class OrganizationsSourcesService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources',
        http_method='POST',
        method_id='securitycenter.organizations.sources.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1p1beta1/{+parent}/sources',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}',
        http_method='GET',
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}:getIamPolicy',
        http_method='POST',
        method_id='securitycenter.organizations.sources.getIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1p1beta1/{+resource}:getIamPolicy',
...
Updates a source.
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}:setIamPolicy',
        http_method='POST',
        method_id='securitycenter.organizations.sources.setIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1p1beta1/{+resource}:setIamPolicy',
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/sources/{sourcesId}:testIamPermissions',
        http_method='POST',
        method_id='securitycenter.organizations.sources.testIamPermissions',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1p1beta1/{+resource}:testIamPermissions',
  ...
  class OrganizationsService(base_api.BaseApiService):
    ...
    GetOrganizationSettings.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1p1beta1/organizations/{organizationsId}/organizationSettings',
        http_method='GET',
