"""Generated message classes for securitycenter version v1p1beta1.
...
class NotificationConfig(_messages.Message):
  r"""Security Command Center notification configs.  A notification config is
  a Security Command Center resource that contains the configuration to send
  notifications for create/update events of findings, assets and etc.

  Enums:
    EventTypeValueValuesEnum: The type of events the config is for, e.g.
      FINDING.
  ...
  class EventTypeValueValuesEnum(_messages.Enum):
    r"""The type of events the config is for, e.g. FINDING.
...
class SecuritycenterOrganizationsAssetsUpdateSecurityMarksRequest(_messages.Message):
  ...
  Fields:
    googleCloudSecuritycenterV1p1beta1SecurityMarks: A
      GoogleCloudSecuritycenterV1p1beta1SecurityMarks resource to be passed as
      the request body.
    name: The relative resource name of the SecurityMarks. See:
      https://cloud.google.com/apis/design/resource_names#relative_resource_na
      me Examples:
  ...
  googleCloudSecuritycenterV1p1beta1SecurityMarks = _messages.MessageField('GoogleCloudSecuritycenterV1p1beta1SecurityMarks', 1)
...
class SecuritycenterOrganizationsSourcesFindingsCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    googleCloudSecuritycenterV1p1beta1Finding: A
      GoogleCloudSecuritycenterV1p1beta1Finding resource to be passed as the
      request body.
  ...
  googleCloudSecuritycenterV1p1beta1Finding = _messages.MessageField('GoogleCloudSecuritycenterV1p1beta1Finding', 2)
  parent = _messages.StringField(3, required=True)
...
class SecuritycenterOrganizationsSourcesFindingsPatchRequest(_messages.Message):
  ...
  googleCloudSecuritycenterV1p1beta1Finding = _messages.MessageField('GoogleCloudSecuritycenterV1p1beta1Finding', 1)
  name = _messages.StringField(2, required=True)
  updateMask = _messages.StringField(3)
