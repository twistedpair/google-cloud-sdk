...
class NetworkservicesV1alpha1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsRoutersService(base_api.BaseApiService):
    """Service class for the projects_locations_routers resource."""

    _NAME = 'projects_locations_routers'

    def __init__(self, client):
      super(NetworkservicesV1alpha1.ProjectsLocationsRoutersService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Create(self, request, global_params=None):
      ...
      Args:
        request: (NetworkservicesProjectsLocationsRoutersCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/routers',
        http_method='POST',
        method_id='networkservices.projects.locations.routers.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['routerId'],
        relative_path='v1alpha1/{+parent}/routers',
        request_field='router',
        request_type_name='NetworkservicesProjectsLocationsRoutersCreateRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (NetworkservicesProjectsLocationsRoutersDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='DELETE',
        method_id='networkservices.projects.locations.routers.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}',
        request_field='',
        request_type_name='NetworkservicesProjectsLocationsRoutersDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (NetworkservicesProjectsLocationsRoutersGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/routers/{routersId}',
        http_method='GET',
        method_id='networkservices.projects.locations.routers.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}',
        request_field='',
        request_type_name='NetworkservicesProjectsLocationsRoutersGetRequest',
    ...
    def GetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (NetworkservicesProjectsLocationsRoutersGetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Policy) The response message.
      """
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/routers/{routersId}:getIamPolicy',
        http_method='GET',
        method_id='networkservices.projects.locations.routers.getIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=['options_requestedPolicyVersion'],
        relative_path='v1alpha1/{+resource}:getIamPolicy',
        request_field='',
        request_type_name='NetworkservicesProjectsLocationsRoutersGetIamPolicyRequest',
        response_type_name='Policy',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (NetworkservicesProjectsLocationsRoutersListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/routers',
        http_method='GET',
        method_id='networkservices.projects.locations.routers.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1alpha1/{+parent}/routers',
        request_field='',
        request_type_name='NetworkservicesProjectsLocationsRoutersListRequest',
    ...
    def Patch(self, request, global_params=None):
      ...
      Args:
        request: (NetworkservicesProjectsLocationsRoutersPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/routers/{routersId}',
        http_method='PATCH',
        method_id='networkservices.projects.locations.routers.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['updateMask'],
        relative_path='v1alpha1/{+name}',
        request_field='router',
        request_type_name='NetworkservicesProjectsLocationsRoutersPatchRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def SetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (NetworkservicesProjectsLocationsRoutersSetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Policy) The response message.
      """
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/routers/{routersId}:setIamPolicy',
        http_method='POST',
        method_id='networkservices.projects.locations.routers.setIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha1/{+resource}:setIamPolicy',
        request_field='setIamPolicyRequest',
        request_type_name='NetworkservicesProjectsLocationsRoutersSetIamPolicyRequest',
        response_type_name='Policy',
        supports_download=False,
    )
    ...
    def TestIamPermissions(self, request, global_params=None):
      ...
      Args:
        request: (NetworkservicesProjectsLocationsRoutersTestIamPermissionsRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (TestIamPermissionsResponse) The response message.
      """
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/routers/{routersId}:testIamPermissions',
        http_method='POST',
        method_id='networkservices.projects.locations.routers.testIamPermissions',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha1/{+resource}:testIamPermissions',
        request_field='testIamPermissionsRequest',
        request_type_name='NetworkservicesProjectsLocationsRoutersTestIamPermissionsRequest',
        response_type_name='TestIamPermissionsResponse',
        supports_download=False,
    )
