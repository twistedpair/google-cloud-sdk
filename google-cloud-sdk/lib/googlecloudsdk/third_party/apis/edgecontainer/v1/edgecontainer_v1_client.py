...
class EdgecontainerV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsSitesMachinesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsSitesMachinesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/sites/{sitesId}/machines/{machinesId}',
        http_method='GET',
  ...
  class ProjectsLocationsSitesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1.ProjectsLocationsSitesService, self).__init__(client)
      self._upload_configs = {
          }
