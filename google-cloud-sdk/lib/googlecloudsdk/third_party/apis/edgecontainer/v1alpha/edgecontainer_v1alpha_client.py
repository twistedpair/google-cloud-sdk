...
from googlecloudsdk.third_party.apis.edgecontainer.v1alpha import edgecontainer_v1alpha_messages as messages
...
class EdgecontainerV1alpha(base_api.BaseApiClient):
  ...
  class ProjectsLocationsSitesMachinesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1alpha.ProjectsLocationsSitesMachinesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/sites/{sitesId}/machines/{machinesId}',
        http_method='GET',
  ...
  class ProjectsLocationsSitesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(EdgecontainerV1alpha.ProjectsLocationsSitesService, self).__init__(client)
      self._upload_configs = {
          }
