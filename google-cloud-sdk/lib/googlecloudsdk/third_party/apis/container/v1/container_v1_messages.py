...
class ContainerMasterProjectsLocationsProjectsClustersGetRepairworkRequest(_messages.Message):
  """A ContainerMasterProjectsLocationsProjectsClustersGetRepairworkRequest
  object.

  Fields:
    clusterId: Cluster name of the cluster this master manages.
    location: Location of the hosted master.
    masterProjectId: Project Number of the Hosted Master Project.
