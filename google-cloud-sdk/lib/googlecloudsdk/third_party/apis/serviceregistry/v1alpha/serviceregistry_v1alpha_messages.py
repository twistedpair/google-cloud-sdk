...
class Endpoint(_messages.Message):
  ...
  Fields:
    ...
    dnsName: [Output Only] Fully qualified domain name for the endpoint.
  ...
  dnsName = _messages.StringField(5)
...
class EndpointPort(_messages.Message):
  ...
  Fields:
    name: User provided name of the port. It's optional if only one port is
      defined for the endpoint.
    portNumber: User provided port number of the endpoint.
    protocol: Optional user provided protocol for this port. Must be one of
      the following well known protocol strings: tcp, udp, icmp, esp, ah or
      sctp. Default is tcp.
  """
