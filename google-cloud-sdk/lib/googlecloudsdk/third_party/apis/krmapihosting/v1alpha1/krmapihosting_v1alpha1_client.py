...
from googlecloudsdk.third_party.apis.krmapihosting.v1alpha1 import krmapihosting_v1alpha1_messages as messages
...
class KrmapihostingV1alpha1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsAnthosApiEndpointsService(base_api.BaseApiService):
    """Service class for the projects_locations_anthosApiEndpoints resource."""

    _NAME = 'projects_locations_anthosApiEndpoints'

    def __init__(self, client):
      super(KrmapihostingV1alpha1.ProjectsLocationsAnthosApiEndpointsService, self).__init__(client)
      self._upload_configs = {
          }

    def Create(self, request, global_params=None):
      r"""Creates a new AnthosApiEndpoint in a given project and location.

      Args:
        request: (KrmapihostingProjectsLocationsAnthosApiEndpointsCreateRequest) input message
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/anthosApiEndpoints',
        http_method='POST',
        method_id='krmapihosting.projects.locations.anthosApiEndpoints.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['anthosApiEndpointId', 'requestId'],
        relative_path='v1alpha1/{+parent}/anthosApiEndpoints',
        request_field='anthosApiEndpoint',
        request_type_name='KrmapihostingProjectsLocationsAnthosApiEndpointsCreateRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Delete(self, request, global_params=None):
      r"""Deletes a single AnthosApiEndpoint.

      Args:
        request: (KrmapihostingProjectsLocationsAnthosApiEndpointsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/anthosApiEndpoints/{anthosApiEndpointsId}',
        http_method='DELETE',
        method_id='krmapihosting.projects.locations.anthosApiEndpoints.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId'],
        relative_path='v1alpha1/{+name}',
        request_field='',
        request_type_name='KrmapihostingProjectsLocationsAnthosApiEndpointsDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Get(self, request, global_params=None):
      r"""Gets details of a single AnthosApiEndpoint.

      Args:
        request: (KrmapihostingProjectsLocationsAnthosApiEndpointsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (AnthosApiEndpoint) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/anthosApiEndpoints/{anthosApiEndpointsId}',
        http_method='GET',
        method_id='krmapihosting.projects.locations.anthosApiEndpoints.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}',
        request_field='',
        request_type_name='KrmapihostingProjectsLocationsAnthosApiEndpointsGetRequest',
        response_type_name='AnthosApiEndpoint',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (KrmapihostingProjectsLocationsAnthosApiEndpointsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListAnthosApiEndpointsResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/anthosApiEndpoints',
        http_method='GET',
        method_id='krmapihosting.projects.locations.anthosApiEndpoints.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1alpha1/{+parent}/anthosApiEndpoints',
        request_field='',
        request_type_name='KrmapihostingProjectsLocationsAnthosApiEndpointsListRequest',
        response_type_name='ListAnthosApiEndpointsResponse',
        supports_download=False,
    )

    def Patch(self, request, global_params=None):
      r"""Updates the parameters of a single AnthosApiEndpoint.

      Args:
        request: (KrmapihostingProjectsLocationsAnthosApiEndpointsPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/anthosApiEndpoints/{anthosApiEndpointsId}',
        http_method='PATCH',
        method_id='krmapihosting.projects.locations.anthosApiEndpoints.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'updateMask'],
        relative_path='v1alpha1/{+name}',
        request_field='anthosApiEndpoint',
        request_type_name='KrmapihostingProjectsLocationsAnthosApiEndpointsPatchRequest',
        response_type_name='Operation',
        supports_download=False,
    )
