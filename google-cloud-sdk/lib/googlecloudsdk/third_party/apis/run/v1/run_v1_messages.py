...
class ConfigurationSpec(_messages.Message):
  ...
  Fields:
    template: Optional metadata for this Revision, including labels and
      ...
      instances" annotation key. To set a Serverless VPC Access connector for
      the revision, use the "run.googleapis.com/vpc-access-connector"
...
class ResourceRequirements(_messages.Message):
  ...
  Messages:
    LimitsValue: (Optional) Cloud Run fully managed: Only memory and CPU are
      ...
      Cloud Run for Anthos: supported Limits describes the maximum amount of
