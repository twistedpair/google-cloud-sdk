...
class TranslateV3beta1(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = u'TranslateV3beta1'
  _URL_VERSION = u'v3beta1'
  _API_KEY = None
  ...
  class ProjectsLocationsGlossariesService(base_api.BaseApiService):
    ...
    def Create(self, request, global_params=None):
      r"""Creates a glossary and returns the long-running operation. Returns.
NOT_FOUND, if the project doesn't exist.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}/glossaries',
        http_method=u'POST',
        method_id=u'translate.projects.locations.glossaries.create',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[],
        relative_path=u'v3beta1/{+parent}/glossaries',
...
Returns NOT_FOUND, if the glossary doesn't exist.
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}/glossaries/{glossariesId}',
        http_method=u'DELETE',
        method_id=u'translate.projects.locations.glossaries.delete',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v3beta1/{+name}',
        request_field='',
...
exist.
    ...
    def List(self, request, global_params=None):
      r"""Lists glossaries in a project. Returns NOT_FOUND, if the project doesn't.
exist.
...
corresponding to `Code.CANCELLED`.
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}:cancel',
        http_method=u'POST',
        method_id=u'translate.projects.locations.operations.cancel',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v3beta1/{+name}:cancel',
...
`google.rpc.Code.UNIMPLEMENTED`.
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}',
        http_method=u'DELETE',
...
is the parent resource, without the operations collection id.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}/operations',
        http_method=u'GET',
        method_id=u'translate.projects.locations.operations.list',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[u'filter', u'pageSize', u'pageToken'],
        relative_path=u'v3beta1/{+name}/operations',
        request_field='',
    ...
    def Wait(self, request, global_params=None):
      r"""Waits for the specified long-running operation until it is done or reaches.
...
immediate response is no guarantee that the operation is done.
    ...
    Wait.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}:wait',
        http_method=u'POST',
        method_id=u'translate.projects.locations.operations.wait',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v3beta1/{+name}:wait',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def BatchTranslateText(self, request, global_params=None):
      r"""Translates a large volume of text in asynchronous batch mode.
...
use google.longrunning.Operation.name to poll the status of the call.
    ...
    BatchTranslateText.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}:batchTranslateText',
        http_method=u'POST',
        method_id=u'translate.projects.locations.batchTranslateText',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[],
        relative_path=u'v3beta1/{+parent}:batchTranslateText',
    ...
    DetectLanguage.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}:detectLanguage',
        http_method=u'POST',
        method_id=u'translate.projects.locations.detectLanguage',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[],
        relative_path=u'v3beta1/{+parent}:detectLanguage',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}',
        http_method=u'GET',
    ...
    GetSupportedLanguages.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}/supportedLanguages',
        http_method=u'GET',
        method_id=u'translate.projects.locations.getSupportedLanguages',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[u'displayLanguageCode', u'model'],
        relative_path=u'v3beta1/{+parent}/supportedLanguages',
        request_field='',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations',
        http_method=u'GET',
        method_id=u'translate.projects.locations.list',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[u'filter', u'pageSize', u'pageToken'],
        relative_path=u'v3beta1/{+name}/locations',
        request_field='',
    ...
    TranslateText.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/locations/{locationsId}:translateText',
        http_method=u'POST',
        method_id=u'translate.projects.locations.translateText',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[],
        relative_path=u'v3beta1/{+parent}:translateText',
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    DetectLanguage.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}:detectLanguage',
        http_method=u'POST',
    ...
    GetSupportedLanguages.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}/supportedLanguages',
        http_method=u'GET',
    ...
    TranslateText.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v3beta1/projects/{projectsId}:translateText',
        http_method=u'POST',
