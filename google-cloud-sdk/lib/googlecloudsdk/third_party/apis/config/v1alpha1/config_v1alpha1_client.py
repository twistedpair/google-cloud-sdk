...
class ConfigV1alpha1(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.projects_locations_configSets = self.ProjectsLocationsConfigSetsService(self)
  ...
  class ProjectsLocationsConfigSetsService(base_api.BaseApiService):
    """Service class for the projects_locations_configSets resource."""

    _NAME = 'projects_locations_configSets'

    def __init__(self, client):
      super(ConfigV1alpha1.ProjectsLocationsConfigSetsService, self).__init__(client)
      self._upload_configs = {
          }

    def Create(self, request, global_params=None):
      r"""Creates a new ConfigSet in a given project and location.

      Args:
        request: (ConfigProjectsLocationsConfigSetsCreateRequest) input message
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/configSets',
        http_method='POST',
        method_id='config.projects.locations.configSets.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['configSetId', 'requestId'],
        relative_path='v1alpha1/{+parent}/configSets',
        request_field='configSet',
        request_type_name='ConfigProjectsLocationsConfigSetsCreateRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Delete(self, request, global_params=None):
      r"""Deletes a single ConfigSet.

      Args:
        request: (ConfigProjectsLocationsConfigSetsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/configSets/{configSetsId}',
        http_method='DELETE',
        method_id='config.projects.locations.configSets.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId'],
        relative_path='v1alpha1/{+name}',
        request_field='',
        request_type_name='ConfigProjectsLocationsConfigSetsDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Get(self, request, global_params=None):
      r"""Gets details of a single ConfigSet.

      Args:
        request: (ConfigProjectsLocationsConfigSetsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ConfigSet) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/configSets/{configSetsId}',
        http_method='GET',
        method_id='config.projects.locations.configSets.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}',
        request_field='',
        request_type_name='ConfigProjectsLocationsConfigSetsGetRequest',
        response_type_name='ConfigSet',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""Lists ConfigSets in a given project and location.

      Args:
        request: (ConfigProjectsLocationsConfigSetsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListConfigSetsResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/configSets',
        http_method='GET',
        method_id='config.projects.locations.configSets.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1alpha1/{+parent}/configSets',
        request_field='',
        request_type_name='ConfigProjectsLocationsConfigSetsListRequest',
        response_type_name='ListConfigSetsResponse',
        supports_download=False,
    )

    def Patch(self, request, global_params=None):
      r"""Updates the parameters of a single ConfigSet.

      Args:
        request: (ConfigProjectsLocationsConfigSetsPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/configSets/{configSetsId}',
        http_method='PATCH',
        method_id='config.projects.locations.configSets.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'updateMask'],
        relative_path='v1alpha1/{+name}',
        request_field='configSet',
        request_type_name='ConfigProjectsLocationsConfigSetsPatchRequest',
        response_type_name='Operation',
        supports_download=False,
    )
