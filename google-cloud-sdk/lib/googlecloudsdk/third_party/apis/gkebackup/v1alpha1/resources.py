...
BASE_URL = 'https://gkebackup.googleapis.com/v1alpha1/'
...
class Collections(enum.Enum):
  ...
  PROJECTS_LOCATIONS_RESTORES = (
      'projects.locations.restores',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/restores/'
              '{restoresId}',
      },
      ['name'],
      True
  )
  PROJECTS_LOCATIONS_RESTORES_VOLUMERESTORES = (
      'projects.locations.restores.volumeRestores',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/restores/'
              '{restoresId}/volumeRestores/{volumeRestoresId}',
      },
      ['name'],
      True
  )
