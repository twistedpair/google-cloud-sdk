"""Generated client library for ids version v1."""
# NOTE: This file is autogenerated and should not be edited by hand.

from __future__ import absolute_import

from apitools.base.py import base_api
from googlecloudsdk.third_party.apis.ids.v1 import ids_v1_messages as messages


class IdsV1(base_api.BaseApiClient):
  """Generated client library for service ids version v1."""

  MESSAGES_MODULE = messages
  BASE_URL = 'https://ids.googleapis.com/'
  MTLS_BASE_URL = 'https://ids.mtls.googleapis.com/'
  ...
  def __init__(self, url='', credentials=None,
    ...
    """Create a new ids handle."""
    url = url or self.BASE_URL
    super(IdsV1, self).__init__(
  ...
  class ProjectsLocationsEndpointsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(IdsV1.ProjectsLocationsEndpointsService, self).__init__(client)
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='POST',
        method_id='ids.projects.locations.endpoints.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['endpointId', 'requestId'],
        relative_path='v1/{+parent}/endpoints',
        request_field='endpoint',
        request_type_name='IdsProjectsLocationsEndpointsCreateRequest',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='DELETE',
        method_id='ids.projects.locations.endpoints.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId'],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='IdsProjectsLocationsEndpointsDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/endpoints/{endpointsId}',
        http_method='GET',
        method_id='ids.projects.locations.endpoints.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='IdsProjectsLocationsEndpointsGetRequest',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/endpoints',
        http_method='GET',
        method_id='ids.projects.locations.endpoints.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1/{+parent}/endpoints',
        request_field='',
        request_type_name='IdsProjectsLocationsEndpointsListRequest',
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/endpoints/{endpointsId}',
        http_method='PATCH',
        method_id='ids.projects.locations.endpoints.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'updateMask'],
        relative_path='v1/{+name}',
        request_field='endpoint',
        request_type_name='IdsProjectsLocationsEndpointsPatchRequest',
        response_type_name='Operation',
        supports_download=False,
    )
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(IdsV1.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='POST',
        method_id='ids.projects.locations.operations.cancel',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:cancel',
        request_field='cancelOperationRequest',
        request_type_name='IdsProjectsLocationsOperationsCancelRequest',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='DELETE',
        method_id='ids.projects.locations.operations.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='IdsProjectsLocationsOperationsDeleteRequest',
        response_type_name='Empty',
        supports_download=False,
    )
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}',
        http_method='GET',
        method_id='ids.projects.locations.operations.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='IdsProjectsLocationsOperationsGetRequest',
        response_type_name='Operation',
        supports_download=False,
    )
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(IdsV1.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method='GET',
        method_id='ids.projects.locations.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='IdsProjectsLocationsGetRequest',
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(IdsV1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
