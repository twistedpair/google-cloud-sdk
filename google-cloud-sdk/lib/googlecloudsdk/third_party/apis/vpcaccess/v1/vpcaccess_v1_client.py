...
class VpcaccessV1(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = u'VpcaccessV1'
  _URL_VERSION = u'v1'
  _API_KEY = None
  ...
  class ProjectsLocationsConnectorsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/locations/{locationsId}/connectors',
        http_method=u'POST',
        method_id=u'vpcaccess.projects.locations.connectors.create',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[u'connectorId'],
        relative_path=u'v1/{+parent}/connectors',
...
resource does not exist.
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/locations/{locationsId}/connectors/{connectorsId}',
