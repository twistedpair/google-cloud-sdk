...
class AuthorizationPolicy(_messages.Message):
  ...
  Fields:
    ...
    name: Required. Name of the AuthorizationPolicy resource. It matches
      pattern `projects/*/locations/{location}/authorizationPolicies/<authoriz
      ation_policy>`.
...
class ServerTlsPolicy(_messages.Message):
  ...
  Fields:
    allowOpen: Optional. Determines if server allows plaintext connections. By
      default, server will disallow plaintext connections. If allow_open is
      set to true, server allows both plain text and MTLS connections.
    createTime: Output only. The timestamp when the resource was created.
    description: Optional. Free-text description of the resource.
    labels: Optional. Set of label tags associated with the resource.
    mtlsPolicy: Optional. Defines a mechanism to provision peer validation
      ...
      treated as TLS and not mTLS.
    name: Required. Name of the ServerTlsPolicy resource. It matches the
      pattern
      `projects/*/locations/{location}/serverTlsPolicies/{server_tls_policy}`
    serverCertificate: Required. Defines a mechanism to provision server
