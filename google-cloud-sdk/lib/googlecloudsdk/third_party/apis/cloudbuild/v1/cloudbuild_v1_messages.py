...
class BuildTrigger(_messages.Message):
  ...
  sourceToBuild = _messages.MessageField('GitRepoSource', 17)
  substitutions = _messages.MessageField('SubstitutionsValue', 18)
  tags = _messages.StringField(19, repeated=True)
  triggerTemplate = _messages.MessageField('RepoSource', 20)
  webhookConfig = _messages.MessageField('WebhookConfig', 21)
