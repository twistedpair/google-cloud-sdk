...
class AppengineAppsServicesPatchRequest(_messages.Message):
  ...
  Fields:
    migrateTraffic: Set to `true` to gradually shift traffic from one version
      ...
      flexible environment. For examples, see [Migrating and Splitting
...
class Version(_messages.Message):
  ...
  Messages:
    ...
    EnvVariablesValue: Environment variables available to the application.
  ...
  versionUrl = _messages.StringField(27)
