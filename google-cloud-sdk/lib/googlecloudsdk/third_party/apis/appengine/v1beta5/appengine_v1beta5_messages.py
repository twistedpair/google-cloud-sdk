...
class Deployment(_messages.Message):
  ...
  Fields:
    container: A Docker image that App Engine uses the run the version. Only
    ...
    sourceReferences: Origin of the source code for this deployment. There can
      be more than one source reference per version if source code is
...
class Instance(_messages.Message):
  ...
  vmIp = _messages.StringField(12)
  vmName = _messages.StringField(13)
  vmStatus = _messages.StringField(14)
  vmUnlocked = _messages.BooleanField(15)
...
class SourceReference(_messages.Message):
  ...
  Fields:
    ...
    revisionId: The canonical, persistent identifier of the deployed revision.
      Aliases that include tags or branch names are not allowed. Example
