...
class Network(_messages.Message):
  ...
  Fields:
    ...
    name: The Google Compute Engine network that this resource is currently
      attached to. Either the fully-qualified URI of the network resource, or
      the short name of the network must be specified. If the network belongs
      to another project, the URI of the resource must be specified. e.g., htt
      ps://www.googleapis.com/compute/v1/projects/{project}/global/networks/{n
      etwork}  or my-network.See the VPC documentation
...
class Version(_messages.Message):
  ...
  Fields:
    ...
    enableStandardWebsocket: Allow Websocket requests for Standard to be
      routed to the streaming frontend.
  ...
  enableStandardWebsocket = _messages.BooleanField(10)
  ...
  lifecycle = _messages.EnumField('LifecycleValueValuesEnum', 21)
