...
class AppengineV1alpha(base_api.BaseApiClient):
  ...
  class AppsFirewallIngressRulesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AppengineV1alpha.AppsFirewallIngressRulesService, self).__init__(client)
      self._upload_configs = {
          }

    def BatchUpdate(self, request, global_params=None):
      """Replaces the entire firewall ruleset in one bulk operation. This will override and replace any existing firewall with the new rules provided.If the final rule does not match traffic with the wildcard ip range '*', an "allow all" rule will be explicitly added to the end of the list.
    ...
    BatchUpdate.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/firewall/ingressRules:batchUpdate',
        http_method=u'POST',
        method_id=u'appengine.apps.firewall.ingressRules.batchUpdate',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v1alpha/{+name}:batchUpdate',
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/firewall/ingressRules',
        http_method=u'POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/firewall/ingressRules/{ingressRulesId}',
        http_method=u'DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[u'parent'],
        query_params=[u'pageSize', u'pageToken'],
        relative_path=u'v1alpha/{+parent}/firewall/ingressRules',
        request_field='',
  ...
  class AppsFirewallService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(AppengineV1alpha.AppsFirewallService, self).__init__(client)
      self._upload_configs = {
          }
