...
class AppengineV1alpha(base_api.BaseApiClient):
  ...
  class AppsServicesVersionsInstancesService(base_api.BaseApiService):
    ...
    Debug.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}:debug',
        http_method=u'POST',
        method_id=u'appengine.apps.services.versions.instances.debug',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v1alpha/{+name}:debug',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}',
        http_method=u'DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances',
        http_method=u'GET',
  ...
  class AppsServicesVersionsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/services/{servicesId}/versions',
        http_method=u'POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}',
        http_method=u'DELETE',
...
automatic_scaling.min_total_instances (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.automatic_scaling):  For Version resources that use automatic scaling and run in the App  Engine Flexible environment.
automatic_scaling.max_total_instances (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.automatic_scaling):  For Version resources that use automatic scaling and run in the App  Engine Flexible environment.
automatic_scaling.cool_down_period_sec (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.automatic_scaling):  For Version resources that use automatic scaling and run in the App  Engine Flexible environment.
automatic_scaling.cpu_utilization.target_utilization (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.automatic_scaling):  For Version resources that use automatic scaling and run in the App  Engine Flexible environment.
  ...
  class AppsServicesService(base_api.BaseApiService):
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/services/{servicesId}',
        http_method=u'DELETE',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}/services',
        http_method=u'GET',
        method_id=u'appengine.apps.services.list',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[u'pageSize', u'pageToken'],
        relative_path=u'v1alpha/{+parent}/services',
        request_field='',
...
location - The region (https://cloud.google.com/appengine/docs/locations) where you want the App Engine application located.For more information about App Engine applications, see Managing Projects, Applications, and Billing (https://cloud.google.com/appengine/docs/python/console/).
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}',
        http_method=u'GET',
...
default_cookie_expiration - Cookie expiration policy for the application.
    ...
    Repair.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha/apps/{appsId}:repair',
        http_method=u'POST',
        method_id=u'appengine.apps.repair',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v1alpha/{+name}:repair',
