"""Generated message classes for videointelligence version v1beta2.
...
class GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest(_messages.Message):
  ...
  videoContext = _messages.MessageField('GoogleCloudVideointelligenceV1beta2VideoContext', 6)
...
class GoogleCloudVideointelligenceV1beta2ExplicitContentDetectionConfig(_messages.Message):
...
class GoogleCloudVideointelligenceV1beta2LabelDetectionConfig(_messages.Message):
...
class GoogleCloudVideointelligenceV1beta2ShotChangeDetectionConfig(_messages.Message):
...
class GoogleCloudVideointelligenceV1beta2VideoContext(_messages.Message):
  ...
  explicitContentDetectionConfig = _messages.MessageField('GoogleCloudVideointelligenceV1beta2ExplicitContentDetectionConfig', 1)
  labelDetectionConfig = _messages.MessageField('GoogleCloudVideointelligenceV1beta2LabelDetectionConfig', 2)
  segments = _messages.MessageField('GoogleCloudVideointelligenceV1beta2VideoSegment', 3, repeated=True)
  shotChangeDetectionConfig = _messages.MessageField('GoogleCloudVideointelligenceV1beta2ShotChangeDetectionConfig', 4)
