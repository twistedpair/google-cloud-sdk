...
class GoogleAppsScriptTypeCalendarCalendarAddOnManifest(_messages.Message):
  ...
  Fields:
    ...
    currentEventAccess: Define the level of data access when an event addon is
      triggered.
    eventOpenTrigger: An endpoint to trigger when an event is opened
      (viewed/edited).
    eventUpdateTrigger: An endpoint to trigger when the open event is updated.
    homepageTrigger: Defines an endpoint that will be executed contexts that
      don't match a declared contextual trigger. Any cards generated by this
      function will always be available to the user, but may be eclipsed by
...
class GoogleAppsScriptTypeCommonAddOnManifest(_messages.Message):
  ...
  Fields:
    ...
    homepageTrigger: Defines an endpoint that will be executed in any context,
      ...
      available to the user, but may be eclipsed by contextual content when
    ...
    universalActions: Defines a list of extension points in the universal
      ...
      point can be link URL to open or an endpoint to execute as a form
      submission.
...
class GoogleAppsScriptTypeGmailGmailAddOnManifest(_messages.Message):
  ...
  Fields:
    ...
    composeTrigger: Defines the compose time trigger for a compose time add-
      ...
      user is composing an email. All compose time addons are required to have
      the gmail.addons.current.action.compose scope even though it might not
      edit the draft.
  ...
  class AuthorizationHeaderValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      SYSTEM_ID_TOKEN: Send an ID token for the project-specific Google
        Workspace Add-ons system service account (default)
...
class GsuiteaddonsProjectsGetAuthorizationRequest(_messages.Message):
  ...
  Fields:
    name: Required. Name of the project for which to get the Google Workspace
      Add-ons authorization information. Example:
