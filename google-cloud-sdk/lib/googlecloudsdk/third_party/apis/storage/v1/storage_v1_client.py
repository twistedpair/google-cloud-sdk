...
class StorageV1(base_api.BaseApiClient):
  ...
  class ObjectsService(base_api.BaseApiService):
    ...
    Compose.method_config = lambda: base_api.ApiMethodInfo(
        ...
        query_params=[u'destinationPredefinedAcl', u'ifGenerationMatch', u'ifMetagenerationMatch', u'kmsKeyName'],
    ...
    Insert.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=[u'bucket'],
        path_params=[u'bucket'],
        query_params=[u'contentEncoding', u'ifGenerationMatch', u'ifGenerationNotMatch', u'ifMetagenerationMatch', u'ifMetagenerationNotMatch', u'kmsKeyName', u'name', u'predefinedAcl', u'projection'],
