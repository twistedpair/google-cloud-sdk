...
class GenomicsOperationsDeleteRequest(_messages.Message):
  """A GenomicsOperationsDeleteRequest object.
...
class Read(_messages.Message):
  ...
  Fields:
    alignedQuality: The quality of the read sequence contained in this
      ...
      When this occurs, the CIGAR for this read will begin/end with a hard
      clip operator that will indicate the length of the excised sequence.
...
class ReadGroup(_messages.Message):
  ...
  Fields:
    ...
    referenceSetId: The reference set the reads in this read group are aligned
      to. Required if there are any read alignments.
...
class ReferenceSet(_messages.Message):
  ...
  Fields:
    ...
    ncbiTaxonId: ID from http://www.ncbi.nlm.nih.gov/taxonomy (e.g.
      ...
      not belong to the modeled species, e.g. EBV in a human reference genome.
...
class SearchVariantsRequest(_messages.Message):
  ...
  Fields:
    ...
    maxCalls: The maximum number of calls to return. However, at least one
      ...
      limit. If unspecified, defaults to 5000.
