...
class ConfigSync(_messages.Message):
  ...
  class ResourceRequirementsValue(_messages.Message):
    ...
    class AdditionalProperty(_messages.Message):
      ...
      Fields:
        key: Name of the additional property.
        value: A ContainerResourceRequirements attribute.
      """

      key = _messages.StringField(1)
      value = _messages.MessageField('ContainerResourceRequirements', 2)
...
class ContainerResourceRequirements(_messages.Message):
  ...
  cpuLimit = _messages.MessageField('Quantity', 2)
  memoryLimit = _messages.MessageField('Quantity', 3)
