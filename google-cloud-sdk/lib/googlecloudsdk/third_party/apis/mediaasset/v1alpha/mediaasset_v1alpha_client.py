...
from googlecloudsdk.third_party.apis.mediaasset.v1alpha import mediaasset_v1alpha_messages as messages
...
class MediaassetV1alpha(base_api.BaseApiClient):
  ...
  class ProjectsLocationsAssetTypesAssetsService(base_api.BaseApiService):
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['oldReadMask', 'readMask'],
        relative_path='v1alpha/{+name}',
        request_field='',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'oldReadMask', 'pageSize', 'pageToken', 'readMask'],
        relative_path='v1alpha/{+parent}/assets',
        request_field='',
