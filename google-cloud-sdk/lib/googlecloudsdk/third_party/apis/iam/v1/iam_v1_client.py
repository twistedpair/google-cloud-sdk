...
even if the linter detects an issue in the IAM policy.
    ...
    def QueryAuditableServices(self, request, global_params=None):
      r"""Returns a list of services that allow you to opt into audit logs that are.
...
permanently removed.
    ...
    def List(self, request, global_params=None):
      r"""Lists every predefined Role that IAM supports, or every custom role.
that is defined for an organization or project.
  ...
  class PermissionsService(base_api.BaseApiService):
    ...
    def QueryTestablePermissions(self, request, global_params=None):
      r"""Lists every permission that you can test on a resource. A permission is.
...
service account.
    ...
    def Disable(self, request, global_params=None):
      r"""Disables a ServiceAccount immediately.
...
with DeleteServiceAccount.
    ...
    def Enable(self, request, global_params=None):
      r"""Enables a ServiceAccount that was disabled by.
...
method to enable the service account.
    ...
    def GetIamPolicy(self, request, global_params=None):
      r"""Gets the IAM policy that is attached to a ServiceAccount. This IAM.
...
method.
    ...
    def SetIamPolicy(self, request, global_params=None):
      r"""Sets the IAM policy that is attached to a ServiceAccount.
...
that is defined for an organization or project.
    ...
    def QueryGrantableRoles(self, request, global_params=None):
      r"""Lists roles that can be granted on a Google Cloud resource. A role is.
