...
class GoogleIamV1betaListWorkloadIdentityPoolProvidersResponse(_messages.Message):
  ...
  Fields:
    ...
    workloadIdentityPoolProviders: The WorkloadIdentityPoolProviders from the
      specified parent.
  """
...
class GoogleIamV1betaListWorkloadIdentityPoolsResponse(_messages.Message):
  ...
  Fields:
    nextPageToken: A token, which can be sent as `page_token` to retrieve the
      next page. If this field is omitted, there are no subsequent pages.
    workloadIdentityPools: The WorkloadIdentityPools from the specified
      parent.
  """
...
class GoogleIamV1betaWorkloadIdentityPool(_messages.Message):
  r"""Represents a collection of workloads. WorkloadIdentityPools can be used
  in Google Cloud Platform policies, such as in IAM to give workloads
  authorization to access to Google Cloud Platform.

  Enums:
    StateValueValuesEnum: Output only. The state of the WorkloadIdentityPool.
      Note: Users should code against state enums with the expectation that
      new values may be added in the future.

  Fields:
    description: A user-specified description about this pool. The value must
      be less than or equal to 256 characters.
    disabled: Whether the WorkloadIdentityPool is disabled. A disabled
      WorkloadIdentityPool cannot be used to perform new token exchanges.
      Previously issued Access tokens for a workload identity pool will be
      rejected while the pool is disabled but will start working again if the
      pool is re-enabled.
  ...
  class StateValueValuesEnum(_messages.Enum):
    ...
    Values:
      ...
      ACTIVE: The WorkloadIdentityPool is active and may be used in Google
        Cloud Platform policies.
      DELETED: The WorkloadIdentityPool is soft-deleted. Soft-deleted
...
class GoogleIamV1betaWorkloadIdentityPoolProvider(_messages.Message):
  r"""Configuration for how Identity Platform will validate authentication
  credentials minted by an Identity Provider. The total size of a
  WorkloadIdentityPoolProvider may not exceed 100kb. Requests whose outcome
  would cause a WorkloadIdentityPoolProvider to exceed this limit will be
  rejected.
  ...
  Fields:
    ...
    description: A user-specified description for the
      ...
      256 characters.
    disabled: Whether the WorkloadIdentityPoolProvider is disabled. A disabled
      WorkloadIdentityPoolProvider cannot be used to perform new token
      exchanges. Existing Google Cloud Platform authentication tokens are
      unaffected when a WorkloadIdentityPoolProvider is disabled.
    displayName: A user-specified name for the WorkloadIdentityPoolProvider.
  ...
  class StateValueValuesEnum(_messages.Enum):
    ...
    Values:
      STATE_UNSPECIFIED: State unspecified.
      ACTIVE: The WorkloadIdentityPoolProvider is active and may be used to
        validate authentication credentials.
      DELETED: The WorkloadIdentityPoolProvider is soft-deleted. Soft-deleted
        WorkloadIdentityPoolProviders are permanently deleted after
        approximately 30 days unless restored via
        UndeleteWorkloadIdentityPoolProvider. IDs of soft-deleted
        WorkloadIdentityPoolProviders may not be reused until after the
...
class GoogleIamV1betaWorkloadIdentityPoolProviderAws(_messages.Message):
  ...
  Fields:
    ...
    stsUri: A list of AWS STS URIs to limit the allowed STS hostname in the
      AWS signed requests used for authentication. If it is not provided, any
      valid AWS STS URI given the AWS signed request during the credential
      exchange is allowed. Each URI must be in the form
      'https://sts.amazonaws.com' or 'https://sts.{region}.amazonaws.com'
      where {region} is a valid AWS region. A maximum of 25 URIs may be
      specified.
  """
...
class IamProjectsLocationsWorkloadIdentityPoolsDeleteRequest(_messages.Message):
  ...
  Fields:
    name: Required. The name of the WorkloadIdentityPool to delete.
  """
...
class IamProjectsLocationsWorkloadIdentityPoolsGetRequest(_messages.Message):
  ...
  Fields:
    name: Required. The name of the WorkloadIdentityPool to retrieve.
  """
...
class IamProjectsLocationsWorkloadIdentityPoolsListRequest(_messages.Message):
  ...
  Fields:
    pageSize: The maximum number of WorkloadIdentityPools to return. If
      unspecified, at most 50 pools will be returned. The maximum value is
    ...
    showDeleted: Whether to return soft-deleted resources.
  """
...
class IamProjectsLocationsWorkloadIdentityPoolsPatchRequest(_messages.Message):
  ...
  Fields:
    googleIamV1betaWorkloadIdentityPool: A GoogleIamV1betaWorkloadIdentityPool
      resource to be passed as the request body.
    name: Output only. The resource name of the pool.
    updateMask: Required. The list of fields whose values are to be replaced.
  """
...
class IamProjectsLocationsWorkloadIdentityPoolsProvidersCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    parent: Required. The parent resource where this
      WorkloadIdentityPoolProvider will be created.
...
class IamProjectsLocationsWorkloadIdentityPoolsProvidersDeleteRequest(_messages.Message):
  ...
  Fields:
    name: Required. The name of the WorkloadIdentityPoolProvider to delete.
  """
...
class IamProjectsLocationsWorkloadIdentityPoolsProvidersGetRequest(_messages.Message):
  ...
  Fields:
    name: Required. The name of the WorkloadIdentityPoolProvider to retrieve.
  """
...
class IamProjectsLocationsWorkloadIdentityPoolsProvidersListRequest(_messages.Message):
  ...
  Fields:
    pageSize: The maximum number of WorkloadIdentityPoolProviders to return.
      If unspecified, at most 50 WorkloadIdentityPoolProviders will be
...
class IamProjectsLocationsWorkloadIdentityPoolsProvidersUndeleteRequest(_messages.Message):
  ...
  Fields:
    ...
    name: Required. The name of the WorkloadIdentityPoolProvider to undelete.
  """
...
class IamProjectsLocationsWorkloadIdentityPoolsUndeleteRequest(_messages.Message):
  ...
  Fields:
    googleIamV1betaUndeleteWorkloadIdentityPoolRequest: A
      ...
      as the request body.
    name: Required. The name of the WorkloadIdentityPool to undelete.
  """
