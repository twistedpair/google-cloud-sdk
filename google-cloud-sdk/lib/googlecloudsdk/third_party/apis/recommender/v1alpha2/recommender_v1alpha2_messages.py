...
class GoogleCloudRecommenderV1alpha2Insight(_messages.Message):
  ...
  stateInfo = _messages.MessageField('GoogleCloudRecommenderV1alpha2InsightStateInfo', 10)
...
class GoogleCloudRecommenderV1alpha2Recommendation(_messages.Message):
  ...
  stateInfo = _messages.MessageField('GoogleCloudRecommenderV1alpha2RecommendationStateInfo', 10)
  xorGroupId = _messages.StringField(11)
