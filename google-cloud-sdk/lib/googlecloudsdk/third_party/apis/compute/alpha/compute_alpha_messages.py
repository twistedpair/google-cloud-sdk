...
class InstanceGroupManager(_messages.Message):
  ...
  regionalStatus = _messages.EnumField('RegionalStatusValueValuesEnum', 13)
  regionalStatusDetails = _messages.MessageField('InstanceGroupManagerStatusDetails', 14, repeated=True)
  selfLink = _messages.StringField(15)
