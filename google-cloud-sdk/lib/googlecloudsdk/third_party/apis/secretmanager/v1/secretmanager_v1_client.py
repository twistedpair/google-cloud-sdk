...
class SecretmanagerV1(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = u'SecretmanagerV1'
  _URL_VERSION = u'v1'
  _API_KEY = None
...
SecretVersion.
    ...
    Access.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}/versions/{versionsId}:access',
        http_method=u'GET',
        method_id=u'secretmanager.projects.secrets.versions.access',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v1/{+name}:access',
        request_field='',
...
secret data.
    ...
    Destroy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}/versions/{versionsId}:destroy',
        http_method=u'POST',
...
DISABLED.
    ...
    Disable.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}/versions/{versionsId}:disable',
        http_method=u'POST',
...
ENABLED.
    ...
    Enable.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}/versions/{versionsId}:enable',
        http_method=u'POST',
...
SecretVersion.
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}/versions/{versionsId}',
        http_method=u'GET',
...
data.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}/versions',
        http_method=u'GET',
...
it to an existing Secret.
    ...
    AddVersion.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}:addVersion',
        http_method=u'POST',
        method_id=u'secretmanager.projects.secrets.addVersion',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[],
        relative_path=u'v1/{+parent}:addVersion',
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets',
        http_method=u'POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}',
...
Returns empty policy if the secret exists and does not have a policy set.
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}:getIamPolicy',
        http_method=u'GET',
...
to the policy set on the associated Secret.
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}:setIamPolicy',
        http_method=u'POST',
...
may "fail open" without warning.
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1/projects/{projectsId}/secrets/{secretsId}:testIamPermissions',
        http_method=u'POST',
