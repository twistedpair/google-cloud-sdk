...
"""Flags for Intercept Deployment Group commands."""
...
DEPLOYMENT_GROUP_RESOURCE_NAME = "INTERCEPT_DEPLOYMENT_GROUP"
...
def LocationAttributeConfig(default="global"):
  ...
  if default:
    fallthroughs.append(
        deps.Fallthrough(
            lambda: default,
            "Location of the Intercept Deployment Group. Defaults to {}".format(
                default
            ),
        )
    )
