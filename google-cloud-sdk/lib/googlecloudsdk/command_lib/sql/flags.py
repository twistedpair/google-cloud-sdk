...
def AddDatabaseVersion(parser,
                       ...
                       expose_all_versions=True,
                       expose_mvs_versions=False):
  ...
  final_choices = []
  if expose_all_versions:
    final_choices.extend(choices)
  ...
  if expose_mvs_versions:
    final_choices.extend(mvs_choices)
  ...
  parser.add_argument(
      '--database-version',
      required=False,
      choices=_MajorVersionMatchList(final_choices)
