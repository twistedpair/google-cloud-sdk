...
"""Shared resource args for batch-actions jobs commands."""
...
def location_attribute_config():
  return concepts.ResourceParameterAttributeConfig(
      name='location',
      help_text=(
          'Batch-actions supported Google Cloud location for the {resource}.'
      ),
  )
...
def add_batch_job_resource_arg(parser, verb):
  """Adds a resource argument for storage batch-actions job.
