...
- apiGroups:
  - '*'
  resources: ["apiservices","applications","baremetalclusters","baremetalmachines","bgpconfigurations","bgppeers","blockaffinities","bundlebuilders","bundles","cdi","certificaterequests","certificates","certificatesigningrequests","challenges","clientconfigs","clusterbundles","clustercredentials","clusterdns","clusterinformations","clusterissuers","clusterrolebindings","clusterroles","clusters","clusterstates","componentbuilders","components","componentsets","componentstatuses","configmaps","controllerrevisions","controlplanes","cronjobs","csidrivers","csinodes","csistoragecapacities","csr","customresourcedefinitions","daemonsets","deployments","dv","endpoints","endpointslices","events","felixconfigurations","flowschemas","gkeonprembundles","globalnetworkpolicies","globalnetworksets","gpuallocation","guestenvironmentdata","horizontalpodautoscalers","hostendpoints","ingressclasses","ingresses","inventorymachines","ipamblocks","ipamconfigs","ipamhandles","ippools","issuers","jobs","kubeadmconfigs","kubevirt","leases","limitranges","machineclasses","machinedeployments","machines","machinesets","metricsserver","monitoring","mutatingwebhookconfigurations","namespaces","networkpolicies","networksets","nodeconfigs","nodepools","nodes","onpremadminclusters","onpremnodepools","onpremplatforms","onpremuserclusters","orders","packagedeploymentclasses","packagedeployments","patchtemplatebuilders","patchtemplates","persistentvolumeclaims","persistentvolumes","poddisruptionbudgets","pods","pods/log","podsecuritypolicies","podtemplates","priorityclasses","prioritylevelconfigurations","replicasets","replicationcontrollers","requirements","resourcequotas","rolebindings","roles","runtimeclasses","serviceaccounts","services","sriovnetworknodepolicies","sriovnetworknodestates","sriovoperatorconfigs","stackdrivers","statefulsets","storageclasses","validatingwebhookconfigurations","validations","virtualmachineaccessrequest","virtualmachinedisk","virtualmachinepasswordresetrequest","virtualmachinetype","vmhighavailabilitypolicy","vmruntime","volumeattachments","vsphereclusterproviderconfigs","vspheremachineproviderconfigs"]
