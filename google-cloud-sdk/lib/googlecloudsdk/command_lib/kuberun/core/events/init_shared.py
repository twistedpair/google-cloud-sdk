...
"""Provides shared classes for events init command surface."""
...
def UpdateOpResourceWithEventingEnabled(client, operator_type):
...
def PollOperatorResource(client, operator_type, tracker):
  if operator_type == events_constants.Operator.KUBERUN:
