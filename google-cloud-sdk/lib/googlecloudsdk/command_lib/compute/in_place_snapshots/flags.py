...
"""Flags and helpers for the compute in-place snapshots commands."""
...
_SOURCE_DISK_DETAILED_HELP = """\
      Source disk used to create the in-place snapshot.
"""
...
SOURCE_DISK_ARG = compute_flags.ResourceArgument(
    ...
    short_help='Source disk used to create the in-place snapshot.',
