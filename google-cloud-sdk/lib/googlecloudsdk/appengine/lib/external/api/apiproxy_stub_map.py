...
from googlecloudsdk.appengine.lib.external.api import apiproxy_rpc
from googlecloudsdk.appengine.lib.external.runtime import apiproxy_errors
...
def GetDefaultAPIProxy():
  try:
    ...
    runtime = __import__('googlecloudsdk.appengine.lib.external.runtime', globals(), locals(),
                         ['apiproxy'])
