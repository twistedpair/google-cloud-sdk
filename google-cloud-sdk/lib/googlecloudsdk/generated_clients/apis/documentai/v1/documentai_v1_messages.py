...
class GoogleCloudDocumentaiUiv1beta3DocumentIdGCSManagedDocumentId(_messages.Message):
  r"""Identifies a document uniquely within the scope of a dataset in the GCS-
  based option.
...
class GoogleCloudDocumentaiUiv1beta3RevisionReference(_messages.Message):
  ...
  Enums:
    RevisionCaseValueValuesEnum: Read the revision by the predefined case.
  ...
  Fields:
    ...
    revisionId: Read the revision given by the id, returns error if it does
      not exist.
  """

  class RevisionCaseValueValuesEnum(_messages.Enum):
    r"""Read the revision by the predefined case.
...
class GoogleCloudDocumentaiV1alpha1AnalyzeHitlDataMetadata(_messages.Message):
  r"""The long running operation metadata for AnalyzeHitlData.

  Fields:
    commonMetadata: The basic metadata of the long running operation.
  """

  commonMetadata = _messages.MessageField('GoogleCloudDocumentaiV1alpha1CommonOperationMetadata', 1)


class GoogleCloudDocumentaiV1alpha1CommonOperationMetadata(_messages.Message):
  r"""The common metadata for long running operations.
