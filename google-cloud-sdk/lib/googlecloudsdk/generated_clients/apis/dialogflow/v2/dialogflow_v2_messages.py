...
class GoogleCloudDialogflowCxV3ResponseMessage(_messages.Message):
  ...
  liveAgentHandoff = _messages.MessageField('GoogleCloudDialogflowCxV3ResponseMessageLiveAgentHandoff', 4)
  mixedAudio = _messages.MessageField('GoogleCloudDialogflowCxV3ResponseMessageMixedAudio', 5)
  outputAudioText = _messages.MessageField('GoogleCloudDialogflowCxV3ResponseMessageOutputAudioText', 6)
  payload = _messages.MessageField('PayloadValue', 7)
  playAudio = _messages.MessageField('GoogleCloudDialogflowCxV3ResponseMessagePlayAudio', 8)
  telephonyTransferCall = _messages.MessageField('GoogleCloudDialogflowCxV3ResponseMessageTelephonyTransferCall', 9)
  text = _messages.MessageField('GoogleCloudDialogflowCxV3ResponseMessageText', 10)
...
class GoogleCloudDialogflowCxV3beta1ResponseMessage(_messages.Message):
  ...
  telephonyTransferCall = _messages.MessageField('GoogleCloudDialogflowCxV3beta1ResponseMessageTelephonyTransferCall', 9)
  text = _messages.MessageField('GoogleCloudDialogflowCxV3beta1ResponseMessageText', 10)
...
class GoogleCloudDialogflowV2AgentAssistantRecord(_messages.Message):
  ...
  faqAnswer = _messages.MessageField('GoogleCloudDialogflowV2FaqAnswer', 2)
...
class GoogleCloudDialogflowV2beta1GcsDestination(_messages.Message):
  ...
  Fields:
    uri: Required. The Google Cloud Storage URIs for the output. A URI is of
      the form: gs://bucket/object-prefix-or-name Whether a prefix or name is
      used depends on the use case. The requesting user must have "write-
      permission" to the bucket.
  """
