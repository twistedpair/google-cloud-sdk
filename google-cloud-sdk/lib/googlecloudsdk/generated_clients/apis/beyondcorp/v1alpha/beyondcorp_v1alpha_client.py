...
class BeyondcorpV1alpha(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.projects_locations_global_securityGateways_applications = self.ProjectsLocationsGlobalSecurityGatewaysApplicationsService(self)
    ...
    self.projects_locations_securityGateways_applications = self.ProjectsLocationsSecurityGatewaysApplicationsService(self)
  ...
  class OrganizationsLocationsInsightsService(base_api.BaseApiService):
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['aggregation', 'endTime', 'filter', 'orderBy', 'pageSize', 'pageToken', 'startTime', 'view'],
  ...
  class OrganizationsLocationsSubscriptionsService(base_api.BaseApiService):
    ...
    def Restart(self, request, global_params=None):
      r"""Restarts an existing BeyondCorp Enterprise Subscription in a given organization, that is scheduled for cancellation. Location will always be global as BeyondCorp subscriptions are per organization. Returns the timestamp for when the cancellation will become effective.

      Args:
        request: (BeyondcorpOrganizationsLocationsSubscriptionsRestartRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaRestartSubscriptionResponse) The response message.
      """
    ...
    Restart.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/subscriptions/{subscriptionsId}:restart',
        http_method='GET',
        method_id='beyondcorp.organizations.locations.subscriptions.restart',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId'],
        relative_path='v1alpha/{+name}:restart',
        request_field='',
        request_type_name='BeyondcorpOrganizationsLocationsSubscriptionsRestartRequest',
        response_type_name='GoogleCloudBeyondcorpSaasplatformSubscriptionsV1alphaRestartSubscriptionResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsGlobalSecurityGatewaysApplicationsService(base_api.BaseApiService):
    """Service class for the projects_locations_global_securityGateways_applications resource."""

    _NAME = 'projects_locations_global_securityGateways_applications'

    def __init__(self, client):
      super(BeyondcorpV1alpha.ProjectsLocationsGlobalSecurityGatewaysApplicationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Create(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsGlobalSecurityGatewaysApplicationsCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/global/securityGateways/{securityGatewaysId}/applications',
        http_method='POST',
        method_id='beyondcorp.projects.locations.global.securityGateways.applications.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['applicationId', 'requestId'],
        relative_path='v1alpha/{+parent}/applications',
        request_field='googleCloudBeyondcorpSecuritygatewaysV1alphaApplication',
        request_type_name='BeyondcorpProjectsLocationsGlobalSecurityGatewaysApplicationsCreateRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def Patch(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsGlobalSecurityGatewaysApplicationsPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/global/securityGateways/{securityGatewaysId}/applications/{applicationsId}',
        http_method='PATCH',
        method_id='beyondcorp.projects.locations.global.securityGateways.applications.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'updateMask'],
        relative_path='v1alpha/{+name}',
        request_field='googleCloudBeyondcorpSecuritygatewaysV1alphaApplication',
        request_type_name='BeyondcorpProjectsLocationsGlobalSecurityGatewaysApplicationsPatchRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def TestIamPermissions(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsGlobalSecurityGatewaysApplicationsTestIamPermissionsRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleIamV1TestIamPermissionsResponse) The response message.
      """
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/global/securityGateways/{securityGatewaysId}/applications/{applicationsId}:testIamPermissions',
        http_method='POST',
        method_id='beyondcorp.projects.locations.global.securityGateways.applications.testIamPermissions',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha/{+resource}:testIamPermissions',
        request_field='googleIamV1TestIamPermissionsRequest',
        request_type_name='BeyondcorpProjectsLocationsGlobalSecurityGatewaysApplicationsTestIamPermissionsRequest',
        response_type_name='GoogleIamV1TestIamPermissionsResponse',
        supports_download=False,
    )
  ...
  class ProjectsLocationsSecurityGatewaysApplicationsService(base_api.BaseApiService):
    """Service class for the projects_locations_securityGateways_applications resource."""

    _NAME = 'projects_locations_securityGateways_applications'

    def __init__(self, client):
      super(BeyondcorpV1alpha.ProjectsLocationsSecurityGatewaysApplicationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}/applications/{applicationsId}',
        http_method='DELETE',
        method_id='beyondcorp.projects.locations.securityGateways.applications.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'validateOnly'],
        relative_path='v1alpha/{+name}',
        request_field='',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysApplicationsDeleteRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsSecurityGatewaysApplicationsGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplication) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}/applications/{applicationsId}',
        http_method='GET',
        method_id='beyondcorp.projects.locations.securityGateways.applications.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}',
        request_field='',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysApplicationsGetRequest',
        response_type_name='GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplication',
        supports_download=False,
    )
    ...
    def GetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsSecurityGatewaysApplicationsGetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleIamV1Policy) The response message.
      """
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}/applications/{applicationsId}:getIamPolicy',
        http_method='GET',
        method_id='beyondcorp.projects.locations.securityGateways.applications.getIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=['options_requestedPolicyVersion'],
        relative_path='v1alpha/{+resource}:getIamPolicy',
        request_field='',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysApplicationsGetIamPolicyRequest',
        response_type_name='GoogleIamV1Policy',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsSecurityGatewaysApplicationsListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleCloudBeyondcorpSecuritygatewaysV1alphaListApplicationsResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}/applications',
        http_method='GET',
        method_id='beyondcorp.projects.locations.securityGateways.applications.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1alpha/{+parent}/applications',
        request_field='',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysApplicationsListRequest',
        response_type_name='GoogleCloudBeyondcorpSecuritygatewaysV1alphaListApplicationsResponse',
        supports_download=False,
    )
    ...
    def SetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsSecurityGatewaysApplicationsSetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleIamV1Policy) The response message.
      """
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}/applications/{applicationsId}:setIamPolicy',
        http_method='POST',
        method_id='beyondcorp.projects.locations.securityGateways.applications.setIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha/{+resource}:setIamPolicy',
        request_field='googleIamV1SetIamPolicyRequest',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysApplicationsSetIamPolicyRequest',
        response_type_name='GoogleIamV1Policy',
        supports_download=False,
    )
  ...
  class ProjectsLocationsSecurityGatewaysService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways',
        http_method='POST',
        method_id='beyondcorp.projects.locations.securityGateways.create',
        ordered_params=['parent'],
        path_params=['parent'],
        ...
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysCreateRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}',
        http_method='DELETE',
        method_id='beyondcorp.projects.locations.securityGateways.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'validateOnly'],
        relative_path='v1alpha/{+name}',
        request_field='',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysDeleteRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}',
        http_method='GET',
        method_id='beyondcorp.projects.locations.securityGateways.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}',
        request_field='',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysGetRequest',
    ...
    def GetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsSecurityGatewaysGetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleIamV1Policy) The response message.
      """
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}:getIamPolicy',
        http_method='GET',
        method_id='beyondcorp.projects.locations.securityGateways.getIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=['options_requestedPolicyVersion'],
        relative_path='v1alpha/{+resource}:getIamPolicy',
        request_field='',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysGetIamPolicyRequest',
        response_type_name='GoogleIamV1Policy',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""Lists SecurityGateways in a given project and location.
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways',
        http_method='GET',
        method_id='beyondcorp.projects.locations.securityGateways.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1alpha/{+parent}/securityGateways',
        request_field='',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysListRequest',
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}',
        http_method='PATCH',
        method_id='beyondcorp.projects.locations.securityGateways.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId', 'updateMask'],
        relative_path='v1alpha/{+name}',
        request_field='googleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGateway',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysPatchRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def SetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsSecurityGatewaysSetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleIamV1Policy) The response message.
      """
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}:setIamPolicy',
        http_method='POST',
        method_id='beyondcorp.projects.locations.securityGateways.setIamPolicy',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha/{+resource}:setIamPolicy',
        request_field='googleIamV1SetIamPolicyRequest',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysSetIamPolicyRequest',
        response_type_name='GoogleIamV1Policy',
        supports_download=False,
    )

    def SetPeering(self, request, global_params=None):
      r"""This is a custom method to allow customers to create a peering connections between Google network and customer networks. This is enabled only for the allowlisted customers.

      Args:
        request: (BeyondcorpProjectsLocationsSecurityGatewaysSetPeeringRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleLongrunningOperation) The response message.
      """
      config = self.GetMethodConfig('SetPeering')
      return self._RunMethod(
          config, request, global_params=global_params)

    SetPeering.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}:setPeering',
        http_method='POST',
        method_id='beyondcorp.projects.locations.securityGateways.setPeering',
        ordered_params=['securityGateway'],
        path_params=['securityGateway'],
        query_params=[],
        relative_path='v1alpha/{+securityGateway}:setPeering',
        request_field='googleCloudBeyondcorpSecuritygatewaysV1alphaSetPeeringRequest',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysSetPeeringRequest',
        response_type_name='GoogleLongrunningOperation',
        supports_download=False,
    )
    ...
    def TestIamPermissions(self, request, global_params=None):
      ...
      Args:
        request: (BeyondcorpProjectsLocationsSecurityGatewaysTestIamPermissionsRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GoogleIamV1TestIamPermissionsResponse) The response message.
      """
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/securityGateways/{securityGatewaysId}:testIamPermissions',
        http_method='POST',
        method_id='beyondcorp.projects.locations.securityGateways.testIamPermissions',
        ordered_params=['resource'],
        path_params=['resource'],
        query_params=[],
        relative_path='v1alpha/{+resource}:testIamPermissions',
        request_field='googleIamV1TestIamPermissionsRequest',
        request_type_name='BeyondcorpProjectsLocationsSecurityGatewaysTestIamPermissionsRequest',
        response_type_name='GoogleIamV1TestIamPermissionsResponse',
        supports_download=False,
    )
