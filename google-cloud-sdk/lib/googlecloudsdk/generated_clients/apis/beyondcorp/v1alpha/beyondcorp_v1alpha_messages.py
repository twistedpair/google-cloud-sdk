...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplication(_messages.Message):
  ...
  upstreams = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplicationUpstream', 7, repeated=True)
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplicationUpstream(_messages.Message):
  ...
  external = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplicationUpstreamExternal', 2)
  network = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplicationUpstreamNetwork', 3)
  proxyProtocol = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaProxyProtocolConfig', 4)


class GoogleCloudBeyondcorpSecuritygatewaysV1alphaApplicationUpstreamExternal(_messages.Message):
  ...
  endpoints = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaEndpoint', 1, repeated=True)
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaContextualHeaders(_messages.Message):
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaContextualHeadersDelegatedGroupInfo(_messages.Message):
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaContextualHeadersDelegatedUserInfo(_messages.Message):
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaEndpoint(_messages.Message):
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaProxyProtocolConfig(_messages.Message):
  ...
  contextualHeaders = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaContextualHeaders', 3)
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaSecurityGateway(_messages.Message):
  ...
  name = _messages.StringField(6)
  proxyProtocolConfig = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaProxyProtocolConfig', 7)
  serviceDiscovery = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaServiceDiscovery', 8)
  state = _messages.EnumField('StateValueValuesEnum', 9)
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaServiceDiscovery(_messages.Message):
...
class GoogleCloudBeyondcorpSecuritygatewaysV1alphaServiceDiscoveryApiGateway(_messages.Message):
  ...
  resourceOverride = _messages.MessageField('GoogleCloudBeyondcorpSecuritygatewaysV1alphaServiceDiscoveryApiGatewayOperationDescriptor', 1)


class GoogleCloudBeyondcorpSecuritygatewaysV1alphaServiceDiscoveryApiGatewayOperationDescriptor(_messages.Message):
