...
class Tag(_messages.Message):
  ...
  tagKeyId = _messages.StringField(2)
  tagValue = _messages.StringField(3)
  tagValueId = _messages.StringField(4)
...
class ValidationResult(_messages.Message):
  r"""Validation result of the other-cloud connection.
  ...
  class ConnectionStateValueValuesEnum(_messages.Enum):
    r"""NOTE: Deprecated The state of the other-cloud connection
