...
from googlecloudsdk.generated_clients.apis.gameservices.v1beta import gameservices_v1beta_messages as messages
...
class GameservicesV1beta(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = 'GameservicesV1beta'
  _URL_VERSION = 'v1beta'
  _API_KEY = None
  ...
  class ProjectsLocationsGameServerDeploymentsConfigsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}/configs',
        http_method='POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}/configs/{configsId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsGameServerDeploymentsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments',
        http_method='POST',
        method_id='gameservices.projects.locations.gameServerDeployments.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['deploymentId'],
        relative_path='v1beta/{+parent}/gameServerDeployments',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}',
        http_method='DELETE',
    ...
    FetchDeploymentState.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}:fetchDeploymentState',
        http_method='POST',
        method_id='gameservices.projects.locations.gameServerDeployments.fetchDeploymentState',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta/{+name}:fetchDeploymentState',
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}:getIamPolicy',
        http_method='GET',
    ...
    GetRollout.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}/rollout',
        http_method='GET',
        method_id='gameservices.projects.locations.gameServerDeployments.getRollout',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta/{+name}/rollout',
        request_field='',
    ...
    PreviewRollout.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}/rollout:preview',
        http_method='PATCH',
        method_id='gameservices.projects.locations.gameServerDeployments.previewRollout',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['previewTime', 'updateMask'],
        relative_path='v1beta/{+name}/rollout:preview',
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}:setIamPolicy',
        http_method='POST',
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/gameServerDeployments/{gameServerDeploymentsId}:testIamPermissions',
        http_method='POST',
  ...
  class ProjectsLocationsRealmsGameServerClustersService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/realms/{realmsId}/gameServerClusters',
        http_method='POST',
        method_id='gameservices.projects.locations.realms.gameServerClusters.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['gameServerClusterId'],
        relative_path='v1beta/{+parent}/gameServerClusters',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/realms/{realmsId}/gameServerClusters/{gameServerClustersId}',
        http_method='DELETE',
    ...
    PreviewCreate.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/realms/{realmsId}/gameServerClusters:previewCreate',
        http_method='POST',
        method_id='gameservices.projects.locations.realms.gameServerClusters.previewCreate',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['gameServerClusterId', 'previewTime', 'view'],
        relative_path='v1beta/{+parent}/gameServerClusters:previewCreate',
        request_field='gameServerCluster',
    ...
    PreviewDelete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/realms/{realmsId}/gameServerClusters/{gameServerClustersId}:previewDelete',
        http_method='DELETE',
        method_id='gameservices.projects.locations.realms.gameServerClusters.previewDelete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['previewTime'],
        relative_path='v1beta/{+name}:previewDelete',
        request_field='',
    ...
    PreviewUpdate.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/realms/{realmsId}/gameServerClusters/{gameServerClustersId}:previewUpdate',
        http_method='PATCH',
        method_id='gameservices.projects.locations.realms.gameServerClusters.previewUpdate',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['previewTime', 'updateMask'],
        relative_path='v1beta/{+name}:previewUpdate',
        request_field='gameServerCluster',
  ...
  class ProjectsLocationsRealmsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/realms',
        http_method='POST',
        method_id='gameservices.projects.locations.realms.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['realmId'],
        relative_path='v1beta/{+parent}/realms',
        request_field='realm',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/realms/{realmsId}',
        http_method='DELETE',
    ...
    PreviewUpdate.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/realms/{realmsId}:previewUpdate',
        http_method='PATCH',
