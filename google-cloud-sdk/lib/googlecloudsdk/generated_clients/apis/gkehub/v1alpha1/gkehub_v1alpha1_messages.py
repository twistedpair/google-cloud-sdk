...
class ConfigSync(_messages.Message):
  ...
  Fields:
    ...
    enabled: Enables the installation of Config Sync. If set to true, the
      Feature will manage Config Sync resources, and apply the other
    ...
    preventDrift: Set to true to enable the Config Sync admission webhook to
      ...
      webhook and does not prevent drifts. Defaults to false. See
    ...
    sourceFormat: Specifies whether the Config Sync repo is in `hierarchical`
      or `unstructured` mode. Defaults to `hierarchical`. See
      https://docs.cloud.google.com/kubernetes-engine/config-
...
class ContainerOverride(_messages.Message):
  ...
  Fields:
    ...
    cpuLimit: The cpu limit of the container. Use the following CPU resource
      units: https://kubernetes.io/docs/concepts/configuration/manage-
      resources-containers/#meaning-of-cpu.
    cpuRequest: The cpu request of the container. Use the following CPU
      resource units:
      https://kubernetes.io/docs/concepts/configuration/manage-resources-
      containers/#meaning-of-cpu.
    memoryLimit: The memory limit of the container. Use the following memory
      resource units:
      https://kubernetes.io/docs/concepts/configuration/manage-resources-
      containers/#meaning-of-memory.
    memoryRequest: The memory request of the container. Use the following
...
class MembershipConfig(_messages.Message):
  ...
  Fields:
    binauthz: Deprecated: Binauthz configuration will be ignored and should
      not be set.
    cluster: User-specified cluster name used by the Config Sync cluster-name-
      selector annotation or ClusterSelector object, for applying configs to
      only a subset of clusters. Read more about the cluster-name-selector
      annotation and ClusterSelector object at
      https://docs.cloud.google.com/kubernetes-engine/config-sync/docs/how-
    ...
    policyController: Policy Controller configuration for the cluster.
      ...
      instead.
    version: Version of Config Sync to install. Defaults to the latest
...
class OciConfig(_messages.Message):
  ...
  Fields:
    ...
    secretType: Type of secret configured for access to the OCI repo. Must be
      one of `gcenode`, `gcpserviceaccount`, `k8sserviceaccount` or `none`.
