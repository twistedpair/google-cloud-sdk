...
BASE_URL = 'https://gkehub.googleapis.com/v2beta/'
...
class Collections(enum.Enum):
  ...
  PROJECTS_LOCATIONS_MEMBERSHIPS = (
      ...
      '{membershipsId}',
      {},
      ['projectsId', 'locationsId', 'membershipsId'],
      True
  )
  PROJECTS_LOCATIONS_MEMBERSHIPS_FEATURES = (
      'projects.locations.memberships.features',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/memberships/'
              '{membershipsId}/features/{featuresId}',
      },
      ['name'],
      True
  )
