"""Generated client library for cloudapiregistry version v1beta."""
# NOTE: This file is autogenerated and should not be edited by hand.

from __future__ import absolute_import

from apitools.base.py import base_api
from googlecloudsdk.generated_clients.apis.cloudapiregistry.v1beta import cloudapiregistry_v1beta_messages as messages


class CloudapiregistryV1beta(base_api.BaseApiClient):
  """Generated client library for service cloudapiregistry version v1beta."""
  ...
  _CLIENT_CLASS_NAME = 'CloudapiregistryV1beta'
  _URL_VERSION = 'v1beta'
  _API_KEY = None
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(CloudapiregistryV1beta, self).__init__(
  ...
  class ProjectsLocationsMcpServersMcpToolsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudapiregistryV1beta.ProjectsLocationsMcpServersMcpToolsService, self).__init__(client)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/mcpServers/{mcpServersId}/mcpTools/{mcpToolsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/mcpServers/{mcpServersId}/mcpTools',
        http_method='GET',
        method_id='cloudapiregistry.projects.locations.mcpServers.mcpTools.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1beta/{+parent}/mcpTools',
        request_field='',
  ...
  class ProjectsLocationsMcpServersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudapiregistryV1beta.ProjectsLocationsMcpServersService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/mcpServers/{mcpServersId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta/projects/{projectsId}/locations/{locationsId}/mcpServers',
        http_method='GET',
        method_id='cloudapiregistry.projects.locations.mcpServers.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1beta/{+parent}/mcpServers',
        request_field='',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudapiregistryV1beta.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudapiregistryV1beta.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
