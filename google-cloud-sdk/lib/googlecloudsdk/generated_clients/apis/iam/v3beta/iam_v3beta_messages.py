...
class GoogleIamV3betaListPoliciesResponse(_messages.Message):
  ...
  policies = _messages.MessageField('GoogleIamV3betaPolicy', 2, repeated=True)
...
class IamFoldersLocationsPoliciesCreateRequest(_messages.Message):
  ...
  Fields:
    googleIamV3betaPolicy: A GoogleIamV3betaPolicy resource to be passed as
      the request body.
  ...
  googleIamV3betaPolicy = _messages.MessageField('GoogleIamV3betaPolicy', 1)
