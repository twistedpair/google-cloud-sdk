...
class NetworkmanagementV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsVpcFlowLogsConfigsService(base_api.BaseApiService):
    ...
    def Create(self, request, global_params=None):
      r"""Creates a new VPC Flow Logs configuration. If a configuration with the exact same settings already exists, the creation fails.
    ...
    def Delete(self, request, global_params=None):
      r"""Deletes a specific VpcFlowLog configuration.
    ...
    def Get(self, request, global_params=None):
      r"""Gets the details of a specific VPC Flow Log configuration.
    ...
    def List(self, request, global_params=None):
      r"""Lists all VPC Flow Logs configurations in a given project.
    ...
    def Patch(self, request, global_params=None):
      r"""Updates an existing VpcFlowLogsConfig. If a configuration with the exact same settings already exists, the creation fails.
