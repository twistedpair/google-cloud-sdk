...
class DropInfo(_messages.Message):
  ...
  class CauseValueValuesEnum(_messages.Enum):
    ...
    INGRESS_FIREWALL_TAGS_UNSUPPORTED_BY_DIRECT_VPC_EGRESS = 25
    INSTANCE_NOT_RUNNING = 26
    GKE_CLUSTER_NOT_RUNNING = 27
    CLOUD_SQL_INSTANCE_NOT_RUNNING = 28
    REDIS_INSTANCE_NOT_RUNNING = 29
    REDIS_CLUSTER_NOT_RUNNING = 30
    ALLOY_DB_INSTANCE_NOT_READY = 31
