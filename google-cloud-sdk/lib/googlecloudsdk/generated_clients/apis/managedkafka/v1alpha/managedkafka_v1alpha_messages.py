"""Generated message classes for managedkafka version v1alpha.
...
class CapacityConfig(_messages.Message):
  ...
  Fields:
    memoryBytes: Required. The memory to provision for the cluster in bytes.
      The CPU:memory ratio (vCPU:GiB) must be between 1:1 and 1:6. Minimum:
      3221225472 (3 GiB).
...
class Cluster(_messages.Message):
  r"""A Kafka Cluster deployed in a Location.
  ...
  Fields:
    ...
    name: The name of the cluster. Structured like:
...
class ConsumerGroup(_messages.Message):
  ...
  Fields:
    name: The name of the consumer group. The `consumer_group` segment is used
      when connecting directly to the cluster. Structured like: projects/{proj
      ect}/locations/{location}/clusters/{cluster}/consumer_groups/{consumer_g
      roup}
...
class ManagedkafkaProjectsLocationsClustersConsumerGroupsCreateRequest(_messages.Message):
  r"""A ManagedkafkaProjectsLocationsClustersConsumerGroupsCreateRequest
  object.

  Fields:
    consumerGroup: A ConsumerGroup resource to be passed as the request body.
    consumerGroupId: Required. The ID to use for the consumer group, which
      will become the final component of the consumer group's name. This value
      is structured like: `my-consumer-group-name`.
    parent: Required. The parent cluster in which to create the consumer
      group. Structured like
      `projects/{project}/locations/{location}/clusters/{cluster}`.
  """
...
class ManagedkafkaProjectsLocationsClustersConsumerGroupsListRequest(_messages.Message):
  ...
  Fields:
    pageSize: The maximum number of consumer groups to return. The service may
      return fewer than this value. If unset or zero, all consumer groups for
      the parent will be returned.
    pageToken: A page token, received from a previous `ListConsumerGroups`
      call. Provide this to retrieve the subsequent page. When paginating, all
      other parameters provided to `ListConsumerGroups` must match the call
      that provided the page token.
    parent: Required. The parent whose consumer groups are to be listed.
      Structured like
      `projects/{project}/locations/{location}/clusters/{cluster}`.
  """
...
class ManagedkafkaProjectsLocationsClustersConsumerGroupsPatchRequest(_messages.Message):
  ...
  Fields:
    ...
    updateMask: Required. Field mask is used to specify the fields to be
      ...
      request. A field will be overwritten if it is in the mask. If a mask is
      not provided, then all fields will be overwritten.
  """
...
class ManagedkafkaProjectsLocationsClustersCreateRequest(_messages.Message):
  ...
  Fields:
    ...
    clusterId: Required. The ID to use for the cluster, which will become the
      final component of the cluster's name. This value is structured like:
      `my-cluster-name`.
...
class ManagedkafkaProjectsLocationsClustersListRequest(_messages.Message):
  ...
  Fields:
    filter: Filter expression for the result.
    ...
    pageToken: A page token, received from a previous `ListClusters` call.
      ...
      the page token.
    parent: Required. The parent whose clusters are to be listed. Structured
...
class ManagedkafkaProjectsLocationsClustersTopicsPatchRequest(_messages.Message):
  ...
  Fields:
    name: The name of the topic. The `topic` segment is used when connecting
    ...
    updateMask: Required. Field mask is used to specify the fields to be
      ...
      field will be overwritten if it is in the mask. If a mask is not
...
class Topic(_messages.Message):
  ...
  Fields:
    ...
    name: The name of the topic. The `topic` segment is used when connecting
      directly to the cluster. Structured like: projects/{project}/locations/{
      location}/clusters/{cluster}/topics/{topic}
    partitionCount: Immutable. The number of partitions this topic has.
      IMMUTABLE because no safe method to increase topic partition count
      exists.
