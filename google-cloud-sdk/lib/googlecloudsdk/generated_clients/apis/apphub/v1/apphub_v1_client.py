...
class ApphubV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsExtendedMetadataSchemasService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ApphubV1.ProjectsLocationsExtendedMetadataSchemasService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/extendedMetadataSchemas/{extendedMetadataSchemasId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/extendedMetadataSchemas',
        http_method='GET',
        method_id='apphub.projects.locations.extendedMetadataSchemas.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1/{+parent}/extendedMetadataSchemas',
        request_field='',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    GetBoundary.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/boundary',
        http_method='GET',
