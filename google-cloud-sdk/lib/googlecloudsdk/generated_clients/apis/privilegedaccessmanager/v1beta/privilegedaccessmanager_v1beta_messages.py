...
Privileged Access Manager (PAM) is a service to control just-in-time temporary
privilege elevation for select principals, and to view audit logs afterwards
