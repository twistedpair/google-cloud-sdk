...
class GoogleCloudPolicysimulatorV1alphaIamV3RegionalAccessBoundaryPolicy(_messages.Message):
  ...
  annotations = _messages.MessageField('AnnotationsValue', 1)
  details = _messages.MessageField('GoogleCloudPolicysimulatorV1alphaIamV3RegionalAccessBoundaryPolicyDetails', 2)
  displayName = _messages.StringField(3)
  etag = _messages.StringField(4)
  name = _messages.StringField(5)


class GoogleCloudPolicysimulatorV1alphaIamV3RegionalAccessBoundaryPolicyDetails(_messages.Message):
  ...
  enforcementVersion = _messages.StringField(1)
  rules = _messages.MessageField('GoogleCloudPolicysimulatorV1alphaIamV3RegionalAccessBoundaryPolicyRule', 2, repeated=True)


class GoogleCloudPolicysimulatorV1alphaIamV3RegionalAccessBoundaryPolicyRule(_messages.Message):
...
class GoogleCloudPolicysimulatorV1alphaProposedChange(_messages.Message):
  ...
  updateIamV3RegionalAccessBoundaryPolicy = _messages.MessageField('GoogleCloudPolicysimulatorV1alphaUpdateIamV3RegionalAccessBoundaryPolicy', 9)
...
class GoogleCloudPolicysimulatorV1alphaSearchActivityBacktestResultsResponseInaccessibleResults(_messages.Message):
...
class GoogleCloudPolicysimulatorV1alphaSearchActivityBacktestResultsResponseSearchActivityBacktestResult(_messages.Message):
  ...
  inaccessibleResults = _messages.MessageField('GoogleCloudPolicysimulatorV1alphaSearchActivityBacktestResultsResponseInaccessibleResults', 2)
...
class GoogleCloudPolicysimulatorV1alphaUpdateIamV3RegionalAccessBoundaryPolicy(_messages.Message):
  ...
  regionalAccessBoundaryPolicy = _messages.MessageField('GoogleCloudPolicysimulatorV1alphaIamV3RegionalAccessBoundaryPolicy', 1)
  updateMask = _messages.StringField(2)
