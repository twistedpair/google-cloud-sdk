"""Generated client library for configdelivery version v1."""
# NOTE: This file is autogenerated and should not be edited by hand.

from __future__ import absolute_import

from apitools.base.py import base_api
from googlecloudsdk.generated_clients.apis.configdelivery.v1 import configdelivery_v1_messages as messages


class ConfigdeliveryV1(base_api.BaseApiClient):
  """Generated client library for service configdelivery version v1."""
  ...
  _CLIENT_CLASS_NAME = 'ConfigdeliveryV1'
  _URL_VERSION = 'v1'
  _API_KEY = None
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(ConfigdeliveryV1, self).__init__(
  ...
  class ProjectsLocationsFleetPackagesRolloutsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1.ProjectsLocationsFleetPackagesRolloutsService, self).__init__(client)
    ...
    Abort.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts/{rolloutsId}:abort',
        http_method='POST',
        method_id='configdelivery.projects.locations.fleetPackages.rollouts.abort',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:abort',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts/{rolloutsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts',
        http_method='GET',
    ...
    Resume.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts/{rolloutsId}:resume',
        http_method='POST',
    ...
    Suspend.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts/{rolloutsId}:suspend',
        http_method='POST',
        method_id='configdelivery.projects.locations.fleetPackages.rollouts.suspend',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:suspend',
  ...
  class ProjectsLocationsFleetPackagesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1.ProjectsLocationsFleetPackagesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/fleetPackages',
        http_method='POST',
        method_id='configdelivery.projects.locations.fleetPackages.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['fleetPackageId', 'requestId'],
        relative_path='v1/{+parent}/fleetPackages',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsResourceBundlesReleasesVariantsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1.ProjectsLocationsResourceBundlesReleasesVariantsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/resourceBundles/{resourceBundlesId}/releases/{releasesId}/variants',
        http_method='POST',
        method_id='configdelivery.projects.locations.resourceBundles.releases.variants.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'variantId'],
        relative_path='v1/{+parent}/variants',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/resourceBundles/{resourceBundlesId}/releases/{releasesId}/variants/{variantsId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsResourceBundlesReleasesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1.ProjectsLocationsResourceBundlesReleasesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/resourceBundles/{resourceBundlesId}/releases',
        http_method='POST',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/resourceBundles/{resourceBundlesId}/releases/{releasesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsResourceBundlesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1.ProjectsLocationsResourceBundlesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/resourceBundles',
        http_method='POST',
        method_id='configdelivery.projects.locations.resourceBundles.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'resourceBundleId'],
        relative_path='v1/{+parent}/resourceBundles',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/resourceBundles/{resourceBundlesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
