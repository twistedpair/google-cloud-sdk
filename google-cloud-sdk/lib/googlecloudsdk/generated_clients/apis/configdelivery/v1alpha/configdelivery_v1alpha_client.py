"""Generated client library for configdelivery version v1alpha."""
...
class ConfigdeliveryV1alpha(base_api.BaseApiClient):
  """Generated client library for service configdelivery version v1alpha."""
  ...
  _CLIENT_CLASS_NAME = 'ConfigdeliveryV1alpha'
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(ConfigdeliveryV1alpha, self).__init__(
  ...
  class ProjectsLocationsFleetPackagesRolloutsService(base_api.BaseApiService):
    ...
    Abort.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts/{rolloutsId}:abort',
        http_method='POST',
        method_id='configdelivery.projects.locations.fleetPackages.rollouts.abort',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}:abort',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts/{rolloutsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts',
        http_method='GET',
    ...
    Resume.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts/{rolloutsId}:resume',
        http_method='POST',
    ...
    Suspend.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}/rollouts/{rolloutsId}:suspend',
        http_method='POST',
        method_id='configdelivery.projects.locations.fleetPackages.rollouts.suspend',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha/{+name}:suspend',
  ...
  class ProjectsLocationsFleetPackagesService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/fleetPackages',
        http_method='POST',
        method_id='configdelivery.projects.locations.fleetPackages.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['fleetPackageId', 'requestId'],
        relative_path='v1alpha/{+parent}/fleetPackages',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/fleetPackages/{fleetPackagesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1alpha.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsResourceBundlesReleasesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1alpha.ProjectsLocationsResourceBundlesReleasesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/resourceBundles/{resourceBundlesId}/releases',
        http_method='POST',
        method_id='configdelivery.projects.locations.resourceBundles.releases.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['releaseId', 'requestId'],
        relative_path='v1alpha/{+parent}/releases',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/resourceBundles/{resourceBundlesId}/releases/{releasesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsResourceBundlesService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/resourceBundles',
        http_method='POST',
        method_id='configdelivery.projects.locations.resourceBundles.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId', 'resourceBundleId'],
        relative_path='v1alpha/{+parent}/resourceBundles',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/resourceBundles/{resourceBundlesId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1alpha.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConfigdeliveryV1alpha.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
