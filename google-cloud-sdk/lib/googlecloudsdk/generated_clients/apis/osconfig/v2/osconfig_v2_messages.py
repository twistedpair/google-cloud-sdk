"""Generated message classes for osconfig version v2.
...
class GoogleCloudOsconfigV2ListPolicyOrchestratorsResponse(_messages.Message):
  ...
  policyOrchestrators = _messages.MessageField('GoogleCloudOsconfigV2PolicyOrchestrator', 2, repeated=True)
...
class GoogleCloudOsconfigV2OrchestratedResource(_messages.Message):
...
class GoogleCloudOsconfigV2OrchestrationScope(_messages.Message):
  ...
  selectors = _messages.MessageField('GoogleCloudOsconfigV2OrchestrationScopeSelector', 1, repeated=True)


class GoogleCloudOsconfigV2OrchestrationScopeLocationSelector(_messages.Message):
...
class GoogleCloudOsconfigV2OrchestrationScopeResourceHierarchySelector(_messages.Message):
...
class GoogleCloudOsconfigV2OrchestrationScopeSelector(_messages.Message):
  ...
  locationSelector = _messages.MessageField('GoogleCloudOsconfigV2OrchestrationScopeLocationSelector', 1)
  resourceHierarchySelector = _messages.MessageField('GoogleCloudOsconfigV2OrchestrationScopeResourceHierarchySelector', 2)


class GoogleCloudOsconfigV2PolicyOrchestrator(_messages.Message):
  ...
  orchestratedResource = _messages.MessageField('GoogleCloudOsconfigV2OrchestratedResource', 7)
  orchestrationScope = _messages.MessageField('GoogleCloudOsconfigV2OrchestrationScope', 8)
  orchestrationState = _messages.MessageField('GoogleCloudOsconfigV2PolicyOrchestratorOrchestrationState', 9)
  reconciling = _messages.BooleanField(10)
  state = _messages.StringField(11)
  updateTime = _messages.StringField(12)


class GoogleCloudOsconfigV2PolicyOrchestratorIterationState(_messages.Message):
...
class GoogleCloudOsconfigV2PolicyOrchestratorOrchestrationState(_messages.Message):
  ...
  currentIterationState = _messages.MessageField('GoogleCloudOsconfigV2PolicyOrchestratorIterationState', 1)
  previousIterationState = _messages.MessageField('GoogleCloudOsconfigV2PolicyOrchestratorIterationState', 2)
...
class OsconfigFoldersLocationsGlobalPolicyOrchestratorsCreateRequest(_messages.Message):
  ...
  googleCloudOsconfigV2PolicyOrchestrator = _messages.MessageField('GoogleCloudOsconfigV2PolicyOrchestrator', 1)
