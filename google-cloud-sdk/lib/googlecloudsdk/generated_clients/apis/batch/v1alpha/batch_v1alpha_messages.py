...
class CloudLoggingOption(_messages.Message):
  r"""CloudLoggingOption contains additional settings for cloud logging
  generated by Batch job.

  Fields:
    useGenericTaskMonitoredResource: Optional. Set this flag to true to use
      generic_task as monitored resource for Batch job generated cloud
      logging.
  """
...
class TaskGroup(_messages.Message):
  ...
  Fields:
    ...
    enableOslogin: Optional. When true, Batch will use the OS Login generated
      POSIX account to exeucute the runnables instead of the default root
      user. To control root or non-root privilege for runnable execution, the
      project \ Admin user needs to configure IAM roles according to
      https://cloud.google.com/compute/docs/oslogin/set-up-
