...
class BatchV1alpha1(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.projects_locations_state = self.ProjectsLocationsStateService(self)
  ...
  class ProjectsLocationsStateService(base_api.BaseApiService):
    """Service class for the projects_locations_state resource."""

    _NAME = 'projects_locations_state'

    def __init__(self, client):
      super(BatchV1alpha1.ProjectsLocationsStateService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    def Report(self, request, global_params=None):
      ...
      Args:
        request: (BatchProjectsLocationsStateReportRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ReportAgentStateResponse) The response message.
      """
    ...
    Report.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/state:report',
        http_method='POST',
        method_id='batch.projects.locations.state.report',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1alpha1/{+parent}/state:report',
        request_field='reportAgentStateRequest',
        request_type_name='BatchProjectsLocationsStateReportRequest',
        response_type_name='ReportAgentStateResponse',
        supports_download=False,
    )
