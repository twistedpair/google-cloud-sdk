...
class RedisV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsClustersService(base_api.BaseApiService):
    ...
    RescheduleClusterMaintenance.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:rescheduleClusterMaintenance',
        http_method='POST',
        method_id='redis.projects.locations.clusters.rescheduleClusterMaintenance',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:rescheduleClusterMaintenance',
