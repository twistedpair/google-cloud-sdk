...
class RedisV1alpha1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsBackupCollectionsBackupsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(RedisV1alpha1.ProjectsLocationsBackupCollectionsBackupsService, self).__init__(client)
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/backupCollections/{backupCollectionsId}/backups/{backupsId}',
        http_method='DELETE',
    ...
    Export.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/backupCollections/{backupCollectionsId}/backups/{backupsId}:export',
        http_method='POST',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/backupCollections/{backupCollectionsId}/backups',
        http_method='GET',
  ...
  class ProjectsLocationsBackupCollectionsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(RedisV1alpha1.ProjectsLocationsBackupCollectionsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/backupCollections/{backupCollectionsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/backupCollections',
        http_method='GET',
        method_id='redis.projects.locations.backupCollections.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1alpha1/{+parent}/backupCollections',
        request_field='',
  ...
  class ProjectsLocationsClustersService(base_api.BaseApiService):
    ...
    Backup.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:backup',
        http_method='POST',
        method_id='redis.projects.locations.clusters.backup',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:backup',
    ...
    RescheduleClusterMaintenance.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:rescheduleClusterMaintenance',
        http_method='POST',
        method_id='redis.projects.locations.clusters.rescheduleClusterMaintenance',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:rescheduleClusterMaintenance',
