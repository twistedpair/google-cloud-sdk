...
class Instance(_messages.Message):
  ...
  catalogIntegrationEnabled = _messages.BooleanField(2)
  ...
  geminiAiConfig = _messages.MessageField('GeminiAiConfig', 13)
  ...
  userMetadata = _messages.MessageField('UserMetadata', 37)
