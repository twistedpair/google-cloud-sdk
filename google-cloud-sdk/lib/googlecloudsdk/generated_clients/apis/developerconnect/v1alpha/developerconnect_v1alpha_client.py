...
class DeveloperconnectV1alpha(base_api.BaseApiClient):
  ...
  class ProjectsLocationsConnectionsService(base_api.BaseApiService):
    ...
    ProcessGitLabEnterpriseWebhook.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/connections:processGitLabEnterpriseWebhook',
        http_method='POST',
        method_id='developerconnect.projects.locations.connections.processGitLabEnterpriseWebhook',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1alpha/{+parent}/connections:processGitLabEnterpriseWebhook',
    ...
    ProcessGitLabWebhook.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/connections:processGitLabWebhook',
        http_method='POST',
        method_id='developerconnect.projects.locations.connections.processGitLabWebhook',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=[],
        relative_path='v1alpha/{+parent}/connections:processGitLabWebhook',
