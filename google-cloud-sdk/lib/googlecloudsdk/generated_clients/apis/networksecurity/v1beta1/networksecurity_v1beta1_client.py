...
class NetworksecurityV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsFirewallAttachmentsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(NetworksecurityV1beta1.ProjectsLocationsFirewallAttachmentsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/firewallAttachments',
        http_method='POST',
        method_id='networksecurity.projects.locations.firewallAttachments.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['firewallAttachmentId', 'requestId'],
        relative_path='v1beta1/{+parent}/firewallAttachments',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/firewallAttachments/{firewallAttachmentsId}',
        http_method='DELETE',
