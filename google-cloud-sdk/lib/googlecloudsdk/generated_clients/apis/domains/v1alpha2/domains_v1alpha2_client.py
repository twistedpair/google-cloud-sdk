...
class DomainsV1alpha2(base_api.BaseApiClient):
  ...
  class ProjectsLocationsRegistrationsService(base_api.BaseApiService):
    ...
    InitiatePushTransfer.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/registrations/{registrationsId}:initiatePushTransfer',
        http_method='POST',
        method_id='domains.projects.locations.registrations.initiatePushTransfer',
        ordered_params=['registration'],
        path_params=['registration'],
        query_params=[],
        relative_path='v1alpha2/{+registration}:initiatePushTransfer',
    ...
    RenewDomain.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/registrations/{registrationsId}:renewDomain',
        http_method='POST',
        method_id='domains.projects.locations.registrations.renewDomain',
        ordered_params=['registration'],
        path_params=['registration'],
        query_params=[],
        relative_path='v1alpha2/{+registration}:renewDomain',
    ...
    RetrieveGoogleDomainsDnsRecords.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/registrations/{registrationsId}:retrieveGoogleDomainsDnsRecords',
        http_method='GET',
        method_id='domains.projects.locations.registrations.retrieveGoogleDomainsDnsRecords',
        ordered_params=['registration'],
        path_params=['registration'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1alpha2/{+registration}:retrieveGoogleDomainsDnsRecords',
        request_field='',
    ...
    RetrieveGoogleDomainsForwardingConfig.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha2/projects/{projectsId}/locations/{locationsId}/registrations/{registrationsId}:retrieveGoogleDomainsForwardingConfig',
        http_method='GET',
        method_id='domains.projects.locations.registrations.retrieveGoogleDomainsForwardingConfig',
        ordered_params=['registration'],
        path_params=['registration'],
        query_params=[],
        relative_path='v1alpha2/{+registration}:retrieveGoogleDomainsForwardingConfig',
        request_field='',
