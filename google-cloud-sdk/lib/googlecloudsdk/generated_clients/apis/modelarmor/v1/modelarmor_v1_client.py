"""Generated client library for modelarmor version v1."""
# NOTE: This file is autogenerated and should not be edited by hand.

from __future__ import absolute_import

from apitools.base.py import base_api
from googlecloudsdk.generated_clients.apis.modelarmor.v1 import modelarmor_v1_messages as messages


class ModelarmorV1(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = 'ModelarmorV1'
  _URL_VERSION = 'v1'
  _API_KEY = None
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(ModelarmorV1, self).__init__(
  ...
  class FoldersLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ModelarmorV1.FoldersLocationsService, self).__init__(client)
    ...
    GetFloorSetting.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/folders/{foldersId}/locations/{locationsId}/floorSetting',
        http_method='GET',
  ...
  class FoldersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ModelarmorV1.FoldersService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class OrganizationsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ModelarmorV1.OrganizationsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    GetFloorSetting.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/floorSetting',
        http_method='GET',
  ...
  class OrganizationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ModelarmorV1.OrganizationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsTemplatesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ModelarmorV1.ProjectsLocationsTemplatesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    SanitizeModelResponse.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/templates/{templatesId}:sanitizeModelResponse',
        http_method='POST',
        method_id='modelarmor.projects.locations.templates.sanitizeModelResponse',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:sanitizeModelResponse',
    ...
    SanitizeUserPrompt.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/templates/{templatesId}:sanitizeUserPrompt',
        http_method='POST',
        method_id='modelarmor.projects.locations.templates.sanitizeUserPrompt',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:sanitizeUserPrompt',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ModelarmorV1.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    GetFloorSetting.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/floorSetting',
        http_method='GET',
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ModelarmorV1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
