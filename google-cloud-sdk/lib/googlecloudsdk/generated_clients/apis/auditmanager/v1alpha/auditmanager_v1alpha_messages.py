...
class AuditmanagerFoldersLocationsOperationsGetRequest(_messages.Message):
  r"""A AuditmanagerFoldersLocationsOperationsGetRequest object.
...
class GenerateAuditReportRequest(_messages.Message):
  ...
  Fields:
    complianceRegime: Required. Compliance Regime against which the Scope
  ...
  complianceRegime = _messages.StringField(1)
