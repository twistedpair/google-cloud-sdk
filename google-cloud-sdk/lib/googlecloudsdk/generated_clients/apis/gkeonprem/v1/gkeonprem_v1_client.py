...
class GkeonpremV1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsBareMetalAdminClustersService(base_api.BaseApiService):
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['allowMissing', 'view'],
        relative_path='v1/{+name}',
        request_field='',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['allowMissing', 'pageSize', 'pageToken', 'view'],
        relative_path='v1/{+parent}/bareMetalAdminClusters',
        request_field='',
  ...
  class ProjectsLocationsBareMetalClustersService(base_api.BaseApiService):
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['allowMissing', 'filter', 'pageSize', 'pageToken', 'view'],
        relative_path='v1/{+parent}/bareMetalClusters',
        request_field='',
  ...
  class ProjectsLocationsVmwareAdminClustersService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['allowPreflightFailure', 'skipValidations', 'validateOnly', 'vmwareAdminClusterId'],
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['skipValidations', 'updateMask', 'validateOnly'],
        relative_path='v1/{+name}',
        request_field='vmwareAdminCluster',
  ...
  class ProjectsLocationsVmwareClustersService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['allowPreflightFailure', 'skipValidations', 'validateOnly', 'vmwareClusterId'],
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['allowMissing', 'skipValidations', 'updateMask', 'validateOnly'],
        relative_path='v1/{+name}',
        request_field='vmwareCluster',
