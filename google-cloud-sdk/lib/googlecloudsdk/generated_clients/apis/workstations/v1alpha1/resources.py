...
BASE_URL = 'https://workstations.googleapis.com/v1alpha1/'
...
class Collections(enum.Enum):
  ...
  PROJECTS_LOCATIONS_WORKSTATIONCLUSTERS_WORKSTATIONS = (
      'projects.locations.workstationClusters.workstations',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/'
              'workstationClusters/{workstationClustersId}/workstations/'
              '{workstationsId}',
      },
      ['name'],
      True
