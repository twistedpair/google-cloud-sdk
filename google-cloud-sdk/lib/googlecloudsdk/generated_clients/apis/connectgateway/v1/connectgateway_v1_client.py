"""Generated client library for connectgateway version v1."""
# NOTE: This file is autogenerated and should not be edited by hand.

from __future__ import absolute_import

from apitools.base.py import base_api
from googlecloudsdk.generated_clients.apis.connectgateway.v1 import connectgateway_v1_messages as messages


class ConnectgatewayV1(base_api.BaseApiClient):
  """Generated client library for service connectgateway version v1."""
  ...
  _CLIENT_CLASS_NAME = 'ConnectgatewayV1'
  _URL_VERSION = 'v1'
  _API_KEY = None
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(ConnectgatewayV1, self).__init__(
  ...
  class ProjectsLocationsMembershipsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConnectgatewayV1.ProjectsLocationsMembershipsService, self).__init__(client)
    ...
    GenerateCredentials.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/memberships/{membershipsId}:generateCredentials',
        http_method='GET',
        ...
        relative_path='v1/{+name}:generateCredentials',
        request_field='',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConnectgatewayV1.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ConnectgatewayV1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
