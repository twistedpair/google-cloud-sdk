...
class ContainerV1beta1(base_api.BaseApiClient):
  ...
  class ProjectsLocationsClustersService(base_api.BaseApiService):
    ...
    CompleteControlPlaneUpgrade.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:completeControlPlaneUpgrade',
        http_method='POST',
        method_id='container.projects.locations.clusters.completeControlPlaneUpgrade',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:completeControlPlaneUpgrade',
    ...
    def SetLocations(self, request, global_params=None):
      r"""Sets the locations for a specific cluster. Deprecated. Use [projects.locations.clusters.update](https://{$universe.dns_names.final_documentation_domain}/kubernetes-engine/docs/reference/rest/v1beta1/projects.locations.clusters/update) instead.
  ...
  class ProjectsZonesClustersService(base_api.BaseApiService):
    ...
    CompleteControlPlaneUpgrade.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/zones/{zonesId}/clusters/{clustersId}:completeControlPlaneUpgrade',
        http_method='POST',
