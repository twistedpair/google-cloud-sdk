"""Generated client library for parallelstore version v1."""
# NOTE: This file is autogenerated and should not be edited by hand.

from __future__ import absolute_import

from apitools.base.py import base_api
from googlecloudsdk.generated_clients.apis.parallelstore.v1 import parallelstore_v1_messages as messages


class ParallelstoreV1(base_api.BaseApiClient):
  """Generated client library for service parallelstore version v1."""
  ...
  _CLIENT_CLASS_NAME = 'ParallelstoreV1'
  _URL_VERSION = 'v1'
  _API_KEY = None
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(ParallelstoreV1, self).__init__(
  ...
  class ProjectsLocationsInstancesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ParallelstoreV1.ProjectsLocationsInstancesService, self).__init__(client)
    ...
    ExportData.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:exportData',
        http_method='POST',
    ...
    ImportData.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/locations/{locationsId}/instances/{instancesId}:importData',
        http_method='POST',
        method_id='parallelstore.projects.locations.instances.importData',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}:importData',
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ParallelstoreV1.ProjectsLocationsOperationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ParallelstoreV1.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(ParallelstoreV1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
