"""Generated message classes for geminicloudassist version v1.
...
class InvestigationRevision(_messages.Message):
  ...
  snapshot = _messages.MessageField('Investigation', 4)
...
class Observation(_messages.Message):
  ...
  relevantResources = _messages.StringField(12, repeated=True)
  systemRelevanceScore = _messages.FloatField(13, variant=_messages.Variant.FLOAT)
  text = _messages.StringField(14)
  timeIntervals = _messages.MessageField('Interval', 15, repeated=True)
