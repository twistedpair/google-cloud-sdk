...
class RolloutInfo(_messages.Message):
  ...
  errorInfo = _messages.MessageField('ErrorInfo', 3)
  errorMessage = _messages.StringField(4)
  postRolloutState = _messages.EnumField('PostRolloutStateValueValuesEnum', 5)
  rolloutState = _messages.EnumField('RolloutStateValueValuesEnum', 6)
...
class ShipmentInfo(_messages.Message):
  ...
  deliverySealNumber = _messages.StringField(2)
  deliveryTrackingCarrier = _messages.StringField(3)
  deliveryTrackingId = _messages.StringField(4)
  deliveryTrackingUri = _messages.StringField(5)
  returnLabelUri = _messages.StringField(6)
  returnTrackingCarrier = _messages.StringField(7)
  returnTrackingId = _messages.StringField(8)
  returnTrackingUri = _messages.StringField(9)
