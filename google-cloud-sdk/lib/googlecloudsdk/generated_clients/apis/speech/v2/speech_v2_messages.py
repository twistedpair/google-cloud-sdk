...
class CustomPromptConfig(_messages.Message):
...
class RecognitionFeatures(_messages.Message):
  ...
  Fields:
    customPromptConfig: Optional. Configuration to enable custom prompt for
      chirp3.
  ...
  customPromptConfig = _messages.MessageField('CustomPromptConfig', 1)
  ...
  multiChannelMode = _messages.EnumField('MultiChannelModeValueValuesEnum', 9)
...
class RecognitionResponseMetadata(_messages.Message):
  ...
  Fields:
    prompt: Optional. Output only. Provides the prompt used for the
      recognition request.
  ...
  totalBilledDuration = _messages.StringField(3)
