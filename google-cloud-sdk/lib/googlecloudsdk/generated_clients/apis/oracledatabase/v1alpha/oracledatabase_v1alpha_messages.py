...
class AutonomousDatabaseProperties(_messages.Message):
  ...
  Fields:
    ...
    dataSafeState: Output only. State of the Data Safe registration for this
      Autonomous Database.
    dataStorageSizeGb: Optional. The quantity of data in the database, in
      gigabytes.
    ...
    scheduledOperationDetails: Output only. The list of scheduled operations.
...
class CloudExadataInfrastructure(_messages.Message):
  ...
  Fields:
    ...
    name: Identifier. The name of the CloudExadataInfrastructure resource with
      ...
      tures/{cloud_exadata_infrastructure}
...
class DbServer(_messages.Message):
  ...
  Fields:
    ...
    name: Identifier. The name of the Db Server resource with the format: proj
      ...
      xadata_infrastructure}/dbServers/{db_server}
...
class GenerateAutonomousDatabaseWalletRequest(_messages.Message):
  r"""Message for generating an Autonomous Database Wallet

  Enums:
    TypeValueValuesEnum: Optional. The type of wallet generation. The default
      value is SINGLE.

  Fields:
    isRegional: Optional. True when requesting regional connection strings in
      PDB connect info, applicable to cross-region DG only.
    password: Required. The password to encrypt the keys inside the wallet.
      This has to be a minimum of 8 characters.
    type: Optional. The type of wallet generation. The default value is
      SINGLE.
  """

  class TypeValueValuesEnum(_messages.Enum):
    r"""Optional. The type of wallet generation. The default value is SINGLE.
...
class ListAutonomousDatabaseBackupsResponse(_messages.Message):
  r"""Message for response to listing Autonomous Database Backups
...
class OracledatabaseProjectsLocationsAutonomousDatabaseBackupsListRequest(_messages.Message):
  ...
  Fields:
    filter: Optional. Filtering results based on autonomous database . Format:
      autonomous_database_id="{autonomous_database_id}" Only
      autonomous_database_id field is supported with literal equality
      operator. This value is restricted to letters, numbers, and hyphen, with
      the first character a letter, the last a letter or a number, and a 63
      character maximum (^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$).
    ...
    pageToken: Optional. A token identifying a page of results the server
      should return.
    parent: Required. Parent value for ListAutonomousDatabaseBackupsRequest
...
class OracledatabaseProjectsLocationsAutonomousDatabasesGenerateWalletRequest(_messages.Message):
  ...
  Fields:
    generateAutonomousDatabaseWalletRequest: A
      ...
      request body.
    name: Required. Name of the ADB resource. Format projects/{project}/locati
      ons/{location}/autonomousDatabases/{autonomous_database}
  """
...
class RestoreAutonomousDatabaseRequest(_messages.Message):
  r"""Message for restoring an Autonomous Database
