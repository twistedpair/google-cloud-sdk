...
class ApplicationSettings(_messages.Message):
  ...
  Fields:
    ...
    attributePropagationSettings: Settings to configure attribute propagation
      to customer application. These attributes may come from
...
class AttributePropagationSettings(_messages.Message):
  r"""Configuration for propagating attributes to customer applications
  protected by IAP. These attributes may be SAML attributes from a 3rd party
  IdP, or potentially other sources in the future.
  ...
  Fields:
    ...
    expression: Raw string CEL expression. Expression should be of the form
