...
class SecuritypostureV1alpha(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    self.organizations_locations_dataSecurityPostures = self.OrganizationsLocationsDataSecurityPosturesService(self)
  ...
  class OrganizationsLocationsDataSecurityPosturesService(base_api.BaseApiService):
    """Service class for the organizations_locations_dataSecurityPostures resource."""

    _NAME = 'organizations_locations_dataSecurityPostures'

    def __init__(self, client):
      super(SecuritypostureV1alpha.OrganizationsLocationsDataSecurityPosturesService, self).__init__(client)
      self._upload_configs = {
          }

    def Create(self, request, global_params=None):
      r"""Creates a new DataSecurityPosture resource. If a DataSecurityPosture with the specified name already exists in the specified organization and location, the long running operation returns a ALREADY_EXISTS error.

      Args:
        request: (SecuritypostureOrganizationsLocationsDataSecurityPosturesCreateRequest) input message
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures',
        http_method='POST',
        method_id='securityposture.organizations.locations.dataSecurityPostures.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['postureId'],
        relative_path='v1alpha/{+parent}/dataSecurityPostures',
        request_field='dataSecurityPosture',
        request_type_name='SecuritypostureOrganizationsLocationsDataSecurityPosturesCreateRequest',
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (SecuritypostureOrganizationsLocationsDataSecurityPosturesDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures/{dataSecurityPosturesId}',
        http_method='DELETE',
        method_id='securityposture.organizations.locations.dataSecurityPostures.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['etag'],
        relative_path='v1alpha/{+name}',
        request_field='',
        request_type_name='SecuritypostureOrganizationsLocationsDataSecurityPosturesDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )

    def Get(self, request, global_params=None):
      r"""Gets a datasecurity posture in a given organization and location. User must provide revision_id to retrieve a specific revision of the resource. NOT_FOUND error is returned if the revision_id or the Posture name does not exist. In case revision_id is not provided then the latest Posture revision by UpdateTime is returned.

      Args:
        request: (SecuritypostureOrganizationsLocationsDataSecurityPosturesGetRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (DataSecurityPosture) The response message.
      """
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures/{dataSecurityPosturesId}',
        http_method='GET',
        method_id='securityposture.organizations.locations.dataSecurityPostures.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['revisionId'],
        relative_path='v1alpha/{+name}',
        request_field='',
        request_type_name='SecuritypostureOrganizationsLocationsDataSecurityPosturesGetRequest',
        response_type_name='DataSecurityPosture',
        supports_download=False,
    )

    def List(self, request, global_params=None):
      r"""========================== DataSecurity Postures ========================== Lists DataSecurity Postures in a given organization and location. In case a posture has multiple revisions, the latest revision as per UpdateTime will be returned.

      Args:
        request: (SecuritypostureOrganizationsLocationsDataSecurityPosturesListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListDataSecurityPosturesResponse) The response message.
      """
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures',
        http_method='GET',
        method_id='securityposture.organizations.locations.dataSecurityPostures.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1alpha/{+parent}/dataSecurityPostures',
        request_field='',
        request_type_name='SecuritypostureOrganizationsLocationsDataSecurityPosturesListRequest',
        response_type_name='ListDataSecurityPosturesResponse',
        supports_download=False,
    )

    def ListDataSecurityPostureRevisions(self, request, global_params=None):
      r"""Lists revisions of a DataSecurity Posture in a given organization and location.

      Args:
        request: (SecuritypostureOrganizationsLocationsDataSecurityPosturesListDataSecurityPostureRevisionsRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListDataSecurityPostureRevisionsResponse) The response message.
      """
      config = self.GetMethodConfig('ListDataSecurityPostureRevisions')
      return self._RunMethod(
          config, request, global_params=global_params)

    ListDataSecurityPostureRevisions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures/{dataSecurityPosturesId}:listDataSecurityPostureRevisions',
        http_method='GET',
        method_id='securityposture.organizations.locations.dataSecurityPostures.listDataSecurityPostureRevisions',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1alpha/{+name}:listDataSecurityPostureRevisions',
        request_field='',
        request_type_name='SecuritypostureOrganizationsLocationsDataSecurityPosturesListDataSecurityPostureRevisionsRequest',
        response_type_name='ListDataSecurityPostureRevisionsResponse',
        supports_download=False,
    )

    def Patch(self, request, global_params=None):
      r"""Updates an existing DataSecurityPosture. A new revision of the posture will be created if the revision to be updated is currently deployed on a workload. Returns a `google.rpc.Status` with `google.rpc.Code.NOT_FOUND` if the Posture does not exist. Returns a `google.rpc.Status` with `google.rpc.Code.ABORTED` if the etag supplied in the request does not match the persisted etag of the Posture. Updatable fields are state, description and policy_sets. State update operation cannot be clubbed with update of description and policy_sets. An ACTIVE posture can be updated to both DRAFT or DEPRECATED states. Postures in DRAFT or DEPRECATED states can only be updated to ACTIVE state.

      Args:
        request: (SecuritypostureOrganizationsLocationsDataSecurityPosturesPatchRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Operation) The response message.
      """
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures/{dataSecurityPosturesId}',
        http_method='PATCH',
        method_id='securityposture.organizations.locations.dataSecurityPostures.patch',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['revisionId', 'updateMask'],
        relative_path='v1alpha/{+name}',
        request_field='dataSecurityPosture',
        request_type_name='SecuritypostureOrganizationsLocationsDataSecurityPosturesPatchRequest',
        response_type_name='Operation',
        supports_download=False,
    )
