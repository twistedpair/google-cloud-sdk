...
class SecuritypostureV1(base_api.BaseApiClient):
  ...
  class OrganizationsLocationsDataSecurityPosturesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(SecuritypostureV1.OrganizationsLocationsDataSecurityPosturesService, self).__init__(client)
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures',
        http_method='POST',
        method_id='securityposture.organizations.locations.dataSecurityPostures.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['postureId'],
        relative_path='v1/{+parent}/dataSecurityPostures',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures/{dataSecurityPosturesId}',
        http_method='DELETE',
    ...
    ListDataSecurityPostureRevisions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/organizations/{organizationsId}/locations/{locationsId}/dataSecurityPostures/{dataSecurityPosturesId}:listDataSecurityPostureRevisions',
        http_method='GET',
        method_id='securityposture.organizations.locations.dataSecurityPostures.listDataSecurityPostureRevisions',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1/{+name}:listDataSecurityPostureRevisions',
        request_field='',
