...
class AbdfPolicy(_messages.Message):
  r"""ABDF policy

  Fields:
    abdfPolicyRules: ABDF policy rules.
    displayName: A user-specified opaque description of the `AbdfPolicy`. Must
  ...
  abdfPolicyRules = _messages.MessageField('AbdfPolicyRule', 1, repeated=True)
  displayName = _messages.StringField(2)
  name = _messages.StringField(3)


class AbdfPolicyRule(_messages.Message):
  r"""ABDF policy rule.

  Fields:
    description: A user-specified description of the rule. This value can be
      up to 256 characters.
    excludedDataRegions: CLDR regionCountry codes that the policy will allow.
    excludedPrincipals: Principals for which the policy will not apply.
    ruleId: User generated id of the rule.
  """

  description = _messages.StringField(1)
  excludedDataRegions = _messages.StringField(2, repeated=True)
  excludedPrincipals = _messages.StringField(3, repeated=True)
...
class CaxtPolicy(_messages.Message):
  r"""Customer admin access transparency policy. TBD - Update
  required/optional fields once below proto is available in DSPM

  Fields:
    displayName: A user-specified opaque description of the `CaxtPolicy`. Must
      be less than or equal to 63 characters.
    name: Output only. Uniquely identifies the policy. The name is ignored
      when creating the policy. The name is generated by the server with the
      format eg.
      `dataassetgroups/{data_asset_group_ref}/policies/{policy_id}`. `organiza
      tions/org_id/locations/location/resourcegroups/rg_id/policies/policy_id`
    rules: Customer admin access transparency policy rules.
  """

  displayName = _messages.StringField(1)
  name = _messages.StringField(2)
  rules = _messages.MessageField('CaxtPolicyRule', 3, repeated=True)


class CaxtPolicyRule(_messages.Message):
  r"""Customer admin access transparency deny policy rule.

  Fields:
    description: A user-specified description of the rule. This value can be
      up to 255 characters.
    excludedPrincipals: Principals for which the policy will not apply. (No
      logs will be generated).
    ruleId: User generated id of the rule.
  """

  description = _messages.StringField(1)
  excludedPrincipals = _messages.StringField(2, repeated=True)
...
class DataSecurityComplianceStandard(_messages.Message):
  r"""Mapping for a Policy to standard and control.
...
class DataSecurityConstraint(_messages.Message):
  r"""Representation of a DataSecurity Constraint.

  Fields:
    abdfPolicy: Optional. Attribute Based Data Flow policy constraint.
    caxtPolicy: Optional. Customer Access Transparency policy constraint.
    orgPolicyConstraint: Optional. Org Policy builtin constraint.
    securityHealthAnalyticsModule: Optional. SHA built-in detector.
  """

  abdfPolicy = _messages.MessageField('AbdfPolicy', 1)
  caxtPolicy = _messages.MessageField('CaxtPolicy', 2)
  orgPolicyConstraint = _messages.MessageField('OrgPolicyConstraint', 3)
  securityHealthAnalyticsModule = _messages.MessageField('SecurityHealthAnalyticsModule', 4)


class DataSecurityPolicy(_messages.Message):
  r"""DataSecurity Policy representation.

  Fields:
    complianceStandards: Optional. Contains list of mapping for a Policy to a
      standard and control.
    constraint: Required. DataSecurity Constraint details.
    description: Optional. Description of the Policy.
    policyId: Required. ID of the Policy that is user generated, immutable and
      unique within the scope of a policy set.
  """

  complianceStandards = _messages.MessageField('DataSecurityComplianceStandard', 1, repeated=True)
  constraint = _messages.MessageField('DataSecurityConstraint', 2)
  description = _messages.StringField(3)
  policyId = _messages.StringField(4)


class DataSecurityPolicySet(_messages.Message):
  r"""DataSecurity PolicySet representation.

  Fields:
    description: Optional. Description of the Policy set.
    policies: Required. List of DataSecurity policies.
    policySetId: Required. ID of the Policy set.
  """

  description = _messages.StringField(1)
  policies = _messages.MessageField('DataSecurityPolicy', 2, repeated=True)
  policySetId = _messages.StringField(3)


class DataSecurityPosture(_messages.Message):
  r"""========================== DataSecurity datasecuritypostures
  ========================== Definition of a DataSecuritydatasecurityposture.

  Enums:
    CategoriesValueListEntryValuesEnum:
    PostureTypeValueValuesEnum: Output only. The type of the posture.
    StateValueValuesEnum: Required. State of DataSecurityPosture resource.

  Messages:
    AnnotationsValue: Optional. User annotations. These attributes can only be
      set and used by the user, and not by Google Security
      datasecuritypostures. .

  Fields:
    annotations: Optional. User annotations. These attributes can only be set
      and used by the user, and not by Google Security datasecuritypostures. .
    categories: Output only. List of categories associated with a
      datasecurityposture. Based on it's associated policies the service
      defines the category, hence it is OUTPUT_ONLY field.
    createTime: Output only. The timestamp that the datasecurityposture was
      created.
    description: Optional. User provided description of the
      datasecurityposture.
    etag: Optional. An opaque tag indicating the current version of the
      datasecurityposture, used for concurrency control. When the
      `datasecurityposture` is returned from either a `GetDataSecurityPosture`
      or a `ListDataSecurityPostures` request, this `etag` indicates the
      version of the current `datasecurityposture` to use when executing a
      read-modify-write loop. When the `datasecurityposture` is used in a
      `UpdateDataSecurityPosture` method, use the `etag` value that was
      returned from a `Getdatasecurityposture` request as part of a read-
      modify-write loop for concurrency control. Not setting the `etag` in a
      `UpdateDataSecurityPosture` request will result in an unconditional
      write of the `datasecurityposture`.
    name: Required. Identifier. The name of this datasecurityposture resource,
      in the format of organizations/{org_id}/locations/{location_id}/dataSecu
      rityPostures/{dataSecurityPosture}.
    policySets: Required. List of DataSecurity Policy sets.
    postureType: Output only. The type of the posture.
    reconciling: Output only. Whether or not this datasecurityposture is in
      the process of being updated.
    revisionId: Output only. Immutable. The revision ID of the
      datasecurityposture. The format is an 8-character hexadecimal string.
      https://google.aip.dev/162
    state: Required. State of DataSecurityPosture resource.
    updateTime: Output only. The timestamp that the datasecurityposture was
      updated.
  """
  ...
  class StateValueValuesEnum(_messages.Enum):
    r"""Required. State of DataSecurityPosture resource.
  ...
  class AnnotationsValue(_messages.Message):
    ...
    by the user, and not by Google Security datasecuritypostures. .
  ...
  policySets = _messages.MessageField('DataSecurityPolicySet', 7, repeated=True)
...
class DataSecurityPostureDeployment(_messages.Message):
  r"""========================== DataSecurityPostureDeployments
  ================= ========================== Message describing
  DataSecurityPostureDeployment resource.

  Enums:
    CategoriesValueListEntryValuesEnum:
    PostureTypeValueValuesEnum: Output only. The type of the posture.
    StateValueValuesEnum: Output only. State of DataSecurityPostureDeployment
      resource.
  ...
  Fields:
    ...
    categories: Output only. Categories are a function of policies present in
      a Posture Version associated with this DataSecurityPostureDeployment.
    createTime: Output only. The timestamp that the
      DataSecurityPostureDeployment was created.
    description: Optional. User provided description of the
      DataSecurityPostureDeployment.
    desiredPostureId: Output only. This is a output only optional field which
      will be filled in case where DataSecurityPostureDeployment state is
      UPDATE_FAILED or CREATE_FAILED or DELETE_FAILED. It denotes the desired
      Posture.
    desiredPostureRevisionId: Output only. Output only optional field which
      provides revision_id of the desired_posture_id.
    etag: Optional. An opaque tag indicating the current version of the
      DataSecurityPostureDeployment, used for concurrency control. When the
      `DataSecurityPostureDeployment` is returned from either a
      `GetDataSecurityPostureDeployment` or a
      `ListDataSecurityPostureDeployments` request, this `etag` indicates the
      version of the current `DataSecurityPostureDeployment` to use when
      executing a read-modify-write loop. When the
      `DataSecurityPostureDeployment` is used in a
      `UpdateDataSecurityPostureDeployment` method, use the `etag` value that
      was returned from a `GetDataSecurityPostureDeployment` request as part
      of a read-modify-write loop for concurrency control. Not setting the
      `etag` in a `UpdateDataSecurityPostureDeployment` request will result in
      an unconditional write of the `DataSecurityPostureDeployment`.
    failureMessage: Output only. This is a output only optional field which
      will be filled in case where DataSecurityPostureDeployment enters a
      failure state like UPDATE_FAILED or CREATE_FAILED or DELETE_FAILED.
    name: Required. The name of this DataSecurityPostureDeployment resource,
      in the format of organizations/{organization}/locations/{location_id}/da
      taSecurityPostureDeployment/{dataSecurityPostureDeployment}.
    ...
    reconciling: Output only. Whether or not this Posture is in the process of
      being updated.
    state: Output only. State of DataSecurityPostureDeployment resource.
    ...
    updateTime: Output only. The timestamp that the
      DataSecurityPostureDeployment was updated.
  """
  ...
  class StateValueValuesEnum(_messages.Enum):
    r"""Output only. State of DataSecurityPostureDeployment resource.
...
class ListDataSecurityPostureRevisionsResponse(_messages.Message):
  ...
  revisions = _messages.MessageField('DataSecurityPosture', 2, repeated=True)


class ListDataSecurityPosturesResponse(_messages.Message):
  r"""Message for response to listing Postures.

  Fields:
    dataSecurityPostures: The list of DataSecurityPosture.
    nextPageToken: A token identifying a page of results the server should
      return.
    unreachable: Unreachable resources.
  """

  dataSecurityPostures = _messages.MessageField('DataSecurityPosture', 1, repeated=True)
...
class SecuritypostureOrganizationsLocationsDataSecurityPosturesCreateRequest(_messages.Message):
  r"""A SecuritypostureOrganizationsLocationsDataSecurityPosturesCreateRequest
  object.

  Fields:
    dataSecurityPosture: A DataSecurityPosture resource to be passed as the
      request body.
  ...
  dataSecurityPosture = _messages.MessageField('DataSecurityPosture', 1)
  parent = _messages.StringField(2, required=True)
  postureId = _messages.StringField(3)


class SecuritypostureOrganizationsLocationsDataSecurityPosturesDeleteRequest(_messages.Message):
  r"""A SecuritypostureOrganizationsLocationsDataSecurityPosturesDeleteRequest
  object.
...
class SecuritypostureOrganizationsLocationsDataSecurityPosturesGetRequest(_messages.Message):
  r"""A SecuritypostureOrganizationsLocationsDataSecurityPosturesGetRequest
  object.

  Fields:
    name: Required. Name of the resource.
    revisionId: Optional. DataSecurityPosture revision which needs to be
      retrieved.
  """
...
class SecuritypostureOrganizationsLocationsDataSecurityPosturesListDataSecurityPostureRevisionsRequest(_messages.Message):
  r"""A SecuritypostureOrganizationsLocationsDataSecurityPosturesListDataSecur
  ityPostureRevisionsRequest object.
...
class SecuritypostureOrganizationsLocationsDataSecurityPosturesListRequest(_messages.Message):
  r"""A SecuritypostureOrganizationsLocationsDataSecurityPosturesListRequest
  object.
  ...
  Fields:
    ...
    pageToken: Optional. A token identifying a page of results the server
      should return.
    parent: Required. Parent value for ListDataSecurityPosturesRequest.
  """
...
class SecuritypostureOrganizationsLocationsDataSecurityPosturesPatchRequest(_messages.Message):
  r"""A SecuritypostureOrganizationsLocationsDataSecurityPosturesPatchRequest
  object.
  ...
  Fields:
    ...
    name: Required. Identifier. The name of this datasecurityposture resource,
      in the format of organizations/{org_id}/locations/{location_id}/dataSecu
      rityPostures/{dataSecurityPosture}.
    revisionId: Required. DataSecurityPosture revision which needs to be
      updated.
    updateMask: Required. Field mask is used to specify the fields to be
      overwritten in the DataSecurityPosture resource by the update. The
