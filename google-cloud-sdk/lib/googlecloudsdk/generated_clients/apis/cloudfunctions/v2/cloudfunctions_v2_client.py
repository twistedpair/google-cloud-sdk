...
class CloudfunctionsV2(base_api.BaseApiClient):
  ...
  class ProjectsLocationsFunctionsService(base_api.BaseApiService):
    ...
    CommitFunctionUpgradeAsGen2.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:commitFunctionUpgradeAsGen2',
        http_method='POST',
        method_id='cloudfunctions.projects.locations.functions.commitFunctionUpgradeAsGen2',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2/{+name}:commitFunctionUpgradeAsGen2',
