...
class Function(_messages.Message):
  ...
  stateMessages = _messages.MessageField('GoogleCloudFunctionsV2betaStateMessage', 14, repeated=True)
...
class GoogleCloudFunctionsV2betaOperationMetadata(_messages.Message):
  ...
  stages = _messages.MessageField('GoogleCloudFunctionsV2betaStage', 10, repeated=True)
