...
class CloudfunctionsV2alpha(base_api.BaseApiClient):
  ...
  class ProjectsLocationsFunctionsService(base_api.BaseApiService):
    ...
    CommitFunctionUpgradeAsGen2.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:commitFunctionUpgradeAsGen2',
        http_method='POST',
        method_id='cloudfunctions.projects.locations.functions.commitFunctionUpgradeAsGen2',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2alpha/{+name}:commitFunctionUpgradeAsGen2',
    ...
    DetachFunction.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v2alpha/projects/{projectsId}/locations/{locationsId}/functions/{functionsId}:detachFunction',
        http_method='POST',
        method_id='cloudfunctions.projects.locations.functions.detachFunction',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v2alpha/{+name}:detachFunction',
