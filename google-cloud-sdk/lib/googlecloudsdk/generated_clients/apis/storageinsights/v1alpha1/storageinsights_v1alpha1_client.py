"""Generated client library for storageinsights version v1alpha1."""
# NOTE: This file is autogenerated and should not be edited by hand.

from __future__ import absolute_import

from apitools.base.py import base_api
from googlecloudsdk.generated_clients.apis.storageinsights.v1alpha1 import storageinsights_v1alpha1_messages as messages


class StorageinsightsV1alpha1(base_api.BaseApiClient):
  """Generated client library for service storageinsights version v1alpha1."""
  ...
  _CLIENT_CLASS_NAME = 'StorageinsightsV1alpha1'
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(StorageinsightsV1alpha1, self).__init__(
  ...
  class ProjectsLocationsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(StorageinsightsV1alpha1.ProjectsLocationsOperationsService, self).__init__(client)
  ...
  class ProjectsLocationsReportConfigsReportDetailsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(StorageinsightsV1alpha1.ProjectsLocationsReportConfigsReportDetailsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/reportConfigs/{reportConfigsId}/reportDetails/{reportDetailsId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/reportConfigs/{reportConfigsId}/reportDetails',
        http_method='GET',
        method_id='storageinsights.projects.locations.reportConfigs.reportDetails.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['filter', 'orderBy', 'pageSize', 'pageToken'],
        relative_path='v1alpha1/{+parent}/reportDetails',
        request_field='',
  ...
  class ProjectsLocationsReportConfigsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(StorageinsightsV1alpha1.ProjectsLocationsReportConfigsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/reportConfigs',
        http_method='POST',
        method_id='storageinsights.projects.locations.reportConfigs.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['requestId'],
        relative_path='v1alpha1/{+parent}/reportConfigs',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/reportConfigs/{reportConfigsId}',
        http_method='DELETE',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(StorageinsightsV1alpha1.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(StorageinsightsV1alpha1.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
