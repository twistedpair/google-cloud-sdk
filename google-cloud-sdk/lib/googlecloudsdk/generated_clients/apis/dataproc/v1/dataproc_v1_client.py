...
class DataprocV1(base_api.BaseApiClient):
  ...
  class ProjectsRegionsClustersGceNodePoolsService(base_api.BaseApiService):
    """Service class for the projects_regions_clusters_gceNodePools resource."""

    _NAME = 'projects_regions_clusters_gceNodePools'

    def __init__(self, client):
      super(DataprocV1.ProjectsRegionsClustersGceNodePoolsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/regions/{regionsId}/clusters/{clustersId}/gceNodePools',
        http_method='POST',
        method_id='dataproc.projects.regions.clusters.gceNodePools.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['gceNodePoolId', 'requestId'],
        relative_path='v1/{+parent}/gceNodePools',
        request_field='gceNodePool',
        request_type_name='DataprocProjectsRegionsClustersGceNodePoolsCreateRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/regions/{regionsId}/clusters/gceNodePools/{gceNodePoolsId}',
        http_method='DELETE',
        method_id='dataproc.projects.regions.clusters.gceNodePools.delete',
        ordered_params=['name'],
        path_params=['name'],
        query_params=['requestId'],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='DataprocProjectsRegionsClustersGceNodePoolsDeleteRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    def Get(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (GceNodePool) The response message.
      """
      config = self.GetMethodConfig('Get')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/regions/{regionsId}/clusters/{clustersId}/gceNodePools/{gceNodePoolsId}',
        http_method='GET',
        method_id='dataproc.projects.regions.clusters.gceNodePools.get',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1/{+name}',
        request_field='',
        request_type_name='DataprocProjectsRegionsClustersGceNodePoolsGetRequest',
        response_type_name='GceNodePool',
        supports_download=False,
    )
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        ...
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListGceNodePoolsResponse) The response message.
      """
      config = self.GetMethodConfig('List')
      return self._RunMethod(
          config, request, global_params=global_params)
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/regions/{regionsId}/clusters/{clustersId}/gceNodePools',
        http_method='GET',
        method_id='dataproc.projects.regions.clusters.gceNodePools.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1/{+parent}/gceNodePools',
        request_field='',
        request_type_name='DataprocProjectsRegionsClustersGceNodePoolsListRequest',
        response_type_name='ListGceNodePoolsResponse',
        supports_download=False,
    )
    ...
    Resize.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1/projects/{projectsId}/regions/{regionsId}/clusters/{clustersId}/gceNodePools/{gceNodePoolsId}:resize',
        http_method='POST',
        method_id='dataproc.projects.regions.clusters.gceNodePools.resize',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
