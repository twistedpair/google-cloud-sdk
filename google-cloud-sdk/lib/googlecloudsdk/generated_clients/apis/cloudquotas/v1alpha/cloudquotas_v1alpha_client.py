...
class CloudquotasV1alpha(base_api.BaseApiClient):
  ...
  class FoldersLocationsQuotaPreferencesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.FoldersLocationsQuotaPreferencesService, self).__init__(client)
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/folders/{foldersId}/locations/{locationsId}/quotaPreferences',
        http_method='POST',
        method_id='cloudquotas.folders.locations.quotaPreferences.create',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['ignoreSafetyChecks', 'quotaPreferenceId'],
        relative_path='v1alpha/{+parent}/quotaPreferences',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/folders/{foldersId}/locations/{locationsId}/quotaPreferences/{quotaPreferencesId}',
        http_method='GET',
  ...
  class FoldersLocationsServicesQuotaInfosService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.FoldersLocationsServicesQuotaInfosService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/folders/{foldersId}/locations/{locationsId}/services/{servicesId}/quotaInfos/{quotaInfosId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/folders/{foldersId}/locations/{locationsId}/services/{servicesId}/quotaInfos',
        http_method='GET',
        method_id='cloudquotas.folders.locations.services.quotaInfos.list',
        ordered_params=['parent'],
        path_params=['parent'],
        query_params=['pageSize', 'pageToken'],
        relative_path='v1alpha/{+parent}/quotaInfos',
        request_field='',
  ...
  class FoldersLocationsServicesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.FoldersLocationsServicesService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class FoldersLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.FoldersLocationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    GetQuotaAdjusterSettings.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/folders/{foldersId}/locations/{locationsId}/quotaAdjusterSettings',
        http_method='GET',
  ...
  class FoldersService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.FoldersService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class OrganizationsLocationsQuotaPreferencesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.OrganizationsLocationsQuotaPreferencesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/quotaPreferences',
        http_method='POST',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/quotaPreferences/{quotaPreferencesId}',
        http_method='GET',
  ...
  class OrganizationsLocationsServicesQuotaInfosService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.OrganizationsLocationsServicesQuotaInfosService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/services/{servicesId}/quotaInfos/{quotaInfosId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/services/{servicesId}/quotaInfos',
        http_method='GET',
  ...
  class OrganizationsLocationsServicesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.OrganizationsLocationsServicesService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class OrganizationsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.OrganizationsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    GetQuotaAdjusterSettings.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/organizations/{organizationsId}/locations/{locationsId}/quotaAdjusterSettings',
        http_method='GET',
  ...
  class OrganizationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.OrganizationsService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsQuotaPreferencesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.ProjectsLocationsQuotaPreferencesService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/quotaPreferences',
        http_method='POST',
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/quotaPreferences/{quotaPreferencesId}',
        http_method='GET',
  ...
  class ProjectsLocationsServicesQuotaInfosService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.ProjectsLocationsServicesQuotaInfosService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/services/{servicesId}/quotaInfos/{quotaInfosId}',
        http_method='GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/services/{servicesId}/quotaInfos',
        http_method='GET',
  ...
  class ProjectsLocationsServicesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.ProjectsLocationsServicesService, self).__init__(client)
      self._upload_configs = {
          }
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    GetQuotaAdjusterSettings.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha/projects/{projectsId}/locations/{locationsId}/quotaAdjusterSettings',
        http_method='GET',
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudquotasV1alpha.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
