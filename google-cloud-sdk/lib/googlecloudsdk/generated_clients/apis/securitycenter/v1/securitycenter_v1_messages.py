...
class GoogleCloudSecuritycenterV2MitreAttack(_messages.Message):
  ...
  class AdditionalTechniquesValueListEntryValuesEnum(_messages.Enum):
    ...
    SCHEDULED_TASK_JOB = 13
    CONTAINER_ORCHESTRATION_JOB = 14
    PROCESS_DISCOVERY = 15
    COMMAND_AND_SCRIPTING_INTERPRETER = 16
    UNIX_SHELL = 17
    PYTHON = 18
    EXPLOITATION_FOR_PRIVILEGE_ESCALATION = 19
    PERMISSION_GROUPS_DISCOVERY = 20
    CLOUD_GROUPS = 21
    INDICATOR_REMOVAL_FILE_DELETION = 22
    APPLICATION_LAYER_PROTOCOL = 23
    DNS = 24
    SOFTWARE_DEPLOYMENT_TOOLS = 25
    VALID_ACCOUNTS = 26
    DEFAULT_ACCOUNTS = 27
    LOCAL_ACCOUNTS = 28
    CLOUD_ACCOUNTS = 29
    ...
    EXTERNAL_PROXY = 31
    MULTI_HOP_PROXY = 32
    ACCOUNT_MANIPULATION = 33
    ADDITIONAL_CLOUD_CREDENTIALS = 34
    ADDITIONAL_CLOUD_ROLES = 35
    SSH_AUTHORIZED_KEYS = 36
    ADDITIONAL_CONTAINER_CLUSTER_ROLES = 37
    MULTI_STAGE_CHANNELS = 38
    INGRESS_TOOL_TRANSFER = 39
    NATIVE_API = 40
    BRUTE_FORCE = 41
    SHARED_MODULES = 42
    DATA_ENCODING = 43
    STANDARD_ENCODING = 44
    ACCESS_TOKEN_MANIPULATION = 45
    TOKEN_IMPERSONATION_OR_THEFT = 46
    CREATE_ACCOUNT = 47
    LOCAL_ACCOUNT = 48
    EXPLOIT_PUBLIC_FACING_APPLICATION = 49
    USER_EXECUTION = 50
    DOMAIN_POLICY_MODIFICATION = 51
    DATA_DESTRUCTION = 52
    SERVICE_STOP = 53
    INHIBIT_SYSTEM_RECOVERY = 54
    FIRMWARE_CORRUPTION = 55
    RESOURCE_HIJACKING = 56
    NETWORK_DENIAL_OF_SERVICE = 57
    CLOUD_SERVICE_DISCOVERY = 58
    STEAL_APPLICATION_ACCESS_TOKEN = 59
    ACCOUNT_ACCESS_REMOVAL = 60
    TRANSFER_DATA_TO_CLOUD_ACCOUNT = 61
    STEAL_WEB_SESSION_COOKIE = 62
    CREATE_OR_MODIFY_SYSTEM_PROCESS = 63
    EVENT_TRIGGERED_EXECUTION = 64
    BOOT_OR_LOGON_AUTOSTART_EXECUTION = 65
    KERNEL_MODULES_AND_EXTENSIONS = 66
    ABUSE_ELEVATION_CONTROL_MECHANISM = 67
    UNSECURED_CREDENTIALS = 68
    COMPROMISE_HOST_SOFTWARE_BINARY = 69
    MODIFY_AUTHENTICATION_PROCESS = 70
    IMPAIR_DEFENSES = 71
    DISABLE_OR_MODIFY_TOOLS = 72
    HIDE_ARTIFACTS = 73
    HIDDEN_FILES_AND_DIRECTORIES = 74
    HIDDEN_USERS = 75
    EXFILTRATION_OVER_WEB_SERVICE = 76
    EXFILTRATION_TO_CLOUD_STORAGE = 77
    DYNAMIC_RESOLUTION = 78
    LATERAL_TOOL_TRANSFER = 79
    MODIFY_CLOUD_COMPUTE_INFRASTRUCTURE = 80
    CREATE_SNAPSHOT = 81
    CLOUD_INFRASTRUCTURE_DISCOVERY = 82
    OBTAIN_CAPABILITIES = 83
    ACTIVE_SCANNING = 84
    SCANNING_IP_BLOCKS = 85
    STAGE_CAPABILITIES = 86
    CONTAINER_ADMINISTRATION_COMMAND = 87
    DEPLOY_CONTAINER = 88
    ESCAPE_TO_HOST = 89
    CONTAINER_AND_RESOURCE_DISCOVERY = 90
    STEAL_OR_FORGE_AUTHENTICATION_CERTIFICATES = 91
