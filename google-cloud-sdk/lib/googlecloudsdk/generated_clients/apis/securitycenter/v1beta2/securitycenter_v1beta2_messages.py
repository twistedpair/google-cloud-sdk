...
class Finding(_messages.Message):
  ...
  secret = _messages.MessageField('Secret', 56)
  securityMarks = _messages.MessageField('SecurityMarks', 57)
  securityPosture = _messages.MessageField('SecurityPosture', 58)
  severity = _messages.EnumField('SeverityValueValuesEnum', 59)
  sourceProperties = _messages.MessageField('SourcePropertiesValue', 60)
  state = _messages.EnumField('StateValueValuesEnum', 61)
  toxicCombination = _messages.MessageField('ToxicCombination', 62)
  vertexAi = _messages.MessageField('VertexAi', 63)
  vulnerability = _messages.MessageField('Vulnerability', 64)
