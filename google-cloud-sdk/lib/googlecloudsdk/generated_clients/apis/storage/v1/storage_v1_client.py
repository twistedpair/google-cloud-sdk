...
class StorageV1(base_api.BaseApiClient):
  ...
  class BucketsService(base_api.BaseApiService):
    ...
    Insert.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=[],
        query_params=['predefinedAcl', 'predefinedDefaultObjectAcl', 'project', 'projection', 'userProject'],
        relative_path='b',
  ...
  class ObjectsService(base_api.BaseApiService):
    ...
    Patch.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['bucket', 'object'],
        path_params=['bucket', 'object'],
        query_params=['generation', 'ifGenerationMatch', 'ifGenerationNotMatch', 'ifMetagenerationMatch', 'ifMetagenerationNotMatch', 'predefinedAcl', 'projection', 'userProject'],
        relative_path='b/{bucket}/o/{object}',
