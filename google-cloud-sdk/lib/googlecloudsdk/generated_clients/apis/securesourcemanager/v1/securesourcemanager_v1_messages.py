...
class BranchRule(_messages.Message):
  ...
  Fields:
    ...
    name: Identifier. A unique identifier for a BranchRule. The name should be
...
class Instance(_messages.Message):
  ...
  Fields:
    ...
    labels: Optional. Labels as key value pairs. Keys and values can contain
      ...
      labels](https://cloud.google.com/resource-manager/docs/best-practices-
      labels#label_encoding).
    name: Identifier. A unique identifier for an instance. The name should be
      of the format: `projects/{project_number}/locations/{location_id}/instan
      ces/{instance_id}` `project_number`: Maps to a unique int64 id assigned
      to each project. `location_id`: Refers to the region where the instance
...
class PullRequest(_messages.Message):
  ...
  Fields:
    ...
    name: Output only. Identifier. A unique identifier for a PullRequest. The
      number appended at the end is generated by the server. Format: `projects
...
class SecuresourcemanagerProjectsLocationsInstancesListRequest(_messages.Message):
  ...
  Fields:
    filter: Optional. Filter for filtering results.
