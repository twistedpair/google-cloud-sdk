...
class CloudnumberregistryV1alpha(base_api.BaseApiClient):
  ...
  class ProjectsLocationsRegistryBooksService(base_api.BaseApiService):
    ...
    SearchRegistry.method_config = lambda: base_api.ApiMethodInfo(
        ...
        ordered_params=['name'],
        path_params=['name'],
        query_params=['orderBy', 'pageSize', 'pageToken', 'queryFilter_attributeKeys', 'queryFilter_ipRange', 'queryFilter_keywords', 'queryFilter_source'],
        relative_path='v1alpha/{+name}:searchRegistry',
        request_field='',
