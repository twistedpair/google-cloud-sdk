...
class Tensor(proto.Message):
    ...
    Attributes:
        dtype (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.Tensor.DataType):
        ...
        bool_val (MutableSequence[bool]):
            ...
            [BOOL][google.cloud.aiplatform.v1beta1.Tensor.DataType.BOOL]
        string_val (MutableSequence[str]):
            [STRING][google.cloud.aiplatform.v1beta1.Tensor.DataType.STRING]
        bytes_val (MutableSequence[bytes]):
            [STRING][google.cloud.aiplatform.v1beta1.Tensor.DataType.STRING]
        float_val (MutableSequence[float]):
            [FLOAT][google.cloud.aiplatform.v1beta1.Tensor.DataType.FLOAT]
        double_val (MutableSequence[float]):
            [DOUBLE][google.cloud.aiplatform.v1beta1.Tensor.DataType.DOUBLE]
        int_val (MutableSequence[int]):
            [INT_8][google.cloud.aiplatform.v1beta1.Tensor.DataType.INT8]
            [INT_16][google.cloud.aiplatform.v1beta1.Tensor.DataType.INT16]
            [INT_32][google.cloud.aiplatform.v1beta1.Tensor.DataType.INT32]
        int64_val (MutableSequence[int]):
            [INT64][google.cloud.aiplatform.v1beta1.Tensor.DataType.INT64]
        uint_val (MutableSequence[int]):
            [UINT8][google.cloud.aiplatform.v1beta1.Tensor.DataType.UINT8]
            [UINT16][google.cloud.aiplatform.v1beta1.Tensor.DataType.UINT16]
            [UINT32][google.cloud.aiplatform.v1beta1.Tensor.DataType.UINT32]
        uint64_val (MutableSequence[int]):
            [UINT64][google.cloud.aiplatform.v1beta1.Tensor.DataType.UINT64]
        list_val (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.Tensor]):
            A list of tensor values.
        struct_val (MutableMapping[str, googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.Tensor]):
