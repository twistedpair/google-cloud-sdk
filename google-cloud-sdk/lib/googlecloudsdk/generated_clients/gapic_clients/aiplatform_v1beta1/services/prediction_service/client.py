...
from googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types import usage_metadata
...
class PredictionServiceClient(metaclass=PredictionServiceClientMeta):
    ...
    def predict_long_running(self,
        ...
        .. code-block:: python
            ...
            def sample_predict_long_running():
                ...
                request = aiplatform_v1beta1.PredictLongRunningRequest(
                    endpoint="endpoint_value",
                    instances=instances,
                )
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.PredictLongRunningRequest, dict]):
                The request object. Request message for
    ...
    def fetch_predict_operation(self,
        ...
        .. code-block:: python
            ...
            def sample_fetch_predict_operation():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.FetchPredictOperationRequest(
                    endpoint="endpoint_value",
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.FetchPredictOperationRequest, dict]):
                The request object. Request message for
    ...
    def invoke(self,
        ...
        .. code-block:: python
            ...
            def sample_invoke():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.InvokeRequest(
                    endpoint="endpoint_value",
                )
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.InvokeRequest, dict]):
                The request object. Request message for
    ...
    def embed_content(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.EmbedContentRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1beta1.types.EmbedContentResponse:
                Response message for
                   [PredictionService.EmbedContent][google.cloud.aiplatform.v1beta1.PredictionService.EmbedContent].
