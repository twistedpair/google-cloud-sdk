...
class WorkerPoolsClient(metaclass=WorkerPoolsClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            WorkerPoolsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def create_worker_pool(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.CreateWorkerPoolRequest, dict]):
    ...
    def get_worker_pool(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.GetWorkerPoolRequest, dict]):
    ...
    def list_worker_pools(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListWorkerPoolsRequest, dict]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.services.worker_pools.pagers.ListWorkerPoolsPager:
    ...
    def update_worker_pool(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.UpdateWorkerPoolRequest, dict]):
    ...
    def delete_worker_pool(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.DeleteWorkerPoolRequest, dict]):
