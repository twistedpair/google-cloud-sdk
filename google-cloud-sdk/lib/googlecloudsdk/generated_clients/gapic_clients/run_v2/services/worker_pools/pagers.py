...
class ListWorkerPoolsPager:
    ...
    :class:`googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListWorkerPoolsResponse` object, and
    ...
    All the usual :class:`googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListWorkerPoolsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListWorkerPoolsRequest):
                The initial request object.
            response (googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListWorkerPoolsResponse):
