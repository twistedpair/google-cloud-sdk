...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.services.revisions import pagers
...
class RevisionsClient(metaclass=RevisionsClientMeta):
    ...
    def get_revision(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.GetRevisionRequest, dict]):
    ...
    def list_revisions(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListRevisionsRequest, dict]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.services.revisions.pagers.ListRevisionsPager:
    ...
    def delete_revision(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.DeleteRevisionRequest, dict]):
