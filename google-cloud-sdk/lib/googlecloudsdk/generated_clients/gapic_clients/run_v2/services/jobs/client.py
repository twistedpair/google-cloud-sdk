...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.services.jobs import pagers
...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.types import execution_template
...
class JobsClient(metaclass=JobsClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            JobsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def create_job(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.CreateJobRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`googlecloudsdk.generated_clients.gapic_clients.run_v2.types.Job` Job represents the configuration of a single job, which references a
    ...
    def get_job(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.GetJobRequest, dict]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.types.Job:
    ...
    def list_jobs(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListJobsRequest, dict]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.services.jobs.pagers.ListJobsPager:
    ...
    def update_job(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.UpdateJobRequest, dict]):
    ...
    def delete_job(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.DeleteJobRequest, dict]):
    ...
    def run_job(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.RunJobRequest, dict]):
