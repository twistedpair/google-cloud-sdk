...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.types import build
...
class BuildsAsyncClient:
    ...
    parse_build_worker_pool_path = staticmethod(BuildsClient.parse_build_worker_pool_path)
    ...
    get_transport_class = functools.partial(type(BuildsClient).get_transport_class, type(BuildsClient))
