...
class BuildsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_submit_build(self, request: build.SubmitBuildRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[build.SubmitBuildRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_submit_build_with_metadata(self, response: build.SubmitBuildResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[build.SubmitBuildResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for submit_build
...
class BuildsRestTransport(_BaseBuildsRestTransport):
    ...
    class _SubmitBuild(_BaseBuildsRestTransport._BaseSubmitBuild, BuildsRestStub):
        ...
        def __call__(self,
            ...
            resp, _ = self._interceptor.post_submit_build_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
