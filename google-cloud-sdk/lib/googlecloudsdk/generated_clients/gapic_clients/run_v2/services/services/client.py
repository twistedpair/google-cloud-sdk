...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.services.services import pagers
from googlecloudsdk.generated_clients.gapic_clients.run_v2.types import condition
from googlecloudsdk.generated_clients.gapic_clients.run_v2.types import revision_template
...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.types import traffic_target
...
class ServicesClient(metaclass=ServicesClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ServicesClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def create_service(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.CreateServiceRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be :class:`googlecloudsdk.generated_clients.gapic_clients.run_v2.types.Service` Service acts as a top-level container that manages a set of
    ...
    def get_service(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.GetServiceRequest, dict]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.types.Service:
    ...
    def list_services(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListServicesRequest, dict]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.services.services.pagers.ListServicesPager:
    ...
    def update_service(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.UpdateServiceRequest, dict]):
    ...
    def delete_service(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.DeleteServiceRequest, dict]):
