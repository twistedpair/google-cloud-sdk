...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.services.executions import pagers
...
from googlecloudsdk.generated_clients.gapic_clients.run_v2.types import task_template
...
class ExecutionsClient(metaclass=ExecutionsClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            ExecutionsClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def get_execution(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.GetExecutionRequest, dict]):
    ...
    def list_executions(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListExecutionsRequest, dict]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.services.executions.pagers.ListExecutionsPager:
    ...
    def delete_execution(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.DeleteExecutionRequest, dict]):
    ...
    def cancel_execution(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.CancelExecutionRequest, dict]):
                The request object. Request message for deleting an
                Execution.
            name (str):
