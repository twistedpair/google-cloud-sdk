...
class TasksClient(metaclass=TasksClientMeta):
    ...
    def get_task(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.GetTaskRequest, dict]):
    ...
    def list_tasks(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.run_v2.types.ListTasksRequest, dict]):
        ...
        Returns:
            googlecloudsdk.generated_clients.gapic_clients.run_v2.services.tasks.pagers.ListTasksPager:
