...
class Mutation(proto.Message):
    ...
    Attributes:
        ...
        delete (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.Mutation.Delete):
            ...
            This field is a member of `oneof`_ ``operation``.
        send (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.Mutation.Send):
            Send a message to a queue.

            This field is a member of `oneof`_ ``operation``.
        ack (googlecloudsdk.generated_clients.gapic_clients.spanner_v1.types.Mutation.Ack):
