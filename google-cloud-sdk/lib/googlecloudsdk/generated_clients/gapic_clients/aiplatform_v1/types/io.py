...
from googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types import api_auth
...
class CsvDestination(proto.Message):
    ...
    Attributes:
        gcs_destination (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GcsDestination):
            Required. Google Cloud Storage location.
    """
...
class GoogleDriveSource(proto.Message):
    ...
    Attributes:
        resource_ids (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GoogleDriveSource.ResourceId]):
    ...
    class ResourceId(proto.Message):
        ...
        Attributes:
            resource_type (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GoogleDriveSource.ResourceId.ResourceType):
...
class SlackSource(proto.Message):
    ...
    Attributes:
        channels (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SlackSource.SlackChannels]):
    ...
    class SlackChannels(proto.Message):
        ...
        Attributes:
            channels (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SlackSource.SlackChannels.SlackChannel]):
                Required. The Slack channel IDs.
            api_key_config (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ApiAuth.ApiKeyConfig):
...
class JiraSource(proto.Message):
    ...
    Attributes:
        jira_queries (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.JiraSource.JiraQueries]):
...
class SharePointSources(proto.Message):
    ...
    Attributes:
        share_point_sources (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SharePointSources.SharePointSource]):
    ...
    class SharePointSource(proto.Message):
        ...
        Attributes:
            ...
            client_secret (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ApiAuth.ApiKeyConfig):
