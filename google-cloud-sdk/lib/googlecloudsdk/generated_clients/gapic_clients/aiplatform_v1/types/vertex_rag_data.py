...
from googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types import encryption_spec as gca_encryption_spec
from googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types import io
...
class RagCorpus(proto.Message):
    ...
    Attributes:
        ...
        encryption_spec (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.EncryptionSpec):
...
class RagManagedDbConfig(proto.Message):
    ...
    Attributes:
        ...
        basic (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.RagManagedDbConfig.Basic):
            ...
            This field is a member of `oneof`_ ``tier``.
        unprovisioned (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.RagManagedDbConfig.Unprovisioned):
...
class RagEngineConfig(proto.Message):
    ...
    Attributes:
        ...
        rag_managed_db_config (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.RagManagedDbConfig):
