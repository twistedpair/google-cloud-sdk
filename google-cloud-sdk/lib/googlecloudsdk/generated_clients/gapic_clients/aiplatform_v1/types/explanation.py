...
from googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types import explanation_metadata
...
class Explanation(proto.Message):
    ...
    Attributes:
        attributions (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Attribution]):
        ...
        neighbors (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Neighbor]):
...
class ModelExplanation(proto.Message):
    ...
    Attributes:
        mean_attributions (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Attribution]):
...
class ExplanationSpec(proto.Message):
    ...
    Attributes:
        parameters (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExplanationParameters):
            Required. Parameters that configure
            explaining of the Model's predictions.
        metadata (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExplanationMetadata):
...
class ExplanationParameters(proto.Message):
    ...
    Attributes:
        sampled_shapley_attribution (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SampledShapleyAttribution):
        ...
        integrated_gradients_attribution (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.IntegratedGradientsAttribution):
            ...
            This field is a member of `oneof`_ ``method``.
        xrai_attribution (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.XraiAttribution):
            ...
            This field is a member of `oneof`_ ``method``.
        examples (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Examples):
...
class IntegratedGradientsAttribution(proto.Message):
    ...
    Attributes:
        ...
        smooth_grad_config (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.SmoothGradConfig):
        ...
        blur_baseline_config (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.BlurBaselineConfig):
...
class SmoothGradConfig(proto.Message):
    ...
    Attributes:
        ...
        feature_noise_sigma (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.FeatureNoiseSigma):
            This is similar to
...
class FeatureNoiseSigma(proto.Message):
    ...
    Attributes:
        noise_sigma (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.FeatureNoiseSigma.NoiseSigmaForFeature]):
...
class Examples(proto.Message):
    ...
    Attributes:
        example_gcs_source (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Examples.ExampleGcsSource):
        ...
        presets (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Presets):
    ...
    class ExampleGcsSource(proto.Message):
        ...
        Attributes:
            data_format (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Examples.ExampleGcsSource.DataFormat):
...
class Presets(proto.Message):
    ...
    Attributes:
        query (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Presets.Query):
        ...
        modality (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Presets.Modality):
...
class ExplanationSpecOverride(proto.Message):
    ...
    Attributes:
        ...
        metadata (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExplanationMetadataOverride):
            The metadata to be overridden. If not
            specified, no metadata is overridden.
        examples_override (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExamplesOverride):
...
class ExplanationMetadataOverride(proto.Message):
    ...
    Attributes:
        inputs (MutableMapping[str, googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExplanationMetadataOverride.InputMetadataOverride]):
...
class ExamplesOverride(proto.Message):
    ...
    Attributes:
        ...
        restrictions (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExamplesRestrictionsNamespace]):
            Restrict the resulting nearest neighbors to
            respect these constraints.
        return_embeddings (bool):
            If true, return the embeddings instead of
            neighbors.
        data_format (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExamplesOverride.DataFormat):
