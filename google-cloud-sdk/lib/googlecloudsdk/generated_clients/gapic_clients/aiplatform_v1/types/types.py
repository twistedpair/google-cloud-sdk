...
class Tensor(proto.Message):
    ...
    Attributes:
        dtype (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Tensor.DataType):
        ...
        list_val (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Tensor]):
            A list of tensor values.
        struct_val (MutableMapping[str, googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Tensor]):
