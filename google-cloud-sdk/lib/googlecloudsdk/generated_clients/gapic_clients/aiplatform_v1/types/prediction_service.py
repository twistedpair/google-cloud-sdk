...
from googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types import usage_metadata as gca_usage_metadata
...
class DirectPredictRequest(proto.Message):
    ...
    Attributes:
        endpoint (str):
            ...
            prediction. Format:
            ``projects/{project}/locations/{location}/endpoints/{endpoint}``
        inputs (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Tensor]):
            The prediction input.
        parameters (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Tensor):
...
class DirectPredictResponse(proto.Message):
    ...
    Attributes:
        outputs (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Tensor]):
...
class ExplainRequest(proto.Message):
    ...
    Attributes:
        ...
        parameters (google.protobuf.struct_pb2.Value):
            ...
            [PredictSchemata's][google.cloud.aiplatform.v1.Model.predict_schemata]
            [parameters_schema_uri][google.cloud.aiplatform.v1.PredictSchemata.parameters_schema_uri].
        explanation_spec_override (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExplanationSpecOverride):
...
class ExplainResponse(proto.Message):
    ...
    Attributes:
        explanations (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.Explanation]):
...
class GenerateContentResponse(proto.Message):
    ...
    Attributes:
        ...
        prompt_feedback (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GenerateContentResponse.PromptFeedback):
            ...
            violations.
        usage_metadata (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GenerateContentResponse.UsageMetadata):
    ...
    class PromptFeedback(proto.Message):
        ...
        Attributes:
            block_reason (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GenerateContentResponse.PromptFeedback.BlockedReason):
    ...
    class UsageMetadata(proto.Message):
        ...
        Attributes:
            ...
            tool_use_prompt_tokens_details (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ModalityTokenCount]):
                ...
                as input.
            traffic_type (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GenerateContentResponse.UsageMetadata.TrafficType):
...
class GenerateVideoResponse(proto.Message):
    ...
    Attributes:
        ...
        videos (MutableSequence[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GenerateVideoResponse.Video]):
...
class EmbedContentResponse(proto.Message):
    ...
    Attributes:
        embedding (googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.EmbedContentResponse.Embedding):
