...
class PredictionServiceClient(metaclass=PredictionServiceClientMeta):
    ...
    def predict(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.PredictRequest, dict]):
    ...
    def raw_predict(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.RawPredictRequest, dict]):
                The request object. Request message for
    ...
    def stream_raw_predict(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamRawPredictRequest, dict]):
                The request object. Request message for
    ...
    def direct_predict(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.DirectPredictRequest, dict]):
                The request object. Request message for
    ...
    def direct_raw_predict(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.DirectRawPredictRequest, dict]):
                The request object. Request message for
    ...
    def stream_direct_predict(self,
        ...
        Args:
            requests (Iterator[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamDirectPredictRequest]):
        ...
        Returns:
            Iterable[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamDirectPredictResponse]:
                Response message for
                   [PredictionService.StreamDirectPredict][google.cloud.aiplatform.v1.PredictionService.StreamDirectPredict].
    ...
    def stream_direct_raw_predict(self,
        ...
        Args:
            requests (Iterator[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamDirectRawPredictRequest]):
                The request object iterator. Request message for
        ...
        Returns:
            Iterable[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamDirectRawPredictResponse]:
                Response message for
                   [PredictionService.StreamDirectRawPredict][google.cloud.aiplatform.v1.PredictionService.StreamDirectRawPredict].
    ...
    def streaming_predict(self,
        ...
        Args:
            requests (Iterator[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamingPredictRequest]):
                The request object iterator. Request message for
        ...
        Returns:
            Iterable[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamingPredictResponse]:
                Response message for
                   [PredictionService.StreamingPredict][google.cloud.aiplatform.v1.PredictionService.StreamingPredict].
    ...
    def server_streaming_predict(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamingPredictRequest, dict]):
                The request object. Request message for
                [PredictionService.StreamingPredict][google.cloud.aiplatform.v1.PredictionService.StreamingPredict].
    ...
    def streaming_raw_predict(self,
        ...
        Args:
            requests (Iterator[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamingRawPredictRequest]):
                The request object iterator. Request message for
        ...
        Returns:
            Iterable[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.StreamingRawPredictResponse]:
                Response message for
                   [PredictionService.StreamingRawPredict][google.cloud.aiplatform.v1.PredictionService.StreamingRawPredict].
    ...
    def predict_long_running(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.PredictLongRunningRequest, dict]):
                The request object. Request message for
    ...
    def fetch_predict_operation(self,
        ...
        .. code-block:: python
            ...
            def sample_fetch_predict_operation():
                # Create a client
                client = aiplatform_v1.PredictionServiceClient()
                ...
                # Make the request
                response = client.fetch_predict_operation(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.FetchPredictOperationRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.fetch_predict_operation]
    ...
    def invoke(self,
        ...
        .. code-block:: python
            ...
            def sample_invoke():
                ...
                # Make the request
                stream = client.invoke(request=request)
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.InvokeRequest, dict]):
                The request object. Request message for
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.invoke]
    ...
    def explain(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ExplainRequest, dict]):
                The request object. Request message for
    ...
    def generate_content(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GenerateContentRequest, dict]):
    ...
    def stream_generate_content(self,
        ...
        Returns:
            Iterable[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.GenerateContentResponse]:
                Response message for
                [PredictionService.GenerateContent].
    ...
    def chat_completions(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.ChatCompletionsRequest, dict]):
    ...
    def embed_content(self,
        ...
        Args:
            request (Union[googlecloudsdk.generated_clients.gapic_clients.aiplatform_v1.types.EmbedContentRequest, dict]):
                The request object. Request message for
