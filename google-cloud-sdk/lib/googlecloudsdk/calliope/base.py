...
class _Common(six.with_metaclass(abc.ABCMeta, object)):
  ...
  @classmethod
  def IsAutoGenerated(cls):
    """Returns whether or not this command or group is auto generated."""
    return cls._is_auto_generated
  ...
  @classmethod
  def IsDefaultUniverseCompatible(cls):
